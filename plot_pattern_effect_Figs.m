function plot_pattern_effect_Figs(p)
...
if p.do_add; contour(p.lon,p.lat,p.v1_add,p.v1_addbin,p.v1_co,'showtext',p.show);end;
...
cb0.Label.Position = [pos(1)-0.3 pos(2)+0.51]; 
...
s=sprintf('%s (%5.3f%s)',sx,b,p.unit0); 
title(s,'FontSize',fsize,'Interpreter','latex');
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
cb0=colorbar('FontSize',fsize,'Location','eastoutside');
set(cb0, 'Position', [0.93 0.545 wid len]); caxis([cmin2, cmax2]); 
cb0.Label.String = p.unit; pos=get(cb0,'Position');
cb0.Label.Position = [pos(1)-0.3 pos(2)+0.1]; 
cb0.Label.Rotation = 0;
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
cb0=colorbar('FontSize',fsize,'Location','eastoutside');
set(cb0, 'Position', [0.93 0.325 wid len]); caxis([cmin3, cmax3]); 
cb0.Label.String = p.unit; pos=get(cb0,'Position');
cb0.Label.Position = [pos(1)-0.3 pos(2)+0.32]; 
cb0.Label.Rotation = 0;
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
cb0=colorbar('FontSize',fsize,'Location','eastoutside');
set(cb0, 'Position', [0.93 0.106 wid len]); caxis([cmin4 cmax4]); 
cb0.Label.String = p.unit; pos=get(cb0,'Position');
cb0.Label.Position = [pos(1)-0.3 pos(2)+0.54]; 
cb0.Label.Rotation = 0;
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
