function [v]=readartcmcs_day_cre_obs(tpath,expn,yr1,yr2,pct,opt,diag)
...
%  a=readallyear_mon(v,exd,varn,exf1,exf2,exf3,m,ff)*86400; 
  ...
  if (diag==0); break; end
  %%%%%%%%%%%%%%%%%%%%%%%%%%%%%
  varn='toa_lw_all'; ff='day'; exd='/atmos_data_240_480/daily/'; exf1='ceres.'; exf2='0101-'; exf3='1231.';
  a=readallyear_mon(v,exd,varn,exf1,exf2,exf3,m,ff); 
  a=do_ceres_adj(varn,a); rlut=a;
  s=get_cond_var_new(a,id,pct,v.aa,0,idxx);
  ...
  %%%%%%%%%%%%%%%%%%%%%%%%%%%%%
  varn='toa_lw_clr'; ff='day'; exd='/atmos_data_240_480/daily/'; exf1='ceres.'; exf2='0101-'; exf3='1231.';
  a=readallyear_mon(v,exd,varn,exf1,exf2,exf3,m,ff); 
  a=fillmissing(a,'nearest',1); a=fillmissing(a,'nearest',3); 
  a=do_ceres_adj(varn,a); lwcf=a-rlut; clear rlut;
  s=get_cond_var_new(a,id,pct,v.aa,0,idxx);
  ...
  %%%%%%%%%%%%%%%%%%%%%%%%%%%%%
  varn='toa_sw_all'; ff='day'; exd='/atmos_data_240_480/daily/'; exf1='ceres.'; exf2='0101-'; exf3='1231.';
  a=readallyear_mon(v,exd,varn,exf1,exf2,exf3,m,ff); 
  a=do_ceres_adj(varn,a); rsut=a;
  s=get_cond_var_new(a,id,pct,v.aa,0,idxx);
  ...
  %%%%%%%%%%%%%%%%%%%%%%%%%%%%%
  varn='toa_solar_all'; ff='day'; exd='/atmos_data_240_480/daily/'; exf1='ceres.'; exf2='0101-'; exf3='1231.';
  a=readallyear_mon(v,exd,varn,exf1,exf2,exf3,m,ff); 
  a=do_ceres_adj(varn,a); a=a-rsut;
  s=get_cond_var_new(a,id,pct,v.aa,0,idxx);
  ...
  %%%%%%%%%%%%%%%%%%%%%%%%%%%%%
  varn='toa_sw_clr'; ff='day'; exd='/atmos_data_240_480/daily/'; exf1='ceres.'; exf2='0101-'; exf3='1231.';
  a=readallyear_mon(v,exd,varn,exf1,exf2,exf3,m,ff); 
  a=fillmissing(a,'nearest',1); a=fillmissing(a,'nearest',3); 
  a=do_ceres_adj(varn,a); rsutcs=a;
  s=get_cond_var_new(a,id,pct,v.aa,0,idxx);
  ...
  %%%%%%%%%%%%%%%%%%%%%%%%%%%%%
  varn='toa_net_all'; ff='day'; exd='/atmos_data_240_480/daily/'; exf1='ceres.'; exf2='0101-'; exf3='1231.';
  a=readallyear_mon(v,exd,varn,exf1,exf2,exf3,m,ff); 
  a=do_ceres_adj(varn,a); netrad=a; 
  s=get_cond_var_new(a,id,pct,v.aa,0,idxx);
  ...
  %%%%%%%%%%%%%%%%%%%%%%%%%%%%%
  varn='toa_net_clr'; ff='day'; exd='/atmos_data_240_480/daily/'; exf1='ceres.'; exf2='0101-'; exf3='1231.';
  a=readallyear_mon(v,exd,varn,exf1,exf2,exf3,m,ff); 
  a=fillmissing(a,'nearest',3); a=fillmissing(a,'nearest',1); 
  a=do_ceres_adj(varn,a); netradclr=a;
  s=get_cond_var_new(a,id,pct,v.aa,0,idxx);
...
fnmat=strcat(epath,expn,fext,'_',opt,'_diag',num2str(diag),'_readartcmcs_day_cre.mat')
