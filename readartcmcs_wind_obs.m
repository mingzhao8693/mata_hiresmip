function [v]=readartcmcs_wind_obs(tpath,expn,yr1,yr2,pct,opt,diag)
...
%  a=readallyear_mon(v,exd,varn,exf1,exf2,exf3,m,ff)*86400; 
  ...
  %%%%%%%%%%%%%%%%%%%%%%%%%%%%%
  varn='wind_ref'; ff='day'; exd='/atmos_data_240_480/daily/'; exf1='atmos.'; exf2='0101-'; exf3='1231.';
  ...
  %%%%%%%%%%%%%%%%%%%%%%%%%%%%%
  varn='wind_ref_max'; ff='day'; exd='/atmos_data_240_480/daily/'; exf1='atmos.'; exf2='0101-'; exf3='1231.';
  a=readallyear_mon(v,exd,varn,exf1,exf2,exf3,m,ff);
  s=get_cond_var_new(a,id,pct,v.aa,0,idxx);
