...
% $$$   figure; pcolor(v.lon,v.lat,cc); shading flat; colorbar; caxis([-10 10]);
  ...
  for m=1:12
    ...
    v.arfq        (m,t,:,:)=s.arfq; %ar freq
    v.prav6h_arav (m,t,:,:)=s.arav; %ar average
    v.prav6h_armax(m,t,:,:)=s.armax;%ar max
    v.prav6h_av   (m,t,:,:)=s.av;   %monthly average
    v.prav6h_90   (m,t,:,:)=s.p90;  %90 percentile of 6h averaged pr
    v.prav6h_99   (m,t,:,:)=s.p99;  %99 percentile of 6h averaged pr
    v.prav6h_999  (m,t,:,:)=s.p999; %99.9 percentile of 6h averaged pr
...
a=v.freq_ar;    v.freq_ar_clm     = get_clm_ann(a); f=a;
...
a=v.prav6h_arav;  v.prav6h_arav_clm  = get_clm_ann(a);
                  v.prav6h_arall_clm = get_clm_ann(a.*f);
...
a=v.prw_arav;     v.prw_arav_clm     = get_clm_ann(a);
                  v.prw_arall_clm    = get_clm_ann(a.*f);
a=v.prw_armax;    v.prw_armax_clm    = get_clm_ann(a);
a=v.prw_av;       v.prw_av_clm       = get_clm_ann(a);
a=v.prw_99;       v.prw_99_clm       = get_clm_ann(a);

if strcmp(opt,'mod')
  a=v.evav6h_arav;  v.evav6h_arav_clm   = get_clm_ann(a);
                    v.evav6h_arall_clm  = get_clm_ann(a.*f);
  ...
  a=v.evin6h_arav;  v.evin6h_arav_clm   = get_clm_ann(a);
                    v.evin6h_arall_clm  = get_clm_ann(a.*f);
  ...
  a=v.prin6h_arav;  v.prin6h_arav_clm   = get_clm_ann(a);
                    v.prin6h_arall_clm  = get_clm_ann(a.*f);
  ...
  a=v.prsn_arav;    v.prsn_arav_clm     = get_clm_ann(a);
                    v.prsn_arall_clm    = get_clm_ann(a.*f);
  ...
  a=v.w850_arav;    v.w850_arav_clm     = get_clm_ann(a);
                    %v.w850_arall_clm    = get_clm_ann(a.*f);
  ...
  a=v.w500_arav;    v.w500_arav_clm     = get_clm_ann(a);
                    %v.w500_arall_clm    = get_clm_ann(a.*f);
  ...
  a=v.w250_arav;    v.w250_arav_clm     = get_clm_ann(a);
                    %v.w250_arall_clm    = get_clm_ann(a.*f);
  ...
  a=v.wind850_arav; v.wind850_arav_clm  = get_clm_ann(a);
                    %v.wind850_arall_clm = get_clm_ann(a.*f);
  ...
  a=v.wind500_arav; v.wind500_arav_clm  = get_clm_ann(a);
                    %v.wind500_arall_clm = get_clm_ann(a.*f);
  ...
  a=v.wind250_arav; v.wind250_arav_clm  = get_clm_ann(a);
                    %v.wind250_arall_clm = get_clm_ann(a.*f);
  ...
  a=v.t850_arav;    v.t850_arav_clm     = get_clm_ann(a);
                    %v.t850_arall_clm    = get_clm_ann(a.*f);
  ...
  a=v.t500_arav;    v.t500_arav_clm     = get_clm_ann(a);
                    v.t500_arall_clm    = get_clm_ann(a.*f);
  ...
  a=v.t250_arav;    v.t500_arav_clm     = get_clm_ann(a);
                    %v.t500_arall_clm    = get_clm_ann(a.*f);
  ...
  a=v.q850_arav;    v.q850_arav_clm     = get_clm_ann(a);
                    %v.q850_arall_clm    = get_clm_ann(a.*f);
  ...
  a=v.q500_arav;    v.q500_arav_clm     = get_clm_ann(a);
                    %v.q500_arall_clm    = get_clm_ann(a.*f);
  ...
  a=v.q250_arav;    v.q500_arav_clm     = get_clm_ann(a);
                    %v.q500_arall_clm    = get_clm_ann(a.*f);
  ...
  a=v.ttwt_arav;    v.ttwt_arav_clm     = get_clm_ann(a);
                    %v.ttwt_arall_clm    = get_clm_ann(a.*f);
  ...
  a=v.tcrh_arav;    v.tcrh_arav_clm     = get_clm_ann(a);
                    %v.tcrh_arall_clm    = get_clm_ann(a.*f);
  ...
  a=v.ttws_arav;    v.ttws_arav_clm     = get_clm_ann(a);
                    %v.ttws_arall_clm    = get_clm_ann(a.*f);
  ...
  a=v.tasmin_arav;  v.tasmin_arav_clm   = get_clm_ann(a);
