...
yr1=0045; yr2=0101; pct=[99 99.9]; use_obs_tc=0;
...
%expn='c192L33_am4p0_amip_HIRESMIP_HX'; ardir='AR_climlmt';yr1=1951;yr2=2020;pct=[99 99.9];
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
tpath='/work/miz/mat_hiresmip_cre/'; s='_readartcmcs_day_cre_new.mat';
expn='c192L33_am4p0_amip_HIRESMIP_HX'; yrs='_1951_2020_'; diag='_diag3';
...
% $$$ fext=strcat(yrs,'P01', diag,s); fn=strcat(tpath,expn,fext); load(fn);v1.p1=v;
% $$$ fext=strcat(yrs,'P00', diag,s); fn=strcat(tpath,expn,fext); load(fn);v1.p0=v;
% $$$ fext=strcat(yrs,'PA',  diag,s); fn=strcat(tpath,expn,fext); load(fn);v1.pa=v;
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
tpath='/work/miz/mat_hiresmip_cre/'; s='_readartcmcs_day_cre_new.mat';
expn='c192L33_am4p0_amip_HIRESMIP_HX_p2K'; yrs='_1951_2020_'; diag='_diag3';
...
% $$$ fext=strcat(yrs,'P01_', diag,s); fn=strcat(tpath,expn,fext); load(fn);v2.p1=v;
% $$$ fext=strcat(yrs,'P00_', diag,s); fn=strcat(tpath,expn,fext); load(fn);v2.p0=v;
% $$$ fext=strcat(yrs,'PA_',  diag,s); fn=strcat(tpath,expn,fext); load(fn);v2.pa=v;
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
tpath='/work/miz/mat_hiresmip_cre/'; s='_readartcmcs_day_cre_new.mat';
...
% $$$ fext=strcat(yrs,'P01', diag,s); fn=strcat(tpath,expn,fext); load(fn);w2.p1=v;
% $$$ fext=strcat(yrs,'P00', diag,s); fn=strcat(tpath,expn,fext); load(fn);w2.p0=v;
% $$$ fext=strcat(yrs,'PA',  diag,s); fn=strcat(tpath,expn,fext); load(fn);w2.pa=v;
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
tpath='/work/miz/mat_hiresmip_cre/'; s='_readartcmcs_day_cre_new.mat';
...
% $$$ fext=strcat(yrs,'P01', diag,s); fn=strcat(tpath,expn,fext); load(fn);v3.p1=v;
% $$$ fext=strcat(yrs,'P00', diag,s); fn=strcat(tpath,expn,fext); load(fn);v3.p0=v;
% $$$ fext=strcat(yrs,'PA',  diag,s); fn=strcat(tpath,expn,fext); load(fn);v3.pa=v;
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%===Fig 1: revision===: annual frequency of P-days %%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
p.cm=[0 0.0005 0.001 0.002 0.01:0.004:0.1 0.15:0.05:1]; p.c='k'; p.rescale=false;
v=ob; p.vn='obs_frqday_revision';
p.z1=squeeze(v.p2.frqday)*100;   
p.z5=squeeze(v.pr.frqday)*100;
p.z3=p.z1-p.z5;
p.z7=squeeze(v.al.frqday)*100;    
p.z2=squeeze(v.ar.frqday)*100;
p.z4=squeeze(v.tc.frqday)*100;    
p.z6=squeeze(v.mc.frqday)*100;    
p.z8=p.z5-p.z7;                          %global area weighted mean=26.999
...
p.s3='(b) frequency of drizzle days'; 
p.s5='(c) frequency of wet days'; 
p.s7='(d) frequency of storm (AR+TS+MCS) days'; 
p.s2='(e) frequency of AR days'; 
p.s4='(f) frequency of TS days';
p.s6='(g) frequency of MCS days'; 
p.s8='(h) frequency of wet non-storm days';
a=[0 100]; p.c1=a; p.c3=a; p.c5=a; p.un='\%'; p.fsize=8; p.optit=4; p.opt=4;p.nn=256;
a=[0 60];  p.c7=a; p.c2=a; p.c4=a; p.c6=a; p.c8=a;
plot_2d_8panel_revision(p)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%===Fig 2:revision===: annual mean LWCF contributed from AR/TS/MSC %%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
v=ob.ar; %all time mean prday from each weather type
p.lm=v.lm; p.x=v.lon; p.y=v.lat; p.xy=[0 360 -90 90];p.expn='c192';
...
p.aa=squeeze(v.aa); p.id=~isnan(p.aa); p.id(p.j1:p.j2,:)=0; id=p.id;
p.cm=[0 0.0005 0.001 0.002 0.01:0.02:0.08 0.1:0.05:1]; p.c='k'; p.rescale=false;
v=ob; p.vn='obs_lwcf_idwei_revision';
p.z1=squeeze(v.ar.lwcf_av); %p.z3=p.z1-p.z5;
p.z3=squeeze(v.p2.lwcf_idwei-v.pr.lwcf_idwei); 
p.z5=squeeze(v.pr.lwcf_idwei); 
p.z7=squeeze(v.al.lwcf_idwei);
p.z2=squeeze(v.ar.lwcf_idwei);
p.z4=squeeze(v.tc.lwcf_idwei);    
p.z6=squeeze(v.mc.lwcf_idwei);    
p.z8=p.z5-p.z7; %squeeze(v.al.lwcf_idwei./v.ar.lwcf_av)*100;    
%p=smoothp(p,1,1,'omitnan','shrink');
p.s1='(a) annual mean LW CRE';
p.s3='(b) LW CRE; drizzle days'; 
p.s5='(c) LW CRE; wet days';
p.s7='(d) LW CRE; storm (AR+TS+MCS) days';
p.s2='(e) LW CRE; AR days'; 
p.s4='(f) LW CRE; TS days';
p.s6='(g) LW CRE; MCS days'; 
p.s8='(h) LW CRE; wet non-storm days';
a=[0 80];  p.c1=a; p.c5=a; p.un='$\rm{W\,m^{-2}}$'; p.fsize=8; p.optit=4; p.opt=4;p.nn=256;
a=[-0 20]; p.c3=a; p.c2=a; p.c4=a; p.c6=a;
p.c7=[0 40]; p.c8=p.c7; p.rescale=false;
plot_2d_8panel_revision(p)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%===FigS1:revision===: LWCF averaged over storm days %%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
v=ob.ar; p.expn='c192'; %all time mean prday from each weather type
p.vn='lwcf_idavg'; p.lm=v.lm; p.x=v.lon; p.y=v.lat; p.xy=[0 360 -90 90];
lat0=-30; p.j1=max(find(v.lat<-lat0)); p.j2=min(find(v.lat>lat0));
p.aa=squeeze(v.aa); p.id=~isnan(p.aa); p.id(p.j1:p.j2,:)=0; id=p.id;
p.cm=[0 0.0005 0.001 0.002 0.01:0.02:0.08 0.1:0.05:1]; p.c='k'; p.rescale=false;
v=ob; p.vn='obs_lwcf_idavg_revision'; p.rescale=true; p.fact=8.948/0.26999;  
p.z1=squeeze(v.pd.lwcf_idavg);   
p.z3=squeeze(v.pc.lwcf_idavg); %p.z2=p.z2-p.z1*2;
p.z5=squeeze(v.pr.lwcf_idavg);
p.z7=squeeze(v.al.lwcf_idavg);    
p.z2=squeeze(v.ar.lwcf_idavg);    
p.z4=squeeze(v.tc.lwcf_idavg);    
p.z6=squeeze(v.mc.lwcf_idavg);    
p.z8=squeeze(v.pb.lwcf_idavg); %p.z8=p.z3-p.z7;
p.n1=squeeze(v.pd.frqday);   
p.n3=squeeze(v.pc.frqday);   
p.n5=squeeze(v.pr.frqday); 
p.n7=squeeze(v.al.frqday);    
p.n2=squeeze(v.ar.frqday);
p.n4=squeeze(v.tc.frqday);    
p.n6=squeeze(v.mc.frqday);    
p.n8=squeeze(v.pb.frqday);    
%p=smoothp(p,1,1,'omitnan','shrink');
p.s1='(a) LW CRE avg; non-precip days';
p.s3='(b) LW CRE avg; drizzle days'; 
p.s5='(c) LW CRE avg; wet days';
p.s7='(d) LW CRE avg; storm (AR+TS+MCS) days';
p.s2='(e) LW CRE avg; AR days'; 
p.s4='(f) LW CRE avg; TS days';
p.s6='(g) LW CRE avg; MCS days'; 
p.s8='(h) LW CRE avg; wet non-storm days'; 
a=[-2 120]; %a=[-30 30]; 
p.c1=a; p.c2=a; p.un='$\rm{W\,m^{-2}}$'; p.fsize=8; p.optit=7; p.opt=4;p.nn=256;
p.c3=a; p.c4=a; p.c5=a; p.c6=a; p.c7=a; p.c8=a; 
plot_2d_8panel_revision(p)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%===Fig3:revision===: annual mean SWCF contributed from AR/TS/MSC %%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
v=ob.ar; p.expn='c192'; %all time mean prday from each weather type
...
p.aa=squeeze(v.aa); p.id=~isnan(p.aa); p.id(p.j1:p.j2,:)=0; id=p.id;
p.cm=[0 0.0005 0.001 0.002 0.01:0.02:0.08 0.1:0.05:1]; p.c='k'; p.rescale=false;
v=ob; p.vn='obs_swcf_idwei_revision';
p.z1=squeeze(v.ar.swcf_av); %p.z3=p.z1-p.z5;
p.z3=squeeze(v.p2.swcf_idwei-v.pr.swcf_idwei); 
p.z5=squeeze(v.pr.swcf_idwei); 
p.z7=squeeze(v.al.swcf_idwei);
p.z2=squeeze(v.ar.swcf_idwei);
p.z4=squeeze(v.tc.swcf_idwei);    
p.z6=squeeze(v.mc.swcf_idwei);    
p.z8=p.z5-p.z7; %squeeze(v.al.swcf_idwei./v.ar.swcf_av)*100;    
%p=smoothp(p,1,1,'omitnan','shrink');
p.s1='(a) annual mean SW CRE';
p.s3='(b) SW CRE; drizzle days'; 
p.s5='(c) SW CRE; wet days'; 
p.s7='(d) SW CRE; storm (AR+TS+MCS) days;';
p.s2='(e) SW CRE; AR days;'; 
p.s4='(f) SW CRE; TS days;';
p.s6='(g) SW CRE; MCS days;'; 
p.s8='(h) SW CRE; wet non-storm days;';
a=[-80  2]; p.c1=a; p.c5=a; p.un='$\rm{W\,m^{-2}}$'; p.fsize=8; p.optit=4; p.opt=3;p.nn=256;
a=[-40  2]; p.c3=a; p.c7=a; p.c2=a; p.c4=a; p.c6=a; p.c8=a; p.rescale=false;
plot_2d_8panel_revision(p)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%===FigS2:revision===: SWCF averaged over storm days %%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
v=ob.ar; p.expn='c192'; %all time mean prday from each weather type
p.vn='swcf_idavg'; p.lm=v.lm; p.x=v.lon; p.y=v.lat; p.xy=[0 360 -90 90];
lat0=-30; p.j1=max(find(v.lat<-lat0)); p.j2=min(find(v.lat>lat0));
p.aa=squeeze(v.aa); p.id=~isnan(p.aa); p.id(p.j1:p.j2,:)=0; id=p.id;
p.cm=[0 0.0005 0.001 0.002 0.01:0.02:0.08 0.1:0.05:1]; p.c='k'; p.rescale=false;
v=ob; p.vn='obs_swcf_idavg_revision'; p.rescale=true; p.fact=-15.156/0.26999;
p.z1=squeeze(v.pd.swcf_idavg);   
p.z3=squeeze(v.pc.swcf_idavg); %p.z2=p.z2-p.z1*2;
p.z5=squeeze(v.pr.swcf_idavg);
p.z7=squeeze(v.al.swcf_idavg);    
p.z2=squeeze(v.ar.swcf_idavg);    
p.z4=squeeze(v.tc.swcf_idavg);    
p.z6=squeeze(v.mc.swcf_idavg);    
p.z8=squeeze(v.pb.swcf_idavg); %p.z8=p.z3-p.z7;
p.n1=squeeze(v.pd.frqday);   
p.n3=squeeze(v.pc.frqday);   
p.n5=squeeze(v.pr.frqday); 
p.n7=squeeze(v.al.frqday);    
...
p.s3='(b) SW CRE avg. drizzle days'; 
p.s5='(c) SW CRE avg. wet days';
p.s7='(d) SW CRE avg. storm (AR+TS+MCS) days';
p.s2='(e) SW CRE avg. AR days'; 
p.s4='(f) SW CRE avg. TS days';
p.s6='(g) SW CRE avg. MCS days'; 
p.s8='(h) SW CRE avg. wet non-storm days'; 
a=[-120 2]; p.c1=a; p.un='$\rm{W\,m^{-2}}$'; p.fsize=8; p.optit=7; p.opt=3;p.nn=256;
a=[-120 2]; p.c2=a; p.c3=a; p.c4=a; p.c5=a; p.c6=a; p.c7=a; p.c8=a;
plot_2d_8panel_revision(p)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%v=v0; p.vn='mod_prday_idwei';
%v=v1; p.vn='ctl_prday_idwei';
%v=v1; p.vn='ng1_prday_idwei';
%v=v2; p.vn='ng2_prday_idwei';
p.z1=squeeze(v.ar.prday_av);   
p.z2=squeeze(v.p2.prday_idwei);   
p.z3=squeeze(v.pr.prday_idwei); 
p.z4=squeeze(v.ar.prday_idwei);
p.z5=squeeze(v.tc.prday_idwei);    
p.z6=squeeze(v.mc.prday_idwei);    
p.z7=squeeze(v.al.prday_idwei); p.z2=p.z2-p.z3;
%p.z7=p.z2-p.z3; p.z7=(p.z4+p.z5+p.z6);
p.z8=p.z3-p.z7;
%p=smoothp(p,1,1,'omitnan','shrink');
p.s1='(a) annual mean Pr';
p.s2='(b) annual mean Pr from drizzle days'; 
...
a=[0 10]; p.c1=a; p.un='mm/day'; p.fsize=8; p.optit=4; p.opt=7;p.nn=256;
a=[0 10];  p.c2=a; p.c3=p.c1; 
a=[0 10];  p.c4=a; p.c5=a; p.c6=a; p.c7=a; p.c8=a; p.rescale=false;
plot_2d_8panel(p)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
v=ob.ar; p.expn='c192'; %all time mean prday from each weather type
p.vn='prday_idavg'; p.lm=v.lm; p.x=v.lon; p.y=v.lat; p.xy=[0 360 -90 90];
lat0=-30; p.j1=max(find(v.lat<-lat0)); p.j2=min(find(v.lat>lat0));
p.aa=squeeze(v.aa); p.id=~isnan(p.aa); p.id(p.j1:p.j2,:)=0; id=p.id;
p.cm=[0 0.0005 0.001 0.002 0.01:0.02:0.08 0.1:0.05:1]; p.c='k'; p.rescale=false;
p.cm=[0 0.0005 0.001 0.002 0.01:0.004:0.1 0.15:0.05:1]; p.c='k'; p.rescale=false;
v=ob; p.vn='obs_prday_idavg'; p.rescale=true; p.fact=1.234/0.26999;
%v=v0; p.vn='mod_prday_idavg';
%v=v1; p.vn='ng1_prday_idavg';
%v=v2; p.vn='ng1_prday_idavg';
p.z1=squeeze(v.pd.prday_idavg);   
p.z2=squeeze(v.pc.prday_idavg); %p.z2=p.z2-p.z1*2;
p.z3=squeeze(v.pr.prday_idavg);
p.z4=squeeze(v.ar.prday_idavg);    
p.z5=squeeze(v.tc.prday_idavg);    
p.z6=squeeze(v.mc.prday_idavg);    
p.z7=squeeze(v.al.prday_idavg);    
p.z8=squeeze(v.pb.prday_idavg);
%p=smoothp(p,1,1,'omitnan','shrink');
p.n1=squeeze(v.pd.frqday);   
...
a=[0 25];  p.c1=a; p.c2=a; p.un='mm/day'; p.fsize=8; p.optit=7; p.opt=7;p.nn=256;
a=[0 25]; p.c3=a; p.c4=a; p.c5=a; p.c6=a; p.c7=a; p.c8=a; 
plot_2d_8panel(p)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%===FigA4===: annual convective precipitation fraction (%) from P-days
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
v=ob.ar; %all time mean fprc from each weather type
p.lm=v.lm; p.x=v.lon; p.y=v.lat; p.xy=[0 360 -90 90];p.expn='c192';
lat0=-30; p.j1=max(find(v.lat<-lat0)); p.j2=min(find(v.lat>lat0));
p.aa=squeeze(v.aa); p.id=~isnan(p.aa); p.id(p.j1:p.j2,:)=0; id=p.id;
p.cm=[0 0.0005 0.001 0.002 0.01:0.02:0.08 0.1:0.05:1]; p.c='k'; p.rescale=false;
v=ob; p.vn='obs_fprc_idwei';
v=v0; p.vn='mod_fprc_idwei';
%v=v1; p.vn='ng1_fprc_idwei';
%v=v2; p.vn='ng2_fprc_idwei';
p.z1=squeeze(v.ar.fprc_av)*100;   
p.z2=squeeze(v.p2.fprc_idwei)*100;   
p.z3=squeeze(v.pr.fprc_idwei)*100; 
p.z4=squeeze(v.ar.fprc_idwei)*100;
p.z5=squeeze(v.tc.fprc_idwei)*100;    
p.z6=squeeze(v.mc.fprc_idwei)*100;    
p.z7=squeeze(v.al.fprc_idwei)*100; p.z2=p.z2-p.z3;   
%p.z7=p.z2-p.z3; p.z7=(p.z4+p.z5+p.z6);
p.z8=p.z3-p.z7;
%p=smoothp(p,1,1,'omitnan','shrink');
p.s1='(a) annual mean CPF';
p.s2='(b) annual mean CPF from drizzle days'; 
...
a=[0 80]; p.c1=a; p.un='%'; p.fsize=8; p.optit=4; p.opt=5;p.nn=256;
a=[0 40]; p.c2=a; p.c3=p.c1; 
a=[0 40]; p.c4=a; p.c5=a; p.c6=a; p.c7=p.c1; p.c8=p.c1; p.rescale=false;
plot_2d_8panel(p)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%===FigA5===: PR averaged over various P-days %%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
v=ob.ar; p.expn='c192'; %all time mean fprc from each weather type
p.vn='fprc_idavg'; p.lm=v.lm; p.x=v.lon; p.y=v.lat; p.xy=[0 360 -90 90];
lat0=-30; p.j1=max(find(v.lat<-lat0)); p.j2=min(find(v.lat>lat0));
p.aa=squeeze(v.aa); p.id=~isnan(p.aa); p.id(p.j1:p.j2,:)=0; id=p.id;
p.cm=[0 0.0005 0.001 0.002 0.01:0.02:0.08 0.1:0.05:1]; p.c='k'; p.rescale=false;
v=ob; p.vn='obs_fprc_idavg';
v=v0; p.vn='mod_fprc_idavg';
%v=v1; p.vn='ng1_fprc_idavg';
%v=v2; p.vn='ng1_fprc_idavg';
p.z1=squeeze(v.pd.fprc_idavg)*100;   
p.z2=squeeze(v.pc.fprc_idavg)*100; %p.z2=p.z2-p.z1*2;
p.z3=squeeze(v.pr.fprc_idavg)*100;
p.z4=squeeze(v.ar.fprc_idavg)*100;    
p.z5=squeeze(v.tc.fprc_idavg)*100;    
p.z6=squeeze(v.mc.fprc_idavg)*100;    
p.z7=squeeze(v.al.fprc_idavg)*100;    
p.z8=squeeze(v.pb.fprc_idavg)*100; %p.z8=p.z3-p.z7;
%p=smoothp(p,1,1,'omitnan','shrink');
p.n1=squeeze(v.pd.frqday);   
p.n2=squeeze(v.pc.frqday);   
p.n3=squeeze(v.pr.frqday); 
...
a=[0 100]; 
p.c1=a; p.c2=a; p.un='%'; p.fsize=8; p.optit=7; p.opt=5;p.nn=256;
p.c3=a; p.c4=a; p.c5=a; p.c6=a; p.c7=a; p.c8=a;  p.rescale=false;
plot_2d_8panel(p)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%===FigA5===: CPF averaged over various P-days %%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
v=ob.ar; p.expn='c192'; %all time mean fprc from each weather type
p.lm=v.lm; p.x=v.lon; p.y=v.lat; p.xy=[0 360 -90 90];
...
p.cm=[0 0.0005 0.001 0.002 0.01:0.02:0.08 0.1:0.05:1]; p.c='k'; p.rescale=false;
%v=ob; p.vn='obs_fprc_idavg';
v=v0; p.vn='mod_fprc_idx4_avg'; i=4;
p.z1=squeeze(v.pd.fprc_idx_avg(1,i,:,:))*100;   
p.z2=squeeze(v.pc.fprc_idx_avg(1,i,:,:))*100; %p.z2=p.z2-p.z1*2;
p.z3=squeeze(v.pr.fprc_idx_avg(1,i,:,:))*100;
p.z4=squeeze(v.ar.fprc_idx_avg(1,i,:,:))*100;    
p.z5=squeeze(v.tc.fprc_idx_avg(1,i,:,:))*100;    
p.z6=squeeze(v.mc.fprc_idx_avg(1,i,:,:))*100;    
p.z7=squeeze(v.al.fprc_idx_avg(1,i,:,:))*100;    
p.z8=squeeze(v.pb.fprc_idx_avg(1,i,:,:))*100; %p.z8=p.z3-p.z7;
%p=smoothp(p,1,1,'omitnan','shrink');
p.n1=squeeze(v.pd.frqday);   
p.n2=squeeze(v.pc.frqday);   
p.n3=squeeze(v.pr.frqday); 
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%===FigA6===: annual precipitation from P-days %%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
v=ob.ar; %all time mean fprc from each weather type
p.lm=v.lm; p.x=v.lon; p.y=v.lat; p.xy=[0 360 -90 90];p.expn='c192';
...
%v=v0; p.vn='mod_prw_idwei';
p.z1=squeeze(v.ar.prw_av);   
p.z2=squeeze(v.p2.prw_idwei);   
p.z3=squeeze(v.pr.prw_idwei); 
p.z4=squeeze(v.ar.prw_idwei);
p.z5=squeeze(v.tc.prw_idwei);    
p.z6=squeeze(v.mc.prw_idwei);    
p.z7=squeeze(v.al.prw_idwei); p.z2=p.z2-p.z3;
p.z8=p.z3-p.z7;
%p=smoothp(p,1,1,'omitnan','shrink');
p.s1='(a) annual mean PRW';
p.s2='(b) annual mean PRW from drizzle days'; 
...
a=[0 40]; p.c1=a; p.un='kg/m2'; p.fsize=8; p.optit=4; p.opt=7;p.nn=256;
a=[0 40]; p.c2=a; p.c3=p.c1; 
a=[0 40]; p.c4=a; p.c5=a; p.c6=a; p.c7=a; p.c8=a; 
plot_2d_8panel(p)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%===FigA7===: PRW averaged over various P-days %%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
v=ob.ar; p.expn='c192'; %all time mean prw from each weather type
p.vn='prw_idavg'; p.lm=v.lm; p.x=v.lon; p.y=v.lat; p.xy=[0 360 -90 90];
lat0=-30; p.j1=max(find(v.lat<-lat0)); p.j2=min(find(v.lat>lat0));
p.aa=squeeze(v.aa); p.id=~isnan(p.aa); p.id(p.j1:p.j2,:)=0; id=p.id;
p.cm=[0 0.0005 0.001 0.002 0.01:0.02:0.08 0.1:0.05:1]; p.c='k'; p.rescale=false;
v=ob; p.vn='obs_prw_idavg'; p.rescale=true; p.fact=8.292/0.26999;
%v=v0; p.vn='mod_prw_idavg';
%v=v1; p.vn='ng1_prw_idavg';
%v=v2; p.vn='ng1_prw_idavg';
p.z1=squeeze(v.pd.prw_idavg);   
p.z2=squeeze(v.pc.prw_idavg); %p.z2=p.z2-p.z1*2;
p.z3=squeeze(v.pr.prw_idavg);
p.z4=squeeze(v.ar.prw_idavg);    
p.z5=squeeze(v.tc.prw_idavg);    
p.z6=squeeze(v.mc.prw_idavg);    
p.z7=squeeze(v.al.prw_idavg);    
p.z8=squeeze(v.pb.prw_idavg); %p.z8=p.z3-p.z7;
%p=smoothp(p,1,1,'omitnan','shrink');
p.n1=squeeze(v.pd.frqday);   
p.n2=squeeze(v.pc.frqday);   
p.n3=squeeze(v.pr.frqday); 
...
a=[0 70]; %a=[-30 30]; 
p.c1=a; p.c2=a; p.un='kg/m2'; p.fsize=8; p.optit=7; p.opt=5;p.nn=256;
p.c3=a; p.c4=a; p.c5=a; p.c6=a; p.c7=a; p.c8=a; 
plot_2d_8panel(p)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%v=v0; p.vn='mod_ttcf_idwei';
%v=v1; p.vn='ng1_ttcf_idwei';
...
p.z7=squeeze(v.al.ttcf_idwei);  p.z2=p.z2-p.z3;  
p.z8=p.z3-p.z7; %p.z8=squeeze(v.al.ttcf_idwei./v.ar.ttcf_av)*100;    
%p=smoothp(p,1,1,'omitnan','shrink');
p.s1='(a) annual mean total CRE';
p.s2='(b) total CRE from drizzle days'; 
...
a=[-60 60]; p.c1=a; p.un='W/m2'; p.fsize=8; p.optit=4; p.opt=5;p.nn=256;
a=[-60 60]; p.c2=a; p.c3=a; 
a=[-10 10]; p.c4=a; p.c5=a; p.c6=a; p.c7=a; p.c8=a; p.rescale=false;
plot_2d_8panel(p)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
p.aa=squeeze(v.aa); p.id=~isnan(p.aa); p.id(p.j1:p.j2,:)=0; id=p.id;
p.cm=[0 0.0005 0.001 0.002 0.01:0.02:0.08 0.1:0.05:1]; p.c='k'; p.rescale=false;
v=ob; p.vn='obs_ttcf_idavg';
%v=v0; p.vn='mod_ttcf_idavg';
%v=v1; p.vn='ng1_ttcf_idavg';
...
a=[-50 50];  p.c1=a; p.un='W/m2'; p.fsize=8; p.optit=7; p.opt=5;p.nn=256;
a=[-50 50]; p.c2=a; p.c3=a; p.c4=a; p.c5=a; p.c6=a; p.c7=a; p.c8=a;
p.rescale=true; p.fact=-6.208/0.26999;
plot_2d_8panel(p)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%v=v0; p.vn='mod_rlut_idwei';
%v=v1; p.vn='ng1_rlut_idwei';
%v=v2; p.vn='ng2_rlut_idwei';
...
p.z8=p.z3-p.z7; %p.z8=squeeze(v.al.rlut_idwei./v.ar.rlut_av)*100;    
%p=smoothp(p,1,1,'omitnan','shrink');
...
a=[0 300]; p.c1=a; p.un='W/m2'; p.fsize=7; p.optit=4; p.opt=1;p.nn=256;
a=[0 300]; p.c2=a; p.c3=a; 
a=[0 50];  p.c4=a; p.c5=a; p.c6=a; p.c7=[0 200]; p.c8=p.c7; p.rescale=false;
plot_2d_8panel(p)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
p.cm=[0 0.0005 0.001 0.002 0.01:0.02:0.08 0.1:0.05:1]; p.c='k'; p.rescale=false;
v=ob; p.vn='obs_rlut_idavg';
%v=v0; p.vn='mod_rlut_idavg';
%v=v1; p.vn='ng1_rlut_idavg';
%v=v2; p.vn='ng2_rlut_idavg';
...
a=[100 300]; p.c1=a; p.un='W/m2'; p.fsize=7; p.optit=7; p.opt=1;p.nn=256;
a=[100 300]; p.c2=a; p.c3=a; 
a=[100 300]; p.c4=a; p.c5=a; p.c6=a; p.c7=a; p.c8=a;
p.rescale=true; p.fact=63.051/0.26999;
plot_2d_8panel(p)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
p.z8=p.z3-p.z7; %p.z8=squeeze(v.al.rlutcs_idwei./v.ar.rlutcs_av)*100;    
%p=smoothp(p,1,1,'omitnan','shrink');
...
p.aa=squeeze(v0.ar.aa); p.id=~isnan(p.aa); p.id(p.j1:p.j2,:)=0; id=p.id;
p.cm=[0 0.0005 0.001 0.002 0.01:0.02:0.08 0.1:0.05:1]; p.c='k'; p.rescale=false;
v=ob; p.vn='obs_rlutcs_idavg';
%v=v0; p.vn='mod_rlutcs_idavg';
...
a=[100 300]; p.c2=a; p.c3=a; 
a=[100 300]; p.c4=a; p.c5=a; p.c6=a; p.c7=a; p.c8=a;
p.rescale=true; p.fact=71.998/0.26999;
plot_2d_8panel(p)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%v=v0; p.vn='mod_swabs_idwei';
%v=v1; p.vn='ng1_swabs_idwei';
p.z1=squeeze(v.ar.swabs_av);   
p.z2=squeeze(v.p2.swabs_idwei);   
p.z3=squeeze(v.pr.swabs_idwei); 
p.z4=squeeze(v.ar.swabs_idwei);
p.z5=squeeze(v.tc.swabs_idwei);    
p.z6=squeeze(v.mc.swabs_idwei);    
p.z7=squeeze(v.al.swabs_idwei);    
p.z8=p.z3-p.z7; %p.z8=squeeze(v.al.swabs_idwei./v.ar.swabs_av)*100;    
%p=smoothp(p,1,1,'omitnan','shrink');
...
a=[0 350]; p.c1=a; p.un='W/m2'; p.fsize=7; p.optit=4; p.opt=1;p.nn=256;
a=[0 350]; p.c2=a; p.c3=a; 
a=[0 50]; p.c4=a; p.c5=a; p.c6=a; p.c7=[0 200]; p.c8=p.c7; p.rescale=false;
plot_2d_8panel(p)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
p.aa=squeeze(v0.ar.aa); p.id=~isnan(p.aa); p.id(p.j1:p.j2,:)=0; id=p.id;
p.cm=[0 0.0005 0.001 0.002 0.01:0.02:0.08 0.1:0.05:1]; p.c='k'; p.rescale=false;
v=ob; p.vn='obs_swabs_idavg';
%v=v0; p.vn='mod_swabs_idavg';
%v=v1; p.vn='ng1_swabs_idavg';
p.z1=squeeze(v.pd.swabs_idavg);   
p.z2=squeeze(v.pc.swabs_idavg);   
p.z3=squeeze(v.pr.swabs_idavg); 
p.z4=squeeze(v.ar.swabs_idavg);
p.z5=squeeze(v.tc.swabs_idavg);    
p.z6=squeeze(v.mc.swabs_idavg);    
p.z7=squeeze(v.al.swabs_idavg);    
p.z8=squeeze(v.pb.swabs_idavg); 
%p=smoothp(p,1,1,'omitnan','shrink');
p.n1=squeeze(v.pd.frqday);   
p.n2=squeeze(v.pc.frqday);   
p.n3=squeeze(v.pr.frqday); 
...
a=[50 350]; p.c1=a; p.un='W/m2'; p.fsize=7; p.optit=7; p.opt=1;p.nn=256;
a=[50 350]; p.c2=a; p.c3=a; 
a=[50 350]; p.c4=a; p.c5=a; p.c6=a; p.c7=a; p.c8=a;
p.rescale=true; p.fact=63.861/0.26999;
plot_2d_8panel(p)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%v=v0; p.vn='mod_rsut_idwei';
%v=ve; p.vn='ens_rsut_idwei';
p.z1=squeeze(v.ar.rsut_av);   
p.z2=squeeze(v.p2.rsut_idwei);   
p.z3=squeeze(v.pr.rsut_idwei); 
p.z4=squeeze(v.ar.rsut_idwei);
p.z5=squeeze(v.tc.rsut_idwei);    
p.z6=squeeze(v.mc.rsut_idwei);    
p.z7=squeeze(v.al.rsut_idwei);    
p.z8=p.z3-p.z7; %p.z8=squeeze(v.al.rsut_idwei./v.ar.rsut_av)*100;    
%p=smoothp(p,1,1,'omitnan','shrink');
...
a=[0 150]; p.c1=a; p.un='W/m2'; p.fsize=7; p.optit=4; p.opt=1;p.nn=256;
a=[0 150]; p.c2=a; p.c3=a; 
a=[0 50]; p.c4=a; p.c5=a; p.c6=a; p.c7=[0 100]; p.c8=p.c7; p.rescale=false;
plot_2d_8panel(p)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
p.aa=squeeze(v.aa); p.id=~isnan(p.aa); p.id(p.j1:p.j2,:)=0; id=p.id;
p.cm=[0 0.0005 0.001 0.002 0.01:0.02:0.08 0.1:0.05:1]; p.c='k'; p.rescale=false;
v=ob; p.vn='obs_rsut_idavg';
%v=v0; p.vn='mod_rsut_idavg';
%v=v1; p.vn='ng1_rsut_idavg';
p.z1=squeeze(v.pd.rsut_idavg);   
p.z2=squeeze(v.pc.rsut_idavg);   
p.z3=squeeze(v.pr.rsut_idavg); 
p.z4=squeeze(v.ar.rsut_idavg);
p.z5=squeeze(v.tc.rsut_idavg);    
p.z6=squeeze(v.mc.rsut_idavg);    
p.z7=squeeze(v.al.rsut_idavg);    
p.z8=squeeze(v.pb.rsut_idavg); 
%p=smoothp(p,1,1,'omitnan','shrink');
p.n1=squeeze(v.pd.frqday);   
p.n2=squeeze(v.pc.frqday);   
p.n3=squeeze(v.pr.frqday); 
...
a=[0 200]; p.c1=a; p.un='W/m2'; p.fsize=7; p.optit=7; p.opt=1;p.nn=256;
a=[0 200]; p.c2=a; p.c3=a; 
a=[0 200];  p.c4=a; p.c5=a; p.c6=a; p.c7=a; p.c8=a;
p.rescale=true; p.fact=27.802/0.26999;
plot_2d_8panel(p)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%Fig14: annual mean TOA SW relection averaged from AR/TS/MSC %%%%
...
p.aa=squeeze(v.aa); p.id=~isnan(p.aa); p.id(p.j1:p.j2,:)=0; id=p.id;
p.cm=[0 0.0005 0.001 0.002 0.01:0.02:0.08 0.1:0.05:1]; p.c='k'; p.rescale=false;
v=ob; p.vn='obs_rsutcs_idavg';
%v=v0; p.vn='mod_rsutcs_idavg';
%v=v1; p.vn='ng1_rsutcs_idavg';
p.z1=squeeze(v.pd.rsutcs_idavg);   
p.z2=squeeze(v.pc.rsutcs_idavg);   
p.z3=squeeze(v.pr.rsutcs_idavg); 
p.z4=squeeze(v.ar.rsutcs_idavg);
p.z5=squeeze(v.tc.rsutcs_idavg);    
p.z6=squeeze(v.mc.rsutcs_idavg);    
p.z7=squeeze(v.al.rsutcs_idavg);    
p.z8=squeeze(v.pb.rsutcs_idavg); 
%p=smoothp(p,1,1,'omitnan','shrink');
p.n1=squeeze(v.pd.frqday);   
p.n2=squeeze(v.pc.frqday);   
p.n3=squeeze(v.pr.frqday); 
...
p.s7='(g) SW relection avg. storm (AR+TS+MCS) days;';
p.s8='(h) SW relection avg. wet non-storm days';
a=[0 50]; p.c1=a; p.un='W/m2'; p.fsize=7; p.optit=7; p.opt=1;p.nn=256;
a=[0 50]; p.c2=a; p.c3=a; 
a=[0 50];  p.c4=a; p.c5=a; p.c6=a; p.c7=a; p.c8=a;
p.rescale=true; p.fact=27.802/0.26999;
plot_2d_8panel(p)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%v=v0; p.vn='mod_netrad_idwei';
%v=v1; p.vn='ng1_netrad_idwei';
...
a=[-100 100]; p.c1=a; p.un='W/m2'; p.fsize=7; p.optit=4; p.opt=6;p.nn=256;
a=[-100 100]; p.c2=a; p.c3=a; 
a=[-10  10];  p.c4=a; p.c5=a; p.c6=a; p.c7=[-50 50]; p.c8=p.c7; p.rescale=false;
plot_2d_8panel(p)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
p.aa=squeeze(v.aa); p.id=~isnan(p.aa); p.id(p.j1:p.j2,:)=0; id=p.id;
p.cm=[0 0.0005 0.001 0.002 0.01:0.02:0.08 0.1:0.05:1]; p.c='k'; p.rescale=false;
v=ob; p.vn='obs_netrad_idavg';
%v=v0; p.vn='mod_netrad_idavg';
%v=v1; p.vn='ng1_netrad_idavg';
...
a=[-100 100]; p.c1=a; p.un='W/m2'; p.fsize=7; p.optit=7; p.opt=1;p.nn=256;
a=[-100 100]; p.c2=a; p.c3=a; 
a=[-100 100]; p.c4=a; p.c5=a; p.c6=a; p.c7=a; p.c8=a;
p.rescale=true; p.fact=0.811/0.26999;
plot_2d_8panel(p)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
