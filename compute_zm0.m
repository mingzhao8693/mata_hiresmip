function al=compute_zm0(xx,aa,opt)
a=squeeze(xx.frqday_org);  al.frqday_org =mean(a,2);
a=squeeze(xx.frqday);      al.frqday     =mean(a,2);
a=squeeze(xx.tas_idwei);   al.tas_idwei  =mean(a,2);
a=squeeze(xx.prday_idwei); al.prday_idwei=mean(a,2);
a=squeeze(xx.lwcf_idwei);  al.lwcf_idwei =mean(a,2);
a=squeeze(xx.swcf_idwei);  al.swcf_idwei =mean(a,2);
a=squeeze(xx.ttcf_idwei);  al.ttcf_idwei =mean(a,2);
...
if (opt==1)
  a=squeeze(xx.prc_idwei);    al.prc_idwei   =mean(a,2);
  a=squeeze(xx.prl_idwei);    al.prl_idwei   =mean(a,2);
  a=squeeze(xx.cvh_idwei);    al.cvh_idwei   =mean(a,2);
  a=squeeze(xx.lsh_idwei);    al.lsh_idwei   =mean(a,2);
  a=squeeze(xx.dcv_idwei);    al.dcv_idwei   =mean(a,2);
  a=squeeze(xx.dls_idwei);    al.dls_idwei   =mean(a,2);
  a=squeeze(xx.qlcond_idwei); al.qlcond_idwei=mean(a,2);
  a=squeeze(xx.qicond_idwei); al.qicond_idwei=mean(a,2);
