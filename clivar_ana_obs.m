function v=clivar_ana_obs(tpath,latlon,region)
...
a=permute(a,[2 1 3 4]); msl_ano=msl-a;
%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%
...
%%%%%%%%%%%%%%%%%%%%%%%%%
m1=1; m2=12; y1=1; y2=37; nyr=y2-y1+1; nmn=m2-m1+1;
a=z1000_ano; b=z700_ano; c=z500_ano; d=msl_ano;
for j=1:v.nlat
  a(:,:,j,:)=a(:,:,j,:)*sqrt(cos(v.lat(j)/180*pi));
  b(:,:,j,:)=b(:,:,j,:)*sqrt(cos(v.lat(j)/180*pi));
...
fn=strcat('/work/miz/mat_hiresmip/obs_clivar_ana','_',region,'.mat')
