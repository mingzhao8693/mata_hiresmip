function plot_5panel_mapp(k,v,s,z1,zo,b1,b2,b3,icmap)
...
subplot('Position',p5); b3(b3<cmin)=cmin; b3(b3>cmax)=cmax;
do_mapproj(lat,lon,b3,vbin,latx,lonx,lm,domap,xy);
caxis([cmin cmax]); colormap(cmap1); 
title(v.s5,'FontSize',fsize);
