function plot_2d_8panel_revision(p)
%str=vname(end-2:end);
...
elseif (p.optit==7)
  ...
  s1=sprintf('%s (%4.2f %s)',s1,z1_mean,p.un);
  s2=sprintf('%s (%4.2f %s)',s2,z2_mean,p.un);
  s3=sprintf('%s (%4.2f %s)',s3,z3_mean,p.un); 
  s4=sprintf('%s (%4.2f %s)',s4,z4_mean,p.un);
  s5=sprintf('%s (%4.2f %s)',s5,z5_mean,p.un); 
  s6=sprintf('%s (%4.2f %s)',s6,z6_mean,p.un); 
  s7=sprintf('%s (%4.2f %s)',s7,z7_mean,p.un); 
  s8=sprintf('%s (%4.2f %s)',s8,z8_mean,p.un); 
elseif (p.optit==8)
...
pcolor(x,y,a); hold on; shading flat; caxis([p.c1]); %contour(x,y,a,[25 75],'c','LineWidth',1);
hc=colorbar; title(hc,unit,fsize,'Interpreter','latex')
...
pcolor(x,y,a); hold on; shading flat; caxis([p.c2]); 
hc=colorbar; title(hc,unit,fsize,'Interpreter','latex')
contour(x,y,lm,1,p.c); axis(xy);
...
pcolor(x,y,a); hold on; shading flat; caxis([p.c3]); 
hc=colorbar; title(hc,unit,fsize,'Interpreter','latex')
contour(x,y,lm,1,p.c); axis(xy); 
ylabel(yl,'FontSize',fsize,'Interpreter','latex'); 
set(gca,'FontSize',fsize);
...
pcolor(x,y,a); hold on; shading flat; caxis([p.c4]); 
hc=colorbar; title(hc,unit,fsize,'Interpreter','latex')
contour(x,y,lm,1,p.c); axis(xy); 
%ylabel(yl,'FontSize',fsize); 
set(gca,'FontSize',fsize);
...
pcolor(x,y,a); hold on; shading flat; caxis([p.c5]); 
hc=colorbar; title(hc,unit,fsize,'Interpreter','latex')
contour(x,y,lm,1,p.c); axis(xy); 
ylabel(yl,'FontSize',fsize,'Interpreter','latex'); 
set(gca,'FontSize',fsize);
...
pcolor(x,y,a); hold on; shading flat; caxis([p.c6]); 
hc=colorbar; title(hc,unit,fsize,'Interpreter','latex')
contour(x,y,lm,1,p.c); axis(xy); 
%ylabel(yl,'FontSize',fsize); 
set(gca,'FontSize',fsize);
...
pcolor(x,y,a); hold on; shading flat; caxis([p.c7]); 
hc=colorbar; title(hc,unit,fsize,'Interpreter','latex')
contour(x,y,lm,1,p.c); axis(xy); 
...
pcolor(x,y,a); hold on; shading flat; caxis([p.c8]); 
hc=colorbar; title(hc,unit,fsize,'Interpreter','latex')
contour(x,y,lm,1,p.c); axis(xy); 
xlabel(xl,'FontSize',fsize,'Interpreter','latex'); 
%ylabel(yl,'FontSize',fsize); 
