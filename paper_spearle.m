...
p.yr1='1921'; p.yr2='2100'; p.myr=1; p.do_trend=1;
p.syr=1; p.nyr=180; p.y1=1921; p.y2=2100; p.opt=0
...
%test plot
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
x0=-v.tr.sst.hadisst.ind.wme; y0=v.tr.slp.obs.ind.soi;
x1=-v.tr.tsurf.mod.ind.wme;   y1=v.tr.slp.mod.ind.soi;
pms=[ 0, 0, 1600, 1000]; t=[1959:2020]; lw=2;
handle=figure('Position',pms,'visible','on');
plot(t,x0-mean(x0),'b','LineWidth',lw); hold on;
plot(t,y0-mean(y0),'r','LineWidth',lw);
plot(t,x1-mean(x1),'b--');
plot(t,y1-mean(y1),'r--');
...
tpath='/archive/Ming.Zhao/am4_spear/'; 
expn0='SPEAR_c192_o1_Hist_AllForc_IC1921_K50_ens_';
fext='_global_opt0.c96_tsana_spearle_';
...
for i=1:30
  ...
  fn=strcat(tpath,expn,'/',expn,fext,period1,'.mat')
  load(fn); vm(i).sst=v.tr.sst; vm(i).sst.mod=v.tr.tsurf.mod;
...
pms=[ 0, 0, 850, 780]*0.5; fsize=10; ms=10; row=1; col=1; lw=2;
handle=figure('Position',pms,'visible','on'); 
