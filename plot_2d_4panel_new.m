...
elseif (p.optit==0)
  ...
  s4=sprintf('%s (mean:%5.3f)',s4,z4_mean);
elseif (p.optit==1)
  s1=sprintf('%s (mean:%5.3f mm/day/K)',s1,z1_mean);
  s2=sprintf('%s (mean:%5.3f mm/day/K)',s2,z2_mean);
  s3=sprintf('%s (mean:%5.3f mm/day/K)',s3,z3_mean); 
  s4=sprintf('%s (mean:%5.3f mm/day/K)',s4,z4_mean);
elseif (p.optit==2)
  s1=sprintf('%s (global mean:%5.3f%%/K)',s1,p.dz1_mean);
  s2=sprintf('%s (global mean:%5.3f%%/K)',s2,p.dz2_mean);
  s3=sprintf('%s (global mean:%5.3f%%/K)',s3,p.dz3_mean); 
  s4=sprintf('%s (global mean:%5.3f%%/K)',s4,p.dz4_mean);
elseif (p.optit==3)
  s1=sprintf('%s (mean:%5.2fW/m2/K)',s1,z1_mean);
  s2=sprintf('%s (mean:%5.2fW/m2/K)',s2,z2_mean);
  s3=sprintf('%s (mean:%5.2fW/m2/K)',s3,z3_mean); 
  s4=sprintf('%s (mean:%5.2fW/m2/K)',s4,z4_mean);
elseif (p.optit==4)
  s1=sprintf('%s (mean:%5.2fmm/day/K)',s1,z1_mean);
  s2=sprintf('%s (mean:%5.2fmm/day/K)',s2,z2_mean);
  s3=sprintf('%s (mean:%5.2fmm/day/K)',s3,z3_mean); 
  s4=sprintf('%s (mean:%5.2fmm/day/K)',s4,z4_mean);
else
  disp('no title');
end
%xy=[0 360 -90 90]; 
...
pms=[ 0, 0, 1100, 600]*1; fsize=10; lw=2; row=2; col=2;
