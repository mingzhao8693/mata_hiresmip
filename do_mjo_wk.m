...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%rkm_dp OLR sensitivity Fig in AM4.0 paper%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
cmin=0.5; cmax=1.6; zbin=[cmin:(cmax-cmin)/10:cmax]; 
xy=[-15 15 0 0.5]; d=o.d; wsize_x=1; wsize_y=3;
...
subplot(row,col,1); v=am4.c1.olr;  
x=v.x; y=v.y; z=v.var_sym_filt; %pcolor(x,y,z);
[x,y,z]=smoothwk(x,y,z,wsize_x,wsize_y);
contourf(x,y,z,zbin); hold on; shading flat; colorbar;
plot(d.xx,d.AfreqKelvinRossby(:,1:5));
...
subplot(row,col,2); v=am4.c2.olr;  
x=v.x; y=v.y; z=v.var_sym_filt; %pcolor(x,y,z);
[x,y,z]=smoothwk(x,y,z,wsize_x,wsize_y);
contourf(x,y,z,zbin); hold on; shading flat; colorbar;
plot(d.xx,d.AfreqKelvinRossby(:,1:5));
...
subplot(row,col,3); v=am4.c3.olr;  
x=v.x; y=v.y; z=v.var_sym_filt; %pcolor(x,y,z);
[x,y,z]=smoothwk(x,y,z,wsize_x,wsize_y);
contourf(x,y,z,zbin); hold on; shading flat; colorbar;
plot(d.xx,d.AfreqKelvinRossby(:,1:5));
...
subplot(row,col,4); v=am4.c4.olr;  
x=v.x; y=v.y; z=v.var_sym_filt; %pcolor(x,y,z);
[x,y,z]=smoothwk(x,y,z,wsize_x,wsize_y);
contourf(x,y,z,zbin); hold on; shading flat; colorbar;
plot(d.xx,d.AfreqKelvinRossby(:,1:5));
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%cfrac OLR sensitivity Fig in AM4.0 paper%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
cmin=0.5; cmax=1.6; zbin=[cmin:(cmax-cmin)/10:cmax]; 
xy=[-15 15 0 0.5]; d=o.d; wsize_x=1; wsize_y=3;
...
handle = figure('Position', pms,'visible','on');
row=2; col=2; warning off all;
subplot(row,col,1); v=am4.c5.olr;  
x=v.x; y=v.y; z=v.var_sym_filt; %pcolor(x,y,z);
[x,y,z]=smoothwk(x,y,z,wsize_x,wsize_y);
contourf(x,y,z,zbin); hold on; shading flat; colorbar;
plot(d.xx,d.AfreqKelvinRossby(:,1:5));
...
subplot(row,col,2); v=am4.c6.olr;  
x=v.x; y=v.y; z=v.var_sym_filt; %pcolor(x,y,z);
[x,y,z]=smoothwk(x,y,z,wsize_x,wsize_y);
contourf(x,y,z,zbin); hold on; shading flat; colorbar;
plot(d.xx,d.AfreqKelvinRossby(:,1:5));
...
subplot(row,col,3); v=am4.c7.olr;  
x=v.x; y=v.y; z=v.var_sym_filt; %pcolor(x,y,z);
[x,y,z]=smoothwk(x,y,z,wsize_x,wsize_y);
contourf(x,y,z,zbin); hold on; shading flat; colorbar;
plot(d.xx,d.AfreqKelvinRossby(:,1:5));
...
subplot(row,col,4); v=am4.c8.olr;  
x=v.x; y=v.y; z=v.var_sym_filt; %pcolor(x,y,z);
[x,y,z]=smoothwk(x,y,z,wsize_x,wsize_y);
contourf(x,y,z,zbin); hold on; shading flat; colorbar;
plot(d.xx,d.AfreqKelvinRossby(:,1:5));
