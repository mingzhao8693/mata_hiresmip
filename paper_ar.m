...
expn='c192L33_am4p0_amip_HIRESMIP_H8_newpp'; yr1=1979;yr2=2014;
...
a=vo.prav6h_ar.*vo.freq_ar; a(isnan(a))=0; y3=squeeze(mean(mean(mean(a,1),2),4));
a=vm.prav6h_ar.*vm.freq_ar; a(isnan(a))=0; y4=squeeze(mean(mean(mean(a,1),2),4));
a=wm.prav6h_ar.*wm.freq_ar ;a(isnan(a))=0; y5=squeeze(mean(mean(mean(a,1),2),4));
a=vo.prav6h_av_clm.ann;     y6=squeeze(mean(a,2));
a=vm.prav6h_av_clm.ann;     y7=squeeze(mean(a,2));
a=wm.prav6h_av_clm.ann;     y8=squeeze(mean(a,2));
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
pms=[ 0, 0, 1200, 800]*0.8; fsize=16; lw=1; msize=4;
handle = figure('Position', pms,'visible','on');
ax1=gca; lat0=0; 
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
vname='pr_ar_pctile'; xmin=-90; xmax=90; xy=[xmin xmax 0 120]; 
a=vm.prav6h_ar50;  vm.prav6h_ar50_clm=get_clm_ann(a);
a=vm.prav6h_ar75;  vm.prav6h_ar75_clm=get_clm_ann(a);
a=vm.prav6h_ar90;  vm.prav6h_ar90_clm=get_clm_ann(a);

pct=99;
a=vm.prav6h_av_clm.ann;     y1=nanmean(a,2);     s1='annual mean';
a=vm.prav6h_ar_clm.ann;     y2=nanmean(a,2);     s2='AR mean';
a=vm.prav6h_90_clm.ann;     y3=prctile(a,pct,2); s3='90th percentile';
a=vm.prav6h_99_clm.ann;     y4=prctile(a,pct,2); s4='99th percentile';
a=vm.prav6h_999_clm.ann;    y5=prctile(a,pct,2); s5='99.9th percentile';
a=vm.prav6h_ar50_clm.ann;   y6=prctile(a,pct,2); s6='AR 50th percentile';
a=vm.prav6h_ar75_clm.ann;   y7=prctile(a,pct,2); s7='AR 75th percentile';
a=vm.prav6h_ar90_clm.ann;   y8=prctile(a,pct,2); s8='AR 90th percentile';
a=vm.prav6h_armax_clm.ann;  y9=prctile(a,pct,2); s9='AR maximum';
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
pms=[ 0, 0, 1200, 800]*0.8; fsize=16; lw=1; msize=4;
handle = figure('Position', pms,'visible','on');
ax1=gca; lat0=0; x=vm.lat; id = (x>-lat0 & x<lat0);
plot(x, y1, 'k--','MarkerSize',msize,'LineWidth',lw); hold on;
plot(x, y2, 'k-', 'MarkerSize',msize,'LineWidth',lw);
plot(x, y3, 'k-.','MarkerSize',msize,'LineWidth',lw);
plot(x, y4, 'k:', 'MarkerSize',msize,'LineWidth',lw);
plot(x, y5, 'g',  'MarkerSize',msize,'LineWidth',lw);
plot(x, y6, 'c',  'MarkerSize',msize,'LineWidth',lw);
plot(x, y7, 'b',  'MarkerSize',msize,'LineWidth',lw);
plot(x, y8, 'r',  'MarkerSize',msize,'LineWidth',lw);
plot(x, y9, 'm',  'MarkerSize',msize,'LineWidth',lw);
legend(s1,s2,s3,s4,s5,s6,s7,s8,s9,1); axis(xy); 
