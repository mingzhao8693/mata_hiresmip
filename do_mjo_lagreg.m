...
v=mjo_ana(tpath,expn,yr1,yr2,latlon,nyr,region)
expn='CM4p0_2010';yr1='0061'; yr2='0100'; nyr=40;
v=mjo_ana(tpath,expn,yr1,yr2,latlon,nyr,region)
...
expn='c96L33_am4p0_m1';       fn=strcat(tpath,expn,'/',expn,'_',region,'_lagreg.mat'); load(fn);am4c=v;
...
expn='CM4p0_2010';            fn=strcat(tpath,expn,'/',expn,'_',region,'_lagreg.mat'); load(fn);cm4a=v;
