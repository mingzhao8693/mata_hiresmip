...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
tpath='/archive/Ming.Zhao/expn_c192L33_am4p0/amip_le_runs/';
p.latlon=[0 360 -90 90]; p.region='global'; p.mod='c96';
p.do_trend=1; p.do_scalar=0; p.myr=1; p.opt=0; p.do_3d_atm=0; p.do_all=1
...
%expn0='c192L33_am4p0_amip_m';
%expn0='c192L33_am4p0_amip_removeTPI_m';
expn0='c192L33_am4p0_amip_2010rad_m';
for i=1:1
  expn=sprintf('%s%02d',expn0,i); p.expn=expn; expn
  v=tsana_hiresmip_new(o,tpath,p);
end
%test%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
for m=1:12
  idx=squeeze(v.sfc.sst_nino3.al0(:,m)); idx=idx-mean(idx);
  sst=squeeze(v.sfc.tsurf.all(:,m,:,:));
  X=idx; Y=reshape(sst,42,288*180);
  a=X \ Y; b=reshape(a,180,288);
  r.slop(m,:,:)=b;
end
figure; m=1;
a=squeeze(r.slop(m,:,:)); pcolor(a); shading flat; colorbar; caxis([-1 1]);
nn=256;  cmap=bluewhitered_miz(nn); colormap(cmap);
%test%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
for m=1:12
  idx=squeeze(v.sfc.sst_amm.al0(:,m)); idx=idx-mean(idx);
  sst=squeeze(v.sfc.tsurf.all(:,m,:,:));
  X=idx; Y=reshape(sst,42,288*180);
  a=X \ Y; b=reshape(a,180,288);
  r.slop(m,:,:)=b;
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
for m=1:12
  tpi=squeeze(v.sfc.sst_tpi(:,m));
  sst=squeeze(v.sfc.tsurf.all(:,m,:,:));
  X=tpi; Y=reshape(sst,42,288*180);
  a=X \ Y; b=reshape(a,180,288);
  r.slop(m,:,:)=b;
end
figure; m=1;
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
p.latlon=[0 360 -90 90]; p.region='global'; p.mod='c96';
p.do_trend=1; p.do_scalar=0; p.myr=1; p.opt=2; p.do_3d_atm=0; p.do_all=1;
p.yr1='1979'; p.yr2='2020'; p.syr= 1; p.nyr=42; p.y1=1979; p.y2=2020;
p.yr1='1951'; p.yr2='2020'; p.syr= 1; p.nyr=70; p.y1=1951; p.y2=2020;
p.yr1='1950'; p.yr2='2020'; p.syr= 2; p.nyr=70; p.y1=1951; p.y2=2020;
tpath='/archive/Ming.Zhao/awg/2023.04/';
p.expn='c192L33_am4p0_amip_HIRESMIP_nudge_wind_30min'; v=tsana_hiresmip_new(o,tpath,p);
p.expn='c192L33_am4p0_amip_HIRESMIP_HX01';             v=tsana_hiresmip_new(o,tpath,p);
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%load an AMIP run
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
f='_global_opt2.c96_tsana_hiresmip_new_1951-2020_1950-2020_do_3d_atm_0_do_all_1.mat';
e='c192L33_am4p0_amip_HIRESMIP_HX01';             n=strcat(ph,e,'/',e,f); load(n);z.v0=v; 
e='c192L33_am4p0_amip_HIRESMIP_nudge_wind_30min'; n=strcat(ph,e,'/',e,f); load(n);z.w1=v; 

ph='/archive/Ming.Zhao/expn_c192L33_am4p0/amip_le_runs/'; 
f='_global_opt2.c96_tsana_hiresmip_new_1980-2020_1950-2020_do_3d_atm_0_do_all_1.mat';
f='_global_opt0.c96_tsana_hiresmip_new_1980-2020_1950-2020.mat';
f='_global_opt0.c96_tsana_hiresmip_new_1979-2020_1950-2020_do_3d_atm_0_do_all_1.mat';
e='c192L33_am4p0_amip_m01'; n=strcat(ph,e,'/',e,f); load(n);z.v1=v;
e='c192L33_am4p0_amip_m02'; n=strcat(ph,e,'/',e,f); load(n);z.v2=v; 
e='c192L33_am4p0_amip_m03'; n=strcat(ph,e,'/',e,f); load(n);z.v3=v; 
e='c192L33_am4p0_amip_m04'; n=strcat(ph,e,'/',e,f); load(n);z.v4=v; 
e='c192L33_am4p0_amip_m05'; n=strcat(ph,e,'/',e,f); load(n);z.v5=v; 
e='c192L33_am4p0_amip_m06'; n=strcat(ph,e,'/',e,f); load(n);z.v6=v; 
e='c192L33_am4p0_amip_m07'; n=strcat(ph,e,'/',e,f); load(n);z.v7=v; 
e='c192L33_am4p0_amip_m08'; n=strcat(ph,e,'/',e,f); load(n);z.v8=v; 
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
tpath='/archive/miz/am5/'; epath='/analysis/'; %epath='/analysis/tropical_storms_wsfc/';
expn ='c384L65_am5f7c1r0_amip'; fn=strcat(tpath,expn,epath,expn,'_traj.mat');
opt='obs'; v=regionstat_ibtracs(fn,opt); v.expn=opt;
v.c.na=getcdf_ts0(v,'ALL',2,opt);
v.c.ep=getcdf_ts0(v,'ALL',5,opt);
v.c.wp=getcdf_ts0(v,'ALL',4,opt);
v.c.sp=getcdf_ts0(v,'ALL',8,opt'); o=v;
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
expn ='c384L65_am5f7c1r0_amip'; fn=strcat(tpath,expn,epath,expn,'_traj.mat'); opt='mod';
v=regionstat_ibtracs(fn,opt); v.expn=expn;
v.c.na=getcdf_ts0(v,'ALL',2,opt);
v.c.ep=getcdf_ts0(v,'ALL',5,opt);
v.c.wp=getcdf_ts0(v,'ALL',4,opt);
v.c.sp=getcdf_ts0(v,'ALL',8,opt'); v1=v;
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
expn ='c384L65_am5f8d2r0_amip'; fn=strcat(tpath,expn,epath,expn,'_traj.mat');
v=regionstat_ibtracs(fn,opt); v.expn=expn;
v.c.na=getcdf_ts0(v,'ALL',2,opt);
v.c.ep=getcdf_ts0(v,'ALL',5,opt);
v.c.wp=getcdf_ts0(v,'ALL',4,opt);
v.c.sp=getcdf_ts0(v,'ALL',8,opt'); v2=v;
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
expn ='c384L65_am5f8d5r0_amip'; fn=strcat(tpath,expn,epath,expn,'_traj.mat');
v=regionstat_ibtracs(fn,opt); v.expn=expn;
v.c.na=getcdf_ts0(v,'ALL',2,opt);
v.c.ep=getcdf_ts0(v,'ALL',5,opt);
v.c.wp=getcdf_ts0(v,'ALL',4,opt);
v.c.sp=getcdf_ts0(v,'ALL',8,opt'); v3=v;
a=v1.expn; a(a=='_')='-'; v1.expn=a;
a=v2.expn; a(a=='_')='-'; v2.expn=a;
a=v3.expn; a(a=='_')='-'; v3.expn=a;
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
pms=[ 0, 0, 2000, 1000]; fsize=10; lw=1;
handle = figure('Position', pms,'visible','on'); msize=5;
v=o.c; x=v.na.wdbin; x=x(1:end-1)
y=v.na.cdf_wnd; y=-diff(y); plot (x,y,'k-','LineWidth',lw*2,'MarkerSize',msize); hold on;
%y=v.ep.cdf_wnd; y=-diff(y); plot (x,y,'k-','LineWidth',lw*2,'MarkerSize',msize); hold on;
%y=v.wp.cdf_wnd; y=-diff(y); plot (x,y,'k-','LineWidth',lw*2,'MarkerSize',msize); hold on;
%y=v.sp.cdf_wnd; y=-diff(y); plot (x,y,'k-','LineWidth',lw*2,'MarkerSize',msize); hold on;
v=v1.c;
y=v.na.cdf_wnd; y=-diff(y); plot (x,y,'r-','LineWidth',lw,'MarkerSize',msize); hold on;
%y=v.ep.cdf_wnd; y=-diff(y); plot (x,y,'r-','LineWidth',lw,'MarkerSize',msize); hold on;
%y=v.wp.cdf_wnd; y=-diff(y); plot (x,y,'r-','LineWidth',lw,'MarkerSize',msize); hold on;
%y=v.sp.cdf_wnd; y=-diff(y); plot (x,y,'r-','LineWidth',lw,'MarkerSize',msize); hold on;
v=v2.c;
y=v.na.cdf_wnd; y=-diff(y); plot (x,y,'g:','LineWidth',lw*2,'MarkerSize',msize); hold on;
%y=v.ep.cdf_wnd; y=-diff(y); plot (x,y,'g:','LineWidth',lw*2,'MarkerSize',msize); hold on;
%y=v.wp.cdf_wnd; y=-diff(y); plot (x,y,'g:','LineWidth',lw*2,'MarkerSize',msize); hold on;
%y=v.sp.cdf_wnd; y=-diff(y); plot (x,y,'g:','LineWidth',lw*2,'MarkerSize',msize); hold on;
v=v3.c;
y=v.na.cdf_wnd; y=-diff(y); plot (x,y,'b--','LineWidth',lw*2,'MarkerSize',msize); hold on;
%y=v.ep.cdf_wnd; y=-diff(y); plot (x,y,'b--','LineWidth',lw*2,'MarkerSize',msize); hold on;
%y=v.wp.cdf_wnd; y=-diff(y); plot (x,y,'b--','LineWidth',lw*2,'MarkerSize',msize); hold on;
%y=v.sp.cdf_wnd; y=-diff(y); plot (x,y,'b:','LineWidth',lw*2,'MarkerSize',msize); hold on;
legend('OBS',v1.expn,v2.expn,v3.expn);
visfig='off'; figpath='./fig_am5/'; expn='C384AM5'; vname='NA';
printnew(visfig,figpath,expn,vname)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
pms=[ 0, 0, 2000, 1000]; fsize=10; lw=1;
handle = figure('Position', pms,'visible','on'); msize=5;
v=o.c; x=v.na.wdbin; x=x(1:end)
y=v.na.cdf_wnd; plot (x,y,'r-','LineWidth',lw*2,'MarkerSize',msize); hold on;
y=v.ep.cdf_wnd; plot (x,y,'g-','LineWidth',lw*2,'MarkerSize',msize); hold on;
y=v.wp.cdf_wnd; plot (x,y,'b-','LineWidth',lw*2,'MarkerSize',msize); hold on;
%y=v.sp.cdf_wnd; plot (x,y,'k-','LineWidth',lw*2,'MarkerSize',msize); hold on;
v=v1.c;
y=v.na.cdf_wnd; plot (x,y,'r-','LineWidth',lw,'MarkerSize',msize); hold on;
y=v.ep.cdf_wnd; plot (x,y,'g-','LineWidth',lw,'MarkerSize',msize); hold on;
y=v.wp.cdf_wnd; plot (x,y,'b-','LineWidth',lw,'MarkerSize',msize); hold on;
%y=v.sp.cdf_wnd; plot (x,y,'k-','LineWidth',lw,'MarkerSize',msize); hold on;
v=v2.c;
y=v.na.cdf_wnd; plot (x,y,'r:','LineWidth',lw*2,'MarkerSize',msize); hold on;
y=v.ep.cdf_wnd; plot (x,y,'g:','LineWidth',lw*2,'MarkerSize',msize); hold on;
y=v.wp.cdf_wnd; plot (x,y,'b:','LineWidth',lw*2,'MarkerSize',msize); hold on;
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
tpath='/archive/miz/awg/2023.04/'; epath='/analysis/'; %epath='/analysis/tropical_storms_wsfc/';
expn ='c192L33_am4p0_amip_HIRESMIP_HX01'; fn=strcat(tpath,expn,epath,expn,'_traj.mat');
vm1=regionstat_ibtracs(fn,'mod');
expn ='c192L33_am4p0_amip_HIRESMIP_HX02'; fn=strcat(tpath,expn,epath,expn,'_traj.mat');
vm2=regionstat_ibtracs(fn,'mod');
expn ='c192L33_am4p0_amip_HIRESMIP_HX03'; fn=strcat(tpath,expn,epath,expn,'_traj.mat');
vm3=regionstat_ibtracs(fn,'mod');
expn ='c192L33_am4p0_amip_HIRESMIP_HX04'; fn=strcat(tpath,expn,epath,expn,'_traj.mat');
vm4=regionstat_ibtracs(fn,'mod');
expn ='c192L33_am4p0_amip_HIRESMIP_HX05'; fn=strcat(tpath,expn,epath,expn,'_traj.mat');
vm5=regionstat_ibtracs(fn,'mod');
expn ='c192L33_CM4X_amip'; fn=strcat(tpath,expn,epath,expn,'_traj.mat'); load(fn)
vm6=regionstat_ibtracs(fn,'mod'); vo=regionstat_ibtracs(fn,'obs');
v.vo=vo; v.vm1=vm1; v.vm2=vm2; v.vm3=vm3; v.vm4=vm4; v.vm5=vm5; v.vm6=vm6;
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
yr=[1980:2020]; %normalization to observation
for m=1:vm0.nbox
  yo=vo.cat0num(m,:);
  y1=vm1.cat0num(m,:); 
  y2=vm2.cat0num(m,:); 
...
pms=[ 0, 0, 1200, 500]; fsize=10; lw=1; nt=39; x=v.vm1.tyear(end-nt:end);
handle = figure('Position', pms,'visible','on'); msize=5;
vx=v.vo;  y=vx.cat0num(m,end-nt:end); plot (x,y,'kp-','LineWidth',lw,'MarkerSize',msize); hold on;
yo=y;
vx=v.vm1; y=vx.cat0num(m,end-nt:end); y=y*mean(yo)/mean(y); plot (x,y,'r*-','LineWidth',lw,'MarkerSize',msize); hold on;
vx=v.vm2; y=vx.cat0num(m,end-nt:end); y=y*mean(yo)/mean(y); plot (x,y,'g*-','LineWidth',lw,'MarkerSize',msize); hold on;
vx=v.vm3; y=vx.cat0num(m,end-nt:end); y=y*mean(yo)/mean(y); plot (x,y,'b*-','LineWidth',lw,'MarkerSize',msize); hold on;
vx=v.vm4; y=vx.cat0num(m,end-nt:end); y=y*mean(yo)/mean(y); plot (x,y,'c*-','LineWidth',lw,'MarkerSize',msize); hold on;
vx=v.vm5; y=vx.cat0num(m,end-nt:end); y=y*mean(yo)/mean(y); plot (x,y,'m*-','LineWidth',lw,'MarkerSize',msize); hold on;
%vx=v.vm6; y=vx.cat0num(m,end-nt:end); y=y*mean(yo)/mean(y); plot (x,y,'y*-','LineWidth',lw,'MarkerSize',msize); hold on;
legend('IBTRAC','M1','M2','M3','M4','M5','Location','NorthWest');
axis([1980 2020 0 40]); xlabel('year','FontSize',fsize);
ylabel('annual number of North Atlantic tropical storms','FontSize',fsize); 
visfig='off'; figpath='./fig_hiresmip/'; expn='C192AM4'; vname='ts'
...
pms=[ 0, 0, 1200, 500]; fsize=10; lw=1; nt=39; x=v.vm1.tyear(end-nt:end);
handle = figure('Position', pms,'visible','on'); msize=5;
vx=v.vo;  y=vx.cat1num(m,end-nt:end); plot (x,y,'kp-','LineWidth',lw,'MarkerSize',msize); hold on;
yo=y;
vx=v.vm1; y=vx.cat1num(m,end-nt:end); y=y*mean(yo)/mean(y); plot (x,y,'r*-','LineWidth',lw,'MarkerSize',msize); hold on;
vx=v.vm2; y=vx.cat1num(m,end-nt:end); y=y*mean(yo)/mean(y); plot (x,y,'g*-','LineWidth',lw,'MarkerSize',msize); hold on;
vx=v.vm3; y=vx.cat1num(m,end-nt:end); y=y*mean(yo)/mean(y); plot (x,y,'b*-','LineWidth',lw,'MarkerSize',msize); hold on;
vx=v.vm4; y=vx.cat1num(m,end-nt:end); y=y*mean(yo)/mean(y); plot (x,y,'c*-','LineWidth',lw,'MarkerSize',msize); hold on;
vx=v.vm5; y=vx.cat1num(m,end-nt:end); y=y*mean(yo)/mean(y); plot (x,y,'m*-','LineWidth',lw,'MarkerSize',msize); hold on;
%vx=v.vm6; y=vx.cat0num(m,end-nt:end); y=y*mean(yo)/mean(y); plot (x,y,'y*-','LineWidth',lw,'MarkerSize',msize); hold on;
legend('IBTRAC','M1','M2','M3','M4','M5','Location','NorthWest');
axis([1980 2020 0 20]); xlabel('year','FontSize',fsize);
ylabel('annual number of North Atlantic tropical storms','FontSize',fsize); 
visfig='off'; figpath='./fig_hiresmip/'; expn='C192AM4'; vname='ts'
printit(visfig,figpath,expn,vname)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
expn='SPEAR_c192_o1_Hist_AllForc_IC1921_K50_ens_16';
fn=strcat(tpath,expn,'/',expn,'_global_opt0.c96_tsana_hiresmip_new_1979_2020','.mat')
load(fn); v0=v;
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
tpath='/archive/Ming.Zhao/awg/2023.04/';
expn='c192L33_am4p0_amip_HIRESMIP_HX_spear_m16';
fn=strcat(tpath,expn,'/',expn,'_global_opt0.c96_tsana_hiresmip_new_1979_2020','.mat'); load(fn); v1=v;
expn='c192L33_am4p0_amip_HIRESMIP_HX_spear_m16_do_leads';
fn=strcat(tpath,expn,'/',expn,'_global_opt2.c96_tsana_hiresmip_new_1979_2020_1979_2020','.mat'); load(fn); v2=v;

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
tpath='/archive/Ming.Zhao/awg/2023.04/';
expn='c192L33_am4p0_amip_HIRESMIP_HX_spear_m16_1977';
fn=strcat(tpath,expn,'/',expn,'_global_opt0.c96_tsana_hiresmip_new_1979_2020','.mat')
load(fn); v2=v;
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
tpath='/archive/Ming.Zhao/awg/2023.04/';
expn='c192L33_am4p0_amip_HIRESMIP_HX_spear_m16_1976';
fn=strcat(tpath,expn,'/',expn,'_global_opt0.c96_tsana_hiresmip_new_1979_2020','.mat')
load(fn); v3=v;
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
tpath='/archive/Ming.Zhao/awg/2023.04/';
expn='c192L33_am4p0_amip_HIRESMIP_HX_spear_m16_1975';
fn=strcat(tpath,expn,'/',expn,'_global_opt0.c96_tsana_hiresmip_new_1979_2020','.mat')
load(fn); v4=v;
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%test
vm(1)=v0; vm(2)=v1; %vm(3)=v2; vm(4)=v3; vm(5)=v4; 
v=v0; s=v.s; lon=s.lon; lat=s.lat; lm=s.lm; aa=s.aa;

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
m=1; p.xsize=1500; p.ysize=1200;
p.cmin=-0.1; p.cmax=0.1;
p.x1=0; p.x2=360; p.y1=-90; p.y2=90;
%p.x1=200; p.x2=360; p.y1=0; p.y2=90;
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
pms=[ 0, 0, p.xsize, p.ysize]*1.2; fsize=12; 
handle=figure('Position',pms,'visible','on'); 
row=3; col=2; %cmap=bluewhitered_miz(256); 
co='k'; cmin=p.cmin; cmax=p.cmax; cmin=-1; cmax=1;
mod_num=2; n=1;
for i = 1:mod_num
  v=vm(i); j=i+n;
%  a=squeeze(v.tr.slp.mod.trend(m,:,:));
%  a=squeeze(v.tr.pcp.mod.trend(m,:,:));

   a=squeeze(v.sfc.tsurf.sea_bias(m,:,:));
%   a=squeeze(v.sfc.evap.sea(m,:,:)); cmin=-10; cmax=10;
%  a=squeeze(v.sfc.slp.sea_bias(m,:,:));
%  a=squeeze(v.sfc.pcp.sea_bias(m,:,:));
%  a=squeeze(v.sfc.pcp.sea(m,:,:));
%  a=squeeze(v.sfc.pcp.sea(m,:,:));
  z(i,:,:)=a; z0=squeeze(z(1,:,:));
  a0=mean(mean(a.*aa)); mod_av(i)=a0;
  subplot(row, col, j); colormap(jet);
  if (j==2);
    b=a; cmin=0; cmax=150;
  else;
    b=a-z0;
  end
  pcolor(lon,lat,b); hold on; shading flat; caxis([cmin, cmax]);
  contour(lon,lat,lm,1,co); colorbar;
  set(gca,'FontSize',fsize); axis([p.x1 p.x2 p.y1 p.y2]);
  c=corrcoef(a,z0); r(i)=c(1,2);
  titl=sprintf('M%02d (corr=%4.2f)',j-2,r(i));
  title(titl,'FontSize',fsize);
end
i=1;
a=squeeze(mean(z(2:end,:,:),1));
a0=mean(mean(a.*aa)); %mod_av(i)=a0;
subplot(row, col, i); colormap(jet);
pcolor(lon,lat,(a-z0)); hold on; shading flat; caxis([cmin, cmax]);
contour(lon,lat,lm,1,co); colorbar;
set(gca,'FontSize',fsize); axis([p.x1 p.x2 p.y1 p.y2]);
c=corrcoef(a,z0); r(i)=c(1,2);
titl=sprintf('MEAN (corr=%4.2f)',r(i));
title(titl,'FontSize',fsize);
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
figure; a=squeeze(v.sfc.pcp.sea_bias(m,:,:)); a0=a;
pcolor(lon,lat,a); hold on; shading flat; colorbar; colormap(jet); caxis([-1 1]);
contour(lon,lat,lm,1,'k');
v=v1;
figure; a=squeeze(v.sfc.pcp.sea_bias(m,:,:)); a1=a;
pcolor(lon,lat,a); hold on; shading flat; colorbar; colormap(jet); caxis([-1 1]);
contour(lon,lat,lm,1,'k');
v=v2;
figure; a=squeeze(v.sfc.pcp.sea_bias(m,:,:)); a2=a;
pcolor(lon,lat,a); hold on; shading flat; colorbar; colormap(jet); caxis([-1 1]);
contour(lon,lat,lm,1,'k');
v=v3;
figure; a=squeeze(v.sfc.pcp.sea_bias(m,:,:)); a3=a;
pcolor(lon,lat,a); hold on; shading flat; colorbar; colormap(jet); caxis([-1 1]);
contour(lon,lat,lm,1,'k');
v=v4;
figure; a=squeeze(v.sfc.pcp.sea_bias(m,:,:)); a4=a;
pcolor(lon,lat,a); hold on; shading flat; colorbar; colormap(jet); caxis([-1 1]);
contour(lon,lat,lm,1,'k');
corrcoef(a0,a1)
corrcoef(a0,a2)
corrcoef(a0,a3)
corrcoef(a0,a4)
corrcoef(mean(a0,2),mean(a1,2))
corrcoef(mean(a0,2),mean(a2,2))
corrcoef(mean(a0,2),mean(a3,2))
corrcoef(mean(a0,2),mean(a4,2))

%trend
m=3;
v=v0; s=v.s; lon=s.lon; lat=s.lat; lm=s.lm; 
figure; a=squeeze(v.tr.pcp.mod.trend(m,:,:)); a0=a;
pcolor(lon,lat,a); hold on; shading flat; colorbar; colormap(jet); caxis([-0.2 0.2]);
contour(lon,lat,lm,1,'k');
v=v1;
figure; a=squeeze(v.tr.pcp.mod.trend(m,:,:)); a1=a;
pcolor(lon,lat,a); hold on; shading flat; colorbar; colormap(jet); caxis([-0.2 0.2]);
contour(lon,lat,lm,1,'k');
v=v2;
figure; a=squeeze(v.tr.pcp.mod.trend(m,:,:)); a2=a;
pcolor(lon,lat,a); hold on; shading flat; colorbar; colormap(jet); caxis([-0.2 0.2]);
contour(lon,lat,lm,1,'k');
v=v3;
figure; a=squeeze(v.tr.pcp.mod.trend(m,:,:)); a3=a;
pcolor(lon,lat,a); hold on; shading flat; colorbar; colormap(jet); caxis([-0.2 0.2]);
contour(lon,lat,lm,1,'k');
v=v4;
figure; a=squeeze(v.tr.pcp.mod.trend(m,:,:)); a4=a;
pcolor(lon,lat,a); hold on; shading flat; colorbar; colormap(jet); caxis([-0.2 0.2]);
contour(lon,lat,lm,1,'k');
corrcoef(a0,a1)
corrcoef(a0,a2)
...
figure; s=v1.s; lon=s.lon; lat=s.lat; lm=s.lm; m=3;
a=squeeze(v2.sfc.tsurf.sea(m,:,:)-v1.sfc.tsurf.sea(m,:,:));
pcolor(lon,lat,a); hold on; shading flat; colorbar; colormap(jet); caxis([-1 1]);
contour(lon,lat,lm,1,'k');

figure; s=v1.s; lon=s.lon; lat=s.lat; lm=s.lm;
pcolor(lon,lat,v2.sfc.ice.tavg0-v1.sfc.ice.tavg0); hold on;
shading flat; colorbar; colormap(jet); caxis([-0.05 0.05]);
contour(lon,lat,lm,1,'k');
%test
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%load AMIP LE runs
...
tpath='/archive/Ming.Zhao/expn_c192L33_am4p0/amip_le_runs/'; 
expn0='c192L33_am4p0_amip_m';
fext='_global_opt0.c96_tsana_hiresmip_new_';
period1='1980_2020';
...
for i=1:13
  ...
  fn=strcat(tpath,expn,'/',expn,fext,period1,'.mat')
  load(fn);
  vm(i).pcp=v.tr.pcp; vm(i).tsurf=v.tr.tsurf; vm(i).sst=v.tr.sst;
end
fn=strcat('/work/miz/mat_hiresmip/c192amip_le_vm.mat'); 
save(fn,'vm','v','o','-v7.3'); 
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
fn=strcat('/work/miz/mat_hiresmip/c192amip_le_vm.mat'); 
...
p.mod_name="amip_le"; p.color='w'; p.color1='c';
p.cmin=-0.3; p.cmax=0.3; p.vname="pcp_trend";
plot_allmember_pcp(vm,o,p,2);
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%xxx
%test
k=5; m=5; n=5;
lat=o.lat(1:n:end); lon=o.lon(1:n:end);
lm=o.lm0(1:n:end,1:n:end);
ua=squeeze(o.atm.ua(5).sea(m,1:n:end,1:n:end));
va=squeeze(o.atm.va(5).sea(m,1:n:end,1:n:end));
[phi,psi]=flowfun(ua,va);
figure; quiver(lon,lat,ua,va,'r'); hold on;
[C,h]=contour(lon,lat,psi,20,'b'); %clabel(C,h);
[C,h]=contour(lon,lat,phi,20,'g'); clabel(C,h);
contour(lon,lat,lm,[0.1 0.2],'k');
%test
%wind circulation plotting:
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
pms=[ 0, 0, 1500, 900]*1.5; warning off all
handle = figure('Position', pms,'visible','on'); fsize=18;
s=v.s; x=s.lon; y=s.lat; lm=s.lm; lw=1; cfact=1; k=2;
seas={'ANN','MAM','JJA','SON','DJF'};
plev={'1000', '925', '850','775','700','600','500','400','300','250','200','150','100','70','50'};
k=7; ua=v.atm.ua(k); va=v.atm.va(k); m=1;
zu=squeeze(ua.sea(m,:,:)); 
zv=squeeze(va.sea(m,:,:));
zz=sqrt(zu.*zu+zv.*zv);
%k=7; zz=v.atm.za(k); zz=squeeze(zz.sea(m,:,:));
contourf(x,y,zz,20); hold on; shading flat; colorbar; caxis([-20 20]); 
quiver(x,y,zu,zv,cfact,'k')
contour(x,y,lm,1,'k','LineWidth',1); 
...
visfig='off'; figpath='./fig_cre/'; vname='wind500';
printit(visfig,figpath,expn,vname);
...
[ts,ind]=plot_spearle_all_new(vm, o, p)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%test plot
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
v=va; xa=v.tr.tsurf.mod.xt;
ya.ts  =v.sfc.tsurf.ts.org_ann; 
ya.tref=v.sfc.tref.ts.org_ann;
ya.sst =v.sfc.tsurf.ann_stat.mmen.ocean;
ya.all =v.sfc.tsurf.ann_stat.mmen.all;
figure;
i1=find(xa==1979); i2=find(xa==2020); x=xa(i1:i2);
y=ya.all(i1:i2); y=y-mean(y); c1=polyfit(x,y,1); plot(x,y); hold on;
y=ya.sst(i1:i2); y=y-mean(y); c2=polyfit(x,y,1); plot(x,y,'r');

pms=[ 0, 0, 1600, 1000]; row=1; col=1; lw=2;
handle=figure('Position',pms,'visible','on');
subplot(row,col,1);
i=1; v=vm(i); xe=v.tr.tsurf.mod.xt;
ym.ts  =v.sfc.tsurf.ts.org_ann; ye.ts  =ym.ts;
ym.tref=v.sfc.tref.ts.org_ann;  ye.tref=ym.tref;
plot(xe,ym.ts,  '-c', 'LineWidth',lw/2); hold on;
plot(xe,ym.tref,'-m', 'LineWidth',lw/2); hold on;
for i=2:30
  v=vm(i);
  ym.ts  =v.sfc.tsurf.ts.org_ann; ye.ts  =ye.ts  +ym.ts;
  ym.tref=v.sfc.tref.ts.org_ann;  ye.tref=ye.tref+ym.tref;
  plot(xe,ym.ts,  '-c', 'LineWidth',lw/2); hold on;
  plot(xe,ym.tref,'-m', 'LineWidth',lw/2); hold on;
end
ye.ts  =ye.ts/30; ye.tref=ye.tref/30;
plot(xa,ya.ts,  '-k*','LineWidth',lw); hold on;
plot(xe,ye.ts,  '-bo','LineWidth',lw);
plot(xa,ya.tref,'-k*','LineWidth',lw); hold on;
plot(xe,ye.tref,'-bo','LineWidth',lw);

figure;
y=ya.ts;   plot(xa,y-mean(y),'r-*'); hold on;
y=ya.tref; plot(xa,y-mean(y),'b-s'); hold on;


y1=-1.6; y2=1.6;
t=1979; plot([t t],[y1 y2],'k');
t=2020; plot([t t],[y1 y2],'k');
axis([1921 2100 y1 y2]);
...
%test plot
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
z=vm(1).tr.sst.hadisst; xo=z.xt;     yo    =-z.ind.wme; 
z=vm(1).tr.slp.obs;     xo_slp=z.xt; yo_slp=z.ind.soi;
z=va.tr.tsurf.mod;      xa=z.xt;     ya    =-z.ind.wme; 
z=va.tr.slp.mod;        xa_slp=z.xt; ya_slp=z.ind.soi;
z=vm(1).tr.slp.obs;     y1= v.tr.slp.obs.ind.soi;
pms=[ 0, 0, 1600, 1000]; row=1; col=1; lw=2;
handle=figure('Position',pms,'visible','on');
subplot(row,col,1);
i=1; z=vm(i).tr.tsurf.mod; y=-z.ind.wme; ye=y; xe=z.xt; y=y-mean(y);
plot(xe,y,'-c', 'LineWidth',lw/2); hold on;
for i=2:30
  z=vm(i).tr.tsurf.mod; y=-z.ind.wme; ye=ye+y; y=y-mean(y); 
  plot(xe,y,'-c', 'LineWidth',lw/2); hold on;
end
ye=ye/30;
yo=yo-mean(yo); ya=ya-mean(ya); ye=ye-mean(ye);
plot(xo,yo,'-k*','LineWidth',lw); hold on;
plot(xa,ya,'-rs','LineWidth',lw);
plot(xe,ye,'-bo','LineWidth',lw);
y1=-1.6; y2=1.6;
t=1979; plot([t t],[y1 y2],'k');
t=2020; plot([t t],[y1 y2],'k');
axis([1921 2100 y1 y2]);
...
i1=find(Y==y1); i2=find(Y==y2);
figure;
plot(x0,y0,'-b*','LineWidth',lw); hold on;
plot(x2,y2,'-rs','LineWidth',lw); hold on;
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
o=v.s; o.imk=v.sfc.ice.tavg0; o.land_th=0.1; o.ice_th=0.1;
p.x1=0; p. x2=360; p.y1=-90; p.y2=90; p.xsize=1100; p.ysize=1000; 
...
t1=91; t2=t1+62-1;  sst=squeeze(mean(o.sfc.sst_1870_2020.all(t1:t2,6:8,:,:),2));
a=heat_wave_us; hw_us=a(1:end-2);
a=heat_wave_eu; hw_eu=a(1:end-2); hw_eu(isnan(hw_eu))=hw_eu(1);
for i=1:288
  for j=1:180
    a=sst(:,j,i);
    c=corrcoef(hw_us,a); r1(j,i)=c(1,2);
    c=corrcoef(hw_eu,a); r2(j,i)=c(1,2);
  end
end
lat=o.lat; lon=o.lon; lm=o.lm0;
pms=[ 0, 0, 1600, 1000]; row=2; col=2; fsize=24; lw=2; 
handle=figure('Position',pms,'visible','on');
subplot(row,col,1); x=[1959:2020];
plot(x,hw_us,'k-s'); title('Heatwave in US'); 
subplot(row,col,2);
plot(x,hw_eu,'k-s');  title('Heatwave in Europe'); 
subplot(row,col,3); 
pcolor(lon,lat,r1); shading flat; caxis([c1 c2]); hold on;
contour(lon,lat,lm,1,'k'); colorbar; colormap(jet);
title('correlatioin between US heatwave and HadISST');
subplot(row,col,4); c1=-0.5; c2=0.5;
pcolor(lon,lat,r2); shading flat; caxis([c1 c2]); hold on;
contour(lon,lat,lm,1,'k'); colorbar; colormap(jet);
title('correlatioin between Europe heatwave and HadISST');
visfig='off'; figpath='./fig_cre/'; expn='obs'; vname='corr_heatwave_sst';
printnew(visfig,figpath,expn,vname);
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
p.opt=1; p.do_trend=false; p.do_scalar=false; p.do_3d_atm=false;
p.expn='c256r25L49'; v=tsana_spearle(o,tpath,p);
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%AM4 paper part I Fig 3 SWABS
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
load('/archive/Ming.Zhao/awg/2022.03/c256r25L49/c256r25L49_global_opt1.tsana_new_1988_2020.mat');
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
k=1; varn='swabs'; unit='(C)'; ss={'ANN','MAM','JJA','SON','DJF'};
s=v.s; s.latx=v.lat; s.lonx=v.lon; s.lmx=v.lm0;
z1=squeeze(o.toa.swnet.sea(k,:,:)); s.s1='CERES-EBAF-ed4.1';
z2=squeeze(v.toa.swnet.sea(k,:,:)); s.s2='Model';
z3=z2-z1;                           s.s3='Model minus CERES';
s.c1=25;    s.c2=410;  s.vbino=[s.c1:10:s.c2]; s.unit='(W/m2)';
s.cmin=-60; s.cmax=60; s.vbin =[s.cmin:5:s.cmax];
fpath='./fig_cre/'; expn='c256r25L49'; f=1; icmap=1;
plot_3panel_mapp_new(s,z1,z2,z3,varn,fpath,expn,f,k,icmap);
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
k=1; varn='olr'; unit='(C)'; ss={'ANN','MAM','JJA','SON','DJF'};
s=v.s; s.latx=v.lat; s.lonx=v.lon; s.lmx=v.lm0;
z1=squeeze(o.toa.lwnet.sea(k,:,:)); s.s1='CERES-EBAF-ed4.1';
z2=squeeze(v.toa.lwnet.sea(k,:,:)); s.s2='Model';
z3=z2-z1;                           s.s3='Model minus CERES';
s.c1=120;    s.c2=350;  s.vbino=[s.c1:10:s.c2]; s.unit='(W/m2)';
s.cmin=-34; s.cmax=34; s.vbin =[s.cmin:5:s.cmax];
fpath='./fig_cre/'; expn='c256r25L49'; f=1; icmap=1;
plot_3panel_mapp_new(s,z1,z2,z3,varn,fpath,expn,f,k,icmap);
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
k=1; varn='netrad'; unit='(C)'; ss={'ANN','MAM','JJA','SON','DJF'};
s=v.s; s.latx=v.lat; s.lonx=v.lon; s.lmx=v.lm0;
z1=squeeze(o.toa.netrad.sea(k,:,:)); s.s1='CERES-EBAF-ed4.1';
z2=squeeze(v.toa.netrad.sea(k,:,:)); s.s2='Model';
z3=z2-z1;                           s.s3='Model minus CERES';
s.c1=-180;    s.c2=120;  s.vbino=[s.c1:10:s.c2]; s.unit='(W/m2)';
s.cmin=-60; s.cmax=60; s.vbin =[s.cmin:5:s.cmax];
fpath='./fig_cre/'; expn='c256r25L49'; f=1; icmap=1;
plot_3panel_mapp_new(s,z1,z2,z3,varn,fpath,expn,f,k,icmap);
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
p.yr1='1951'; p.yr2='2020'; p.myr=1; p.syr=1;  p.nyr=70; p.y1=1951; p.y2=2020; 
...
tpath='/archive/Ming.Zhao/awg/2022.03/';
p.latlon=[0 360 -90 90]; p.region='global'; p.mod='c192';
p.yr1='0002'; p.yr2='0101'; p.myr=1; p.syr=1; p.nyr=100; p.y1=1979; p.y2=2020;
p.opt=2; p.do_trend=false; p.do_scalar=false; p.do_3d_atm=false;
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
p.expn='c192L33_am4p0_2010climo_trend_1979_2020_times_2'; v=tsana_spearle(o,tpath,p);
p.expn='c192L33_am4p0_2010climo_trend_1979_2020_p05';     v=tsana_spearle(o,tpath,p);
...
p.expn='c192L33_am4p0_2010climo_old';                     v=tsana_spearle(o,tpath,p);
p.expn='c192L33_am4p0_2010climo_old_p4K';                 v=tsana_spearle(o,tpath,p);
p.expn='c192L33_am4p0_2010climo_old_4xCO2';               v=tsana_spearle(o,tpath,p);
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
e='c192L33_am4p0_2010climo_trend_1979_2020_spear';  n=strcat(ph,e,'/',e,f); load(n);v1=v;
e='c192L33_am4p0_2010climo_trend_1979_2020';        n=strcat(ph,e,'/',e,f); load(n);v2=v;
e='c192L33_am4p0_2010climo_trend_1979_2020_times_2';n=strcat(ph,e,'/',e,f); load(n);v3=v;
e='c192L33_am4p0_2010climo_trend_1979_2020_p05';    n=strcat(ph,e,'/',e,f); load(n);v4=v;
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%t_surf%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
s=v0.s; p.y=s.lat; p.x=s.lon; p.lm=s.lm0; p.im=v0.sfc.ice.tavg0; 
aa=s.aa; id=(p.lm>0|p.im>0); a=aa(~id); aa0=a/mean(a);
a=v0.sfc.tsurf.tavg0; a0=mean(mean(a(~id).*aa0)); z0=a; 
a=v1.sfc.tsurf.tavg0; a1=mean(mean(a(~id).*aa0)); z1=a;
a=v2.sfc.tsurf.tavg0; a2=mean(mean(a(~id).*aa0)); z2=a;
a=v3.sfc.tsurf.tavg0; a3=mean(mean(a(~id).*aa0)); z3=a;
a=v4.sfc.tsurf.tavg0; a4=mean(mean(a(~id).*aa0)); z4=a;
p.vname='tsfc'; p.xy=[0 360 -90 90]; p.c='b'; p.nn=256; p.expn='WP';p.optit=0;
p.c1=[-3 3]; p.c2=p.c1; p.c3=p.c1; p.c4=p.c1; p.c5=p.c1; p.c6=p.c1;
p.aa=aa; p.id=id;
p.z1=z1-z0; p.z2=z2-z0; p.z3=z3-z0; p.z4=z4-z0; p.z5=z2-z1; p.z6=z2-z3;
p.z1_avg=a1-a0;
p.z2_avg=a2-a0;
p.z3_avg=a3-a0;
p.z4_avg=a4-a0;
p.z5_avg=a2-a1;
p.z6_avg=a2-a3;
p.s1='(a) WP-mod minus CTL'; 
p.s2='(b) WP-obs0 minus CTL';
p.s3='(c) WP-obs1 minus CTL';
p.s4='(d) WP-obs2 minus CTL';
p.s5='(e) WP-mod  minus WP-obs0';
p.s6='(f) WP-mod  minus WP-obs1';
...
s=v0.s; p.y=s.lat; p.x=s.lon; p.lm=s.lm0; p.im=v0.sfc.ice.tavg0; 
aa=s.aa; id=(p.lm<0|p.im<0); a=aa(~id); aa0=a/mean(a);
a=v0.sfc.tref.tavg0; a0=mean(mean(a(~id).*aa0)); z0=a; 
a=v1.sfc.tref.tavg0; a1=mean(mean(a(~id).*aa0)); z1=a;
a=v2.sfc.tref.tavg0; a2=mean(mean(a(~id).*aa0)); z2=a;
a=v3.sfc.tref.tavg0; a3=mean(mean(a(~id).*aa0)); z3=a;
a=v4.sfc.tref.tavg0; a4=mean(mean(a(~id).*aa0)); z4=a;
p.vname='tref'; p.xy=[0 360 -90 90]; p.opt=4; p.cm=4
p.c='b'; p.nn=256; p.expn='WP';p.optit=0;
p.c1=[-3 3]; p.c2=p.c1; p.c3=p.c1; p.c4=p.c1; p.c5=p.c1; p.c6=p.c1;
p.aa=aa; p.id=id;
p.z1=z1-z0; p.z2=z2-z0; p.z3=z3-z0; p.z4=z4-z0; p.z5=z2-z1; p.z6=z2-z3;
p.z1_avg=a1-a0;
...
s=v0.s; p.y=s.lat; p.x=s.lon; p.lm=s.lm0; p.im=v0.sfc.ice.tavg0; 
aa=s.aa; id=(p.lm<0|p.im<0); a=aa(~id); aa0=a/mean(a);
a=v0.sfc.pcp.tavg0; a0=mean(mean(a(~id).*aa0)); z0=a; 
a=v1.sfc.pcp.tavg0; a1=mean(mean(a(~id).*aa0)); z1=a;
a=v2.sfc.pcp.tavg0; a2=mean(mean(a(~id).*aa0)); z2=a;
a=v3.sfc.pcp.tavg0; a3=mean(mean(a(~id).*aa0)); z3=a;
a=v4.sfc.pcp.tavg0; a4=mean(mean(a(~id).*aa0)); z4=a;
p.vname='pcp'; p.xy=[0 360 -90 90]; p.opt=5; p.cm=4
p.c='b'; p.nn=256; p.expn='WP';p.optit=0;
p.c1=[-4 4]; p.c2=p.c1; p.c3=p.c1; p.c4=p.c1; p.c5=p.c1; p.c6=p.c1;
p.aa=aa; p.id=id;
p.z1=z1-z0; p.z2=z2-z0; p.z3=z3-z0; p.z4=z4-z0; p.z5=z2-z1; p.z6=z2-z3;
p.z1_avg=a1-a0;
p.z2_avg=a2-a0;
...
s=v0.s; p.y=s.lat; p.x=s.lon; p.lm=s.lm0; p.im=v0.sfc.ice.tavg0; 
aa=s.aa; id=(p.lm<0|p.im<0); a=aa(~id); aa0=a/mean(a);
a=v0.toa.lwcf.tavg0; a0=mean(mean(a(~id).*aa0)); z0=a; 
a=v1.toa.lwcf.tavg0; a1=mean(mean(a(~id).*aa0)); z1=a;
a=v2.toa.lwcf.tavg0; a2=mean(mean(a(~id).*aa0)); z2=a;
a=v3.toa.lwcf.tavg0; a3=mean(mean(a(~id).*aa0)); z3=a;
a=v4.toa.lwcf.tavg0; a4=mean(mean(a(~id).*aa0)); z4=a;
p.vname='lwcf'; p.xy=[0 360 -90 90]; p.opt=5; p.cm=4
p.c='b'; p.nn=256; p.expn='WP';p.optit=0;
p.c1=[-4 4]; p.c2=p.c1; p.c3=p.c1; p.c4=p.c1; p.c5=p.c1; p.c6=p.c1;
p.aa=aa; p.id=id;
p.z1=z1-z0; p.z2=z2-z0; p.z3=z3-z0; p.z4=z4-z0; p.z5=z2-z1; p.z6=z2-z3;
...
s=v0.s; p.y=s.lat; p.x=s.lon; p.lm=s.lm0; p.im=v0.sfc.ice.tavg0; 
aa=s.aa; id=(p.lm<0|p.im<0); a=aa(~id); aa0=a/mean(a);
a=v0.toa.swcf.tavg0; a0=mean(mean(a(~id).*aa0)); z0=a; 
a=v1.toa.swcf.tavg0; a1=mean(mean(a(~id).*aa0)); z1=a;
a=v2.toa.swcf.tavg0; a2=mean(mean(a(~id).*aa0)); z2=a;
a=v3.toa.swcf.tavg0; a3=mean(mean(a(~id).*aa0)); z3=a;
a=v4.toa.swcf.tavg0; a4=mean(mean(a(~id).*aa0)); z4=a;
p.vname='swcf'; p.xy=[0 360 -90 90]; p.opt=5; p.cm=4
p.c='b'; p.nn=256; p.expn='WP';p.optit=0;
p.c1=[-4 4]; p.c2=p.c1; p.c3=p.c1; p.c4=p.c1; p.c5=p.c1; p.c6=p.c1;
p.aa=aa; p.id=id;
p.z1=z1-z0; p.z2=z2-z0; p.z3=z3-z0; p.z4=z4-z0; p.z5=z2-z1; p.z6=z2-z3;
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
s=v0.s; lat=s.lat; lon=s.lon; lm=s.lm0; im=v0.sfc.ice.tavg0; aa=s.aa; c1=-2; c2=2;
id=(lm>0|im>0); a=aa(~id); aa0=a/mean(a);
pms=[ 0, 0, 1200, 900]*1.5; row=3; col=2; fsize=24; lw=2; 
handle=figure('Position',pms,'visible','on');
subplot(row,col,1); a=z1-z0; a(id)=NaN;
pcolor(lon,lat,a); shading flat; caxis([c1 c2]); hold on;
contour(lon,lat,lm,1,'k'); colorbar; colormap(jet);
a1=mean(mean(a(~id).*aa0)); s1=sprintf('%5.3f',a1);
title(strcat('(a) WPobs0 minus CTL (',s1,'K)'));

subplot(row,col,2); a=z2-z0; a(id)=NaN;
pcolor(lon,lat,a); shading flat; caxis([c1 c2]); hold on;
contour(lon,lat,lm,1,'k'); colorbar; colormap(jet); 
a2=mean(mean(a(~id).*aa0)); s2=sprintf('%5.3f',a2);
title(strcat('(b) WPmod minus CTL (',s2,'K)'));

subplot(row,col,3); a=z3-z0; a(id)=NaN;
pcolor(lon,lat,a); shading flat; caxis([c1 c2]); hold on;
contour(lon,lat,lm,1,'k'); colorbar; colormap(jet);
a3=mean(mean(a(~id).*aa0)); s3=sprintf('%5.3f',a3);
title(strcat('(c) WPobs1 minus CTL (',s3,'K)'));
%s3=sprintf('%5.3f',a2-a1);
%title(strcat('(c) (b) minus (a) (',s3,'K)'));

subplot(row,col,4); a=z4-z0; a(id)=NaN; 
pcolor(lon,lat,a); shading flat; caxis([c1 c2]); hold on;
contour(lon,lat,lm,1,'k'); colorbar; colormap(jet);
a4=mean(mean(a(~id).*aa0)); s4=sprintf('%5.3f',a4);
title(strcat('(d) WPobs2 minus CTL (',s4,'K)'));
%a4=mean(mean(a(~id).*aa0)); s4=sprintf('%5.3f',a4);
%title(strcat('(d) (b)/avg(b) minus (a)/avg(b) (',s4,'K)'));

subplot(row,col,5); a=(z2-z0)/a2-(z1-z0)/a1; a=z2-z3; a(id)=NaN;
pcolor(lon,lat,a); shading flat; caxis([c1 c2]); hold on;
contour(lon,lat,lm,1,'k'); colorbar; colormap(jet);
a5=mean(mean(a(~id).*aa0)); s5=sprintf('%5.3f',a5);
title(strcat('(e) (b)/avg(b) minus (a)/avg(a) (',s5,'K)'));

subplot(row,col,6); a=(z2-z0)/a2-(z3-z0)/a3; a(id)=NaN;
pcolor(lon,lat,a); shading flat; caxis([c1 c2]); hold on;
contour(lon,lat,lm,1,'k'); colorbar; colormap(jet);
a6=mean(mean(a(~id).*aa0)); s6=sprintf('%5.3f',a6);
title(strcat('(f) (b)/avg(b) minus (c)/avg(c) (',s6,'K)'));

cmap=bluewhitered_miz(256); colormap(cmap);
visfig='off'; figpath='./fig_cre/'; expn='sstp';
printnew(visfig,figpath,expn,vname);
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
ph='/archive/Ming.Zhao/awg/2022.03/'; f='_global_opt2.tsana_new_1951_2020.mat';
...
mean(w0.atm.wvp.ts.org_ann-v0.atm.wvp.ts.org_ann)/mean(v0.atm.wvp.ts.org_ann)/2.27
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
ph='/archive/Ming.Zhao/awg/2022.03/'; f='_global_opt2.tsana_new_2001_2020.mat';
e='c192L33_am4p0_amip_HIRESMIP_HX';     n=strcat(ph,e,'/',e,f); load(n);v0=v;
e='c192L33_am4p0_amip_HIRESMIP_HX_p2K'; n=strcat(ph,e,'/',e,f); load(n);w0=v;
