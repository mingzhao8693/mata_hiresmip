function [v]=readarmap_spearhi(tpath,expn,yr1,yr2,ardir,opt)
...
for t=1:v.nyr
  ...
  for m=1:12
    ...
    if g.opt==1; arf=interp_grid(arf,g.lonx,g.latx,g.lon,g.lat,1); end; %interp to lower resolution (c192)
