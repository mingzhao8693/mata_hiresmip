function [d]=getswnet_clr(CM4,ESM,SP1,SP4,a40,a41,t1,t2,opt)
%t1=101; t2=150; opt=0;
...
a=a40.I0.toa.swnet_clr.all (:    ,:,:,:); I5=gmean(a,aa,opt);
a=a40.V0.toa.swnet_clr.all (:    ,:,:,:); V5=gmean(a,aa,opt);
a=a40.P0.toa.swnet_clr.all (:    ,:,:,:); P5=gmean(a,aa,opt);

a=a40.S1.toa.swnet_clr.all (:    ,:,:,:); A5=gmean(a,aa,opt);
a=a40.I1.toa.swnet_clr.all (:    ,:,:,:); B5=gmean(a,aa,opt);
a=a40.V1.toa.swnet_clr.all (:    ,:,:,:); C5=gmean(a,aa,opt);
a=a40.P1.toa.swnet_clr.all (:    ,:,:,:); D5=gmean(a,aa,opt);
%a=a40.P2.toa.swnet_clr.all (:    ,:,:,:); D5=gmean(a,aa,opt);
