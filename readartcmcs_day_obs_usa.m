function [v]=readartcmcs_day_obs_usa(tpath,expn,yr1,yr2,pct,opt,diag,latlon)
...
%expn='c192L33_am4p0_amip_HIRESMIP_nudge_wind_1951_2020'; yr1=1951;yr2=1978;opt='AR';
...
for m=1:length(d_end)
  ...
  a=readallyear_mon_usa(v,exd,varn,exf1,exf2,exf3,m,ff); v.daily(m).prday=a; size(a) %unit:mm/day
...
%  v.prday_nonid_ts_day_lat(m,:,:)  =s.nonid_ts_day_lat;
  %%%%%%%%%%%%%%%%%%%%%%%%%%%%%
  varn='prw'; ff='day'; exd=strcat('/',atmos_data_dir,'/daily_era5/'); exf1='ERA5.'; exf2='0101-'; exf3='1231.';
...
%  v.prw_idwei_ts_day_lat(m,:,:) =s.idwei_ts_day_lat;
  %%%%%%%%%%%%%%%%%%%%%%%%%%%%%
  varn='ivty'; ff='day'; exd=strcat('/',atmos_data_dir,'/daily_era5/'); exf1='ERA5.'; exf2='0101-'; exf3='1231.';
...
%  v.ivty_idwei_ts_day_lat(m,:,:) =s.idwei_ts_day_lat;
  %%%%%%%%%%%%%%%%%%%%%%%%%%%%%
  varn='ivtx'; ff='day'; exd=strcat('/',atmos_data_dir,'/daily_era5/'); exf1='ERA5.'; exf2='0101-'; exf3='1231.';
...
%  v.ivt_idwei_ts_day_lat(m,:,:) =s.idwei_ts_day_lat;
  %%%%%%%%%%%%%%%%%%%%%%%%%%%%%
  varn='u_ref_max'; ff='day'; exd=strcat('/',atmos_data_dir,'/daily_era5/'); exf1='ERA5.'; exf2='0101-'; exf3='1231.';
...
%  v.u_ref_idwei_ts_day_lat(m,:,:) =s.idwei_ts_day_lat;
  %%%%%%%%%%%%%%%%%%%%%%%%%%%%%
  varn='v_ref_max'; ff='day'; exd=strcat('/',atmos_data_dir,'/daily_era5/'); exf1='ERA5.'; exf2='0101-'; exf3='1231.';
