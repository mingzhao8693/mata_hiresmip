...
function ARdetect_miz_new2(tpath,expn,syr,latdef,londef,timedef,pixel_ivtpercentile_limit,ardir,opt)
...
%londef = [480, 0.375,  0.75]; syr='0002';
%timedef= [1460,str2num(syr),1,1,0,6];
%fname_ivt_limit=strcat(tpath,expn,'/AR_new/c192L33_am4p0_2010climo_new_p4K_newpp_0002_pixel_ivt_limit_new.nc');
%pixel_ivtpercentile_limit = 85; 
%pixel_ivtpercentile_limit = fname_ivt_limit;
...
outfile  = strcat(tpath,expn,'/',ardir,'/',expn,'_','AR_',syr,'.nc'); disp(outfile);
...
if exist('opt')
  'computing ivt_limit only, finished'
  return
end
