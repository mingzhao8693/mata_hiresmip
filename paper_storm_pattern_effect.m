...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
tpath='/archive/Ming.Zhao/awg/2022.03/'; diag=1;
...
a=[0 10]; p.c1=a; p.un='mm/day'; p.fsize=8; p.optit=4; p.opt=1;p.nn=256;
a=[0 10]; p.c2=a; p.c3=a; 
a=[0 3];  p.c4=a; p.c5=a; p.c6=a; p.c7=a; p.c8=[0 3]; p.rescale=false;
plot_2d_8panel(p)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
a=[0 1];  p.c1=a; p.c2=a; p.un='mm/day'; p.fsize=8; p.optit=7; p.opt=1;p.nn=256;
a=[0 25]; p.c3=a; p.c4=a; p.c5=a; p.c6=a; p.c7=a; p.c8=a; 
p.rescale=true; p.fact=1.234/0.26999;
plot_2d_8panel(p)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
p.z7=squeeze(v.al.fprc_idwei)*100;    
%p.z7=p.z2-p.z3; p.z7=(p.z4+p.z5+p.z6);
p.z8=p.z3-p.z7;
%p=smoothp(p,1,1,'omitnan','shrink');
...
a=[0 80]; p.c1=a; p.un='%'; p.fsize=8; p.optit=4; p.opt=1;p.nn=256;
...
a=[0 100]; 
p.c1=a; p.c2=a; p.un='%'; p.fsize=8; p.optit=7; p.opt=6;p.nn=256;
...
a=[0 50]; p.c1=a; p.un='kg/m2'; p.fsize=8; p.optit=4; p.opt=1;p.nn=256;
a=[0 50]; p.c2=a; p.c3=a; 
a=[0 30]; p.c4=a; p.c5=a; p.c6=a; p.c7=a; p.c8=a; p.rescale=false;
plot_2d_8panel(p)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
a=[0 70]; %a=[-30 30]; 
p.c1=a; p.c2=a; p.un='kg/m2'; p.fsize=8; p.optit=7; p.opt=1;p.nn=256;
p.c3=a; p.c4=a; p.c5=a; p.c6=a; p.c7=a; p.c8=a; 
p.rescale=true; p.fact=8.292/0.26999;
plot_2d_8panel(p)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
p.aa=squeeze(v.aa); p.id=~isnan(p.aa); p.id(p.j1:p.j2,:)=0; id=p.id;
p.cm=[0 0.0005 0.001 0.002 0.01:0.02:0.08 0.1:0.05:1]; p.c='k'; p.rescale=false;
v=ob; p.vn='obs_lwcf_idavg'; p.rescale=true; p.fact=8.948/0.26999;  
...
a=[0 120]; %a=[-30 30]; 
p.c1=a; p.c2=a; p.un='W/m2'; p.fsize=8; p.optit=4; p.opt=4;p.nn=256;
p.c3=a; p.c4=a; p.c5=a; p.c6=a; p.c7=a; p.c8=a; 
plot_2d_8panel(p)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
a=[-100 0]; p.c1=a; p.un='W/m2'; p.fsize=8; p.optit=4; p.opt=3;p.nn=256
a=[-100 0]; p.c2=a; p.c3=a; 
a=[-30  0]; p.c4=a; p.c5=a; p.c6=a; p.c7=a; p.c8=a; p.rescale=false;
plot_2d_8panel(p)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
a=[-120 0];  p.c1=a; p.un='W/m2'; p.fsize=8; p.optit=7; p.opt=3;p.nn=256;
a=[-120 0]; p.c2=a; p.c3=a; p.c4=a; p.c5=a; p.c6=a; p.c7=a; p.c8=a;
p.rescale=true; p.fact=-15.156/0.26999;
plot_2d_8panel(p)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
a=[-60 0]; p.c1=a; p.un='W/m2'; p.fsize=8; p.optit=4; p.opt=3;p.nn=256;
a=[-60 0]; p.c2=a; p.c3=a; 
a=[-10 0]; p.c4=a; p.c5=a; p.c6=a; p.c7=a; p.c8=a; p.rescale=false;
plot_2d_8panel(p)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
a=[-50 10];  p.c1=a; p.un='W/m2'; p.fsize=8; p.optit=7; p.opt=7;p.nn=256;
a=[-50 10]; p.c2=a; p.c3=a; p.c4=a; p.c5=a; p.c6=a; p.c7=a; p.c8=a;
...
a=[00 300]; p.c1=a; p.un='W/m2'; p.fsize=7; p.optit=4; p.opt=1;p.nn=256;
a=[0 300];  p.c2=a; p.c3=a; 
a=[0 50];   p.c4=a; p.c5=a; p.c6=a; p.c7=[0 200]; p.c8=p.c7; p.rescale=false;
plot_2d_8panel(p)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
