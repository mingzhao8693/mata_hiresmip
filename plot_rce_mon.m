...
expn='rce_am4p0_305_100km_128x64'; va=rceana_am4(tpath,expn,ts,te,zs,qc_th,do_uwc)
expn='rce_am4p0_295_100km_128x64'; va=rceana_am4(tpath,expn,ts,te,zs,qc_th,do_uwc)

expn='mwc_am4p0_295_100km_64x32'; va=rceana_am4(tpath,expn,ts,te,zs,qc_th,do_uwc)
expn='mwc_am4p0_305_100km_64x32'; va=rceana_am4(tpath,expn,ts,te,zs,qc_th,do_uwc)


tpath='/archive/Ming.Zhao/ndrce/warsaw_201710/';
ts=1; te=12; zs=1; qc_th=0.00001; do_uwc=1;
expn='mwc_am4p0_300_100km_64x32'; va=rceana_am4(tpath,expn,ts,te,zs,qc_th,do_uwc)
expn='mwc_am4p0_295_100km_64x32'; va=rceana_am4(tpath,expn,ts,te,zs,qc_th,do_uwc)
expn='mwc_am4p0_305_100km_64x32'; va=rceana_am4(tpath,expn,ts,te,zs,qc_th,do_uwc)


expn='rce_am4p0_300_100km_64x32';       v4=rceana_am4(tpath,expn,ts,te,zs,qc_th,do_uwc)
expn='RCE_am4p0_300_100km_64x32';       v0=rceana_am4(tpath,expn,ts,te,zs,qc_th,do_uwc)
expn='RCE_am4p0_300_100km_64x32_wind1'; v1=rceana_am4(tpath,expn,ts,te,zs,qc_th,do_uwc)
expn='RCE_am4p0_300_100km_64x32_wind2'; v2=rceana_am4(tpath,expn,ts,te,zs,qc_th,do_uwc)
expn='RCE_am4p0_300_100km_64x32_wind3'; v3=rceana_am4(tpath,expn,ts,te,zs,qc_th,do_uwc)

expn='RCE_am4p0_300_100km_128x64_wind3';v4=rceana_am4(tpath,expn,ts,te,zs,qc_th,do_uwc)


expn='RCE_am4p0_305_100km_64x32_wind3'; v1=rceana_am4(tpath,expn,ts,te,zs,qc_th,do_uwc)


expn='RCE_am4p0_300_100km_64x32';       v1=rceana_am4(tpath,expn,ts,te,zs,qc_th,do_uwc)
expn='RCE_am4p0_305_100km_64x32';       v2=rceana_am4(tpath,expn,ts,te,zs,qc_th,do_uwc)

expn='RCE_am4p0_300_100km_64x32_wind2'; v3=rceana_am4(tpath,expn,ts,te,zs,qc_th,do_uwc)


expn='RCE_am4p0_300_100km_64x32_wind1'; v1=rceana_am4(tpath,expn,ts,te,zs,qc_th,do_uwc)

expn='RCE_am4p0_305_100km_64x32'; v2=rceana_am4(tpath,expn,ts,te,zs,qc_th,do_uwc)
expn='RCE_am4p0_295_100km_64x32'; v3=rceana_am4(tpath,expn,ts,te,zs,qc_th,do_uwc)

expn='rce_am4p0_300_100km_64x32'; v1=rceana_am4(tpath,expn,ts,te,zs,qc_th,do_uwc)
expn='rce_am4p0_305_100km_64x32'; v2=rceana_am4(tpath,expn,ts,te,zs,qc_th,do_uwc)
expn='rce_am4p0_295_100km_64x32'; v3=rceana_am4(tpath,expn,ts,te,zs,qc_th,do_uwc)
expn='rce_am4p0_302_100km_64x32'; v3=rceana_am4(tpath,expn,ts,te,zs,qc_th,do_uwc)
...
matlab -r "rceana_mon('$tpath','RCE_H2048x128_L79_R01_295','$res',$ts,$te,$zs,$qc_th,0);exit"&
matlab -r "rceana_mon('$tpath','RCE_H2048x128_L79_R01_300','$res',$ts,$te,$zs,$qc_th,0);exit"&
matlab -r "rceana_mon('$tpath','RCE_H2048x128_L79_R01_305','$res',$ts,$te,$zs,$qc_th,0);exit"&
matlab -r "rceana_mon('$tpath','RCE_H2048x128_L79_R03_295','$res',$ts,$te,$zs,$qc_th,0);exit"&
matlab -r "rceana_mon('$tpath','RCE_H2048x128_L79_R03_300','$res',$ts,$te,$zs,$qc_th,0);exit"&
matlab -r "rceana_mon('$tpath','RCE_H2048x128_L79_R03_305','$res',$ts,$te,$zs,$qc_th,0);exit"&
matlab -r "rceana_mon('$tpath','RCE_H1024x064_L79_R06_295','$res',$ts,$te,$zs,$qc_th,0);exit"&
matlab -r "rceana_mon('$tpath','RCE_H1024x064_L79_R06_300','$res',$ts,$te,$zs,$qc_th,0);exit"&
matlab -r "rceana_mon('$tpath','RCE_H1024x064_L79_R06_305','$res',$ts,$te,$zs,$qc_th,0);exit"&
matlab -r "rceana_mon('$tpath','RCE_H0512x032_L79_R12_295','$res',$ts,$te,$zs,$qc_th,0);exit"
matlab -r "rceana_mon('$tpath','RCE_H0512x032_L79_R12_300','$res',$ts,$te,$zs,$qc_th,0);exit"
matlab -r "rceana_mon('$tpath','RCE_H0512x032_L79_R12_305','$res',$ts,$te,$zs,$qc_th,0);exit"
matlab -r "rceana_mon('$tpath','RCE_H0256x016_L79_R24_295','$res',$ts,$te,$zs,$qc_th,0);exit"
matlab -r "rceana_mon('$tpath','RCE_H0256x016_L79_R24_300','$res',$ts,$te,$zs,$qc_th,0);exit"
matlab -r "rceana_mon('$tpath','RCE_H0256x016_L79_R24_305','$res',$ts,$te,$zs,$qc_th,0);exit"
matlab -r "rceana_mon('$tpath','RCE_H0128x008_L79_R48_295','$res',$ts,$te,$zs,$qc_th,0);exit"
matlab -r "rceana_mon('$tpath','RCE_H0128x008_L79_R48_300','$res',$ts,$te,$zs,$qc_th,0);exit"
matlab -r "rceana_mon('$tpath','RCE_H0128x008_L79_R48_305','$res',$ts,$te,$zs,$qc_th,0);exit"
matlab -r "rceana_mon('$tpath','RCE_H0128x008_L79_R48_conv_295','$res',$ts,$te,$zs,$qc_th,1);exit"
matlab -r "rceana_mon('$tpath','RCE_H0128x008_L79_R48_conv_300','$res',$ts,$te,$zs,$qc_th,1);exit"
matlab -r "rceana_mon('$tpath','RCE_H0128x008_L79_R48_conv_305','$res',$ts,$te,$zs,$qc_th,1);exit"

%%%%%%%%%%%%%%%%%%%%%%%%%%%%
tpath='/archive/Ming.Zhao/ndrce/warsaw_201710/'; 
t1=8; t2=12; zs=1; res='org'; qc_th=0.00001; do_uwc=1;
expn='RCE_H0128x008_L79_R48_conv_300'; v6=rceana_mon(tpath,expn,res,t1,t2,zs,qc_th,1);
...
[CPD,CPV,CL,RV,RD,LV0,G,ROWL,CPVMCL,EPS,EPSI,GINV,RDOCP,T0,HLF]=thermconst;
tpath='/work/miz/mat_rce/'; res='org'; fext=strcat('_',res,'_mon_8_12.mat');
fext=strcat('_mon_1_60.mat');
expn='rce_am4p0_300_100km_128x64';     fn=strcat(tpath,expn,fext); load(fn);v7=v;
expn='rce_am4p0_295_100km_128x64';     fn=strcat(tpath,expn,fext); load(fn);c7=v;
expn='rce_am4p0_305_100km_128x64';     fn=strcat(tpath,expn,fext); load(fn);w7=v;

tpath='/work/miz/mat_rce/'; fext=strcat('_mon_1_60.mat');
expn='rce_am4p0_295_100km_64x32'; fn=strcat(tpath,expn,fext); load(fn);c8=v;
expn='rce_am4p0_300_100km_64x32'; fn=strcat(tpath,expn,fext); load(fn);v8=v;
expn='rce_am4p0_305_100km_64x32'; fn=strcat(tpath,expn,fext); load(fn);w8=v;
expn='rce_am4p0_302_100km_64x32'; fn=strcat(tpath,expn,fext); load(fn);x8=v;

tpath='/work/miz/mat_rce/'; fext=strcat('_mon_1_36.mat');
expn='rce_am4p0_295_100km_128x64_new'; fn=strcat(tpath,expn,fext); load(fn);c7a=v;
expn='rce_am4p0_300_100km_128x64_new'; fn=strcat(tpath,expn,fext); load(fn);v7a=v;
expn='rce_am4p0_305_100km_128x64_new'; fn=strcat(tpath,expn,fext); load(fn);w7a=v;
expn='rce_am4p0_302_100km_128x64_new'; fn=strcat(tpath,expn,fext); load(fn);x7a=v;


tpath='/work/miz/mat_rce/'; fext=strcat('_mon_1_60.mat');
expn='rce_am4p0_300_100km_64x32';       fn=strcat(tpath,expn,fext); load(fn);v9a=v;
expn='RCE_am4p0_300_100km_64x32_wind1'; fn=strcat(tpath,expn,fext); load(fn);v9b=v;
expn='RCE_am4p0_300_100km_64x32_wind2'; fn=strcat(tpath,expn,fext); load(fn);v9c=v;
expn='RCE_am4p0_300_100km_64x32_wind3'; fn=strcat(tpath,expn,fext); load(fn);v9d=v;
expn='RCE_am4p0_300_100km_64x32';       fn=strcat(tpath,expn,fext); load(fn);v9e=v;

expn='mwc_am4p0_295_100km_64x32'; fn=strcat(tpath,expn,fext); load(fn);ca=v;
expn='mwc_am4p0_300_100km_64x32'; fn=strcat(tpath,expn,fext); load(fn);va=v;
expn='mwc_am4p0_305_100km_64x32'; fn=strcat(tpath,expn,fext); load(fn);wa=v;
...
pp='/'; region='global'; dr=strcat('_',region,'_tsana.mat');
tpath='/archive/Ming.Zhao/CFMIP/gfdl/';
expn='amip';       fn=strcat(tpath,expn,pp,expn,dr);load(fn);am4.v1=v;
expn='amip-p4K-a'; fn=strcat(tpath,expn,pp,expn,dr);load(fn);am4.w1=v;


y1=v7.toa.ttcf.all.ts; y2=v8a.toa.ttcf.all.ts; y3=v7a.toa.ttcf.all.ts;
Y1=w7.toa.ttcf.all.ts; Y2=w8a.toa.ttcf.all.ts; Y3=w7a.toa.ttcf.all.ts;
z1=c7.toa.ttcf.all.ts; z2=c8a.toa.ttcf.all.ts; z3=c7a.toa.ttcf.all.ts;

y1=v7.toa.lwcf.all.ts; y2=v8a.toa.lwcf.all.ts; y3=v7a.toa.lwcf.all.ts;
Y1=w7.toa.lwcf.all.ts; Y2=w8a.toa.lwcf.all.ts; Y3=w7a.toa.lwcf.all.ts;
z1=c7.toa.lwcf.all.ts; z2=c8a.toa.lwcf.all.ts; z3=c7a.toa.lwcf.all.ts;

y1=v7.toa.swcf.all.ts; y2=v8a.toa.swcf.all.ts; y3=v7a.toa.swcf.all.ts;
Y1=w7.toa.swcf.all.ts; Y2=w8a.toa.swcf.all.ts; Y3=w7a.toa.swcf.all.ts;
z1=c7.toa.swcf.all.ts; z2=c8a.toa.swcf.all.ts; z3=c7a.toa.swcf.all.ts;

figure; 
plot(y1,'k'); hold on; plot(y2,'k--'); plot(y3,'k:');
plot(Y1,'r'); hold on; plot(Y2,'r--'); plot(Y3,'r:');
plot(z1,'b'); hold on; plot(z2,'b--'); plot(z3,'b:');

figure; 
plot(Y1-y1,'k'); hold on; plot(Y2-y2,'r'); plot(Y3-y3,'b');
...
%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%
vname='netradtoa_avg'; xy=[0 10 -30 90]; opt=4;
...
a.v7=v7.toa.netrad.all.avg; a.c7=c7.toa.netrad.all.avg; a.w7=w7.toa.netrad.all.avg;
a.v8=v8.toa.netrad.all.avg; a.c8=c8.toa.netrad.all.avg; a.w8=w8.toa.netrad.all.avg;
...
b.v7=v7.toa.netrad.all.std_ts; b.c7=c7.toa.netrad.all.std_ts; b.w7=w7.toa.netrad.all.std_ts; 
b.v8=v8.toa.netrad.all.std_ts; b.c8=c8.toa.netrad.all.std_ts; b.w8=w8.toa.netrad.all.std_ts; 
yl='TOA net radiative flux (W/m2)'; plotbar;
printit(visfig,figpath,expn,vname);
%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%
vname='netradtoa_clr_avg'; xy=[0 10 0 110]; opt=1;
...
a.v7=v7.toa.netrad_clr.all.avg; a.c7=c7.toa.netrad_clr.all.avg; a.w7=w7.toa.netrad_clr.all.avg; 
a.v8=v8.toa.netrad_clr.all.avg; a.c8=c8.toa.netrad_clr.all.avg; a.w8=w8.toa.netrad_clr.all.avg; 
...
b.v7=v7.toa.netrad_clr.all.std_ts; b.c7=c7.toa.netrad_clr.all.std_ts; b.w7=w7.toa.netrad_clr.all.std_ts; 
b.v8=v8.toa.netrad_clr.all.std_ts; b.c8=c8.toa.netrad_clr.all.std_ts; b.w8=w8.toa.netrad_clr.all.std_ts; 
yl='TOA clear-sky net radiative flux (W/m2)'; plotbar;
printit(visfig,figpath,expn,vname);
%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%
vname='lwnet_clr_avg'; xy=[0 10 200 320]; opt=2;
...
a.v7=v7.toa.lwnet_clr.all.avg; a.c7=c7.toa.lwnet_clr.all.avg; a.w7=w7.toa.lwnet_clr.all.avg; 
a.v8=v8.toa.lwnet_clr.all.avg; a.c8=c8.toa.lwnet_clr.all.avg; a.w8=w8.toa.lwnet_clr.all.avg; 
...
b.v7=v7.toa.lwnet_clr.all.std_ts; b.c7=c7.toa.lwnet_clr.all.std_ts; b.w7=w7.toa.lwnet_clr.all.std_ts; 
b.v8=v8.toa.lwnet_clr.all.std_ts; b.c8=c8.toa.lwnet_clr.all.std_ts; b.w8=w8.toa.lwnet_clr.all.std_ts; 
...
%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%
vname='lwcf_avg'; xy=[0 10 10 32]; opt=1;
...
a.v7=v7.toa.lwcf.all.avg; a.c7=c7.toa.lwcf.all.avg; a.w7=w7.toa.lwcf.all.avg; 
a.v8=v8.toa.lwcf.all.avg; a.c8=c8.toa.lwcf.all.avg; a.w8=w8.toa.lwcf.all.avg; 
...
b.v7=v7.toa.lwcf.all.std_ts; b.c7=c7.toa.lwcf.all.std_ts; b.w7=w7.toa.lwcf.all.std_ts; 
b.v8=v8.toa.lwcf.all.std_ts; b.c8=c8.toa.lwcf.all.std_ts; b.w8=w8.toa.lwcf.all.std_ts; 
yl='TOA LW CRE (W/m2)'; plotbar;
printit(visfig,figpath,expn,vname);
%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%
vname='lwcf_dn_avg'; xy=[0 10 0 65]; opt=1;
...
a.v7=v7.toa.lwcf.dn.avg; a.c7=c7.toa.lwcf.dn.avg; a.w7=w7.toa.lwcf.dn.avg; 
a.v8=v8.toa.lwcf.dn.avg; a.c8=c8.toa.lwcf.dn.avg; a.w8=w8.toa.lwcf.dn.avg; 
...
b.v7=v7.toa.lwcf.dn.std_ts; b.c7=c7.toa.lwcf.dn.std_ts; b.w7=w7.toa.lwcf.dn.std_ts; 
b.v8=v8.toa.lwcf.dn.std_ts; b.c8=c8.toa.lwcf.dn.std_ts; b.w8=w8.toa.lwcf.dn.std_ts; 
yl='TOA LW CRE in large-scale subsidence region (W/m2)'; plotbar;
printit(visfig,figpath,expn,vname);
%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%
vname='lwcf_up_avg'; xy=[0 10 0 65]; opt=1;
...
a.v7=v7.toa.lwcf.up.avg; a.c7=c7.toa.lwcf.up.avg; a.w7=w7.toa.lwcf.up.avg; 
a.v8=v7.toa.lwcf.up.avg; a.c8=c8.toa.lwcf.up.avg; a.w8=w8.toa.lwcf.up.avg; 
...
b.v7=v7.toa.lwcf.up.std_ts; b.c7=c7.toa.lwcf.up.std_ts; b.w7=w7.toa.lwcf.up.std_ts; 
b.v8=v8.toa.lwcf.up.std_ts; b.c8=c8.toa.lwcf.up.std_ts; b.w8=w8.toa.lwcf.up.std_ts; 
...
%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%
vname='swcf_avg'; xy=[0 10 -120 0]; opt=4;
...
a.v7=v7.toa.swcf.all.avg; a.c7=c7.toa.swcf.all.avg; a.w7=w7.toa.swcf.all.avg; 
a.v8=v8.toa.swcf.all.avg; a.c8=c8.toa.swcf.all.avg; a.w8=w8.toa.swcf.all.avg; 
...
b.v7=v7.toa.swcf.all.std_ts; b.c7=c7.toa.swcf.all.std_ts; b.w7=w7.toa.swcf.all.std_ts; 
b.v8=v8.toa.swcf.all.std_ts; b.c8=c8.toa.swcf.all.std_ts; b.w8=w8.toa.swcf.all.std_ts; 
yl='TOA SW CRE (W/m2)'; plotbar;
printit(visfig,figpath,expn,vname);
%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%
vname='swcf_up_avg'; xy=[0 10 -250 0]; opt=4;
...
a.v7=v7.toa.swcf.up.avg; a.c7=c7.toa.swcf.up.avg; a.w7=w7.toa.swcf.up.avg; 
a.v8=v8.toa.swcf.up.avg; a.c8=c8.toa.swcf.up.avg; a.w8=w8.toa.swcf.up.avg; 
...
b.v7=v7.toa.swcf.up.std_ts; b.c7=c7.toa.swcf.up.std_ts; b.w7=w7.toa.swcf.up.std_ts; 
b.v8=v8.toa.swcf.up.std_ts; b.c8=c8.toa.swcf.up.std_ts; b.w8=w8.toa.swcf.up.std_ts; 
yl='TOA SW CRE in large-scale ascent region (W/m2)'; plotbar;
printit(visfig,figpath,expn,vname);
%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%
vname='swcf_dn_avg'; xy=[0 10 -125 0]; opt=4;
...
a.v7=v7.toa.swcf.dn.avg; a.c7=c7.toa.swcf.dn.avg; a.w7=w7.toa.swcf.dn.avg; 
a.v8=v8.toa.swcf.dn.avg; a.c8=c8.toa.swcf.dn.avg; a.w8=w8.toa.swcf.dn.avg; 
...
b.v7=v7.toa.swcf.dn.std_ts; b.c7=c7.toa.swcf.dn.std_ts; b.w7=w7.toa.swcf.dn.std_ts; 
b.v8=v8.toa.swcf.dn.std_ts; b.c8=c8.toa.swcf.dn.std_ts; b.w8=w8.toa.swcf.dn.std_ts; 
yl='TOA SW CRE in large-scale subsidence region (W/m2)'; plotbar;
printit(visfig,figpath,expn,vname);
%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%
vname='qal_avg'; xy=[0 10 0 70]; opt=2;
...
a.v7=v7.qal.all.avg; a.c7=c7.qal.all.avg; a.w7=w7.qal.all.avg; 
a.v8=v7.qal.all.avg; a.c8=c7.qal.all.avg; a.w8=w7.qal.all.avg; 
...
b.v7=v7.qal.all.std_ts; b.c7=c7.qal.all.std_ts; b.w7=w7.qal.all.std_ts; 
b.v8=v7.qal.all.std_ts; b.c8=c7.qal.all.std_ts; b.w8=w7.qal.all.std_ts; 
