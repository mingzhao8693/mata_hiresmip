function s=get_mon_stat_spearhi(a,id,opt,g)
...
if g.opt==1
  lonx=g.lonx; latx =g.latx; lon=g.lon; lat=g.lat;
  a =interp_grid(a, lonx,latx,lon,lat,1);
  id=interp_grid(id,lonx,latx,lon,lat,1);
end;
