...
tpath='/archive/Ming.Zhao/am5/am5f8d5r0/';
p.yr1='1980'; p.yr2='2020'; p.syr=2; p.nyr=40; p.y1=1981; p.y2=2020; 
p.expn='c96L65_am5f8d5r0_amip';       v0=tsana_hiresmip_new(o,tpath,p);
p.expn='c96L65_am5f8d5r0_amip_test2'; v1=tsana_hiresmip_new(o,tpath,p);
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
pms=[ 0, 0, 1000, 800]*1.5; row=2; col=2;
handle = figure('Position', pms,'visible','on');
lon=v.s.lon; lat=v.s.lat; lm=v.s.lm0; expn1='CNTL'; expn2='EVAPAERO'; xl='year'
subplot(row,col,1); 
y1=squeeze(v.toa.netrad.sea_bias (1,:,:));  
y2=squeeze(v1.toa.netrad.sea_bias(1,:,:)); 
pcolor(lon,lat,y2-y1); shading flat; colorbar; hold on; caxis([-4 4]);
contour(lon,lat,lm,1,'k')
title(strcat('TOA NETRAD;(',expn2,' - ',expn1,')'));

subplot(row,col,2);
y1=squeeze(v.toa.netrad_clr.sea_bias (1,:,:));  
y2=squeeze(v1.toa.netrad_clr.sea_bias(1,:,:)); 
pcolor(lon,lat,y2-y1); shading flat; colorbar; hold on; caxis([-4 4]);
contour(lon,lat,lm,1,'k')
title(strcat('TOA NETRAD CLR;(',expn2,' - ',expn1,')'));

subplot(row,col,3);
y1=squeeze(v.toa.lwnet.sea_bias (1,:,:));  
y2=squeeze(v1.toa.lwnet.sea_bias(1,:,:)); 
pcolor(lon,lat,y2-y1); shading flat; colorbar; hold on; caxis([-4 4]);
contour(lon,lat,lm,1,'k')
title(strcat('TOA LWNET;(',expn2,' - ',expn1,')'));

subplot(row,col,4);
y1=squeeze(v.toa.swnet.sea_bias (1,:,:));%-v.toa.lwnet.sea_bias (1,:,:));
y2=squeeze(v1.toa.swnet.sea_bias(1,:,:));%-v1.toa.lwnet.sea_bias(1,:,:)); 
pcolor(lon,lat,y2-y1); shading flat; colorbar; hold on; caxis([-4 4]);
contour(lon,lat,lm,1,'k')
title(strcat('TOA SWNET;(',expn2,' - ',expn1,')'));

visfig='off'; figpath='./fig_am5/'; expn='evap_aero'; vname='toamap'
...
pms=[ 0, 0, 1000, 800]*1.5; row=2; col=2;
handle = figure('Position', pms,'visible','on');
x=[1981:2020]; expn1='CNTL'; expn2='CNTL-evapaero'; xl='year'
subplot(row,col,1); xy=[1980 2020 -5 5];
y1=v.toa.netrad.ann_stat.bias.all;  y1_avg=mean(y1);
y2=v1.toa.netrad.ann_stat.bias.all; y2_avg=mean(y2);
plot(x,y1,'r'); hold on; plot(x,y2,'b');
s1=sprintf('%s (mean=%5.2f)',expn1,y1_avg);
s2=sprintf('%s (mean=%5.2f)',expn2,y2_avg);
legend(s1,s2,'Location','southeast');
yl='TOA NETRAD'; ylabel(yl); xlabel(xl);

subplot(row,col,2);
y1=v.toa.netrad_clr.ann_stat.bias.all;  y1_avg=mean(y1);
y2=v1.toa.netrad_clr.ann_stat.bias.all; y2_avg=mean(y2);
plot(x,y1,'r'); hold on; plot(x,y2,'b');
s1=sprintf('%s (mean=%5.2f)',expn1,y1_avg);
s2=sprintf('%s (mean=%5.2f)',expn2,y2_avg);
legend(s1,s2,'Location','southeast');
yl='TOA NETRAD-CLR'; ylabel(yl); xlabel(xl);

subplot(row,col,3); 
y1=v.toa.lwnet.ann_stat.bias.all;  y1_avg=mean(y1);
y2=v1.toa.lwnet.ann_stat.bias.all; y2_avg=mean(y2);
plot(x,y1,'r'); hold on; plot(x,y2,'b');
s1=sprintf('%s (mean=%5.2f)',expn1,y1_avg);
s2=sprintf('%s (mean=%5.2f)',expn2,y2_avg);
legend(s1,s2,'Location','southeast');
yl='TOA LW NET'; ylabel(yl); xlabel(xl);


subplot(row,col,4);
y1=v.toa.swnet.ann_stat.bias.all;  y1_avg=mean(y1);
y2=v1.toa.swnet.ann_stat.bias.all; y2_avg=mean(y2);
plot(x,y1,'r'); hold on; plot(x,y2,'b');
s1=sprintf('%s (mean=%5.2f)',expn1,y1_avg);
s2=sprintf('%s (mean=%5.2f)',expn2,y2_avg);
legend(s1,s2,'Location','southeast');
yl='TOA SW NET'; ylabel(yl); xlabel(xl);

visfig='off'; figpath='./fig_am5/'; expn='evap-aero'; vname='toa'
printnew(visfig,figpath,expn,vname);
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
pms=[ 0, 0, 1000, 800]*1.5; row=2; col=2;
handle = figure('Position', pms,'visible','on');
x=[1981:2020]; expn1='CNTL'; expn2='CNTL-evapaero'; xl='year'
subplot(row,col,1); xy=[1980 2020 -5 5];
y1=v.toa.netrad.ann_stat.mmen.all;  y1_avg=mean(y1);
y2=v1.toa.netrad.ann_stat.mmen.all; y2_avg=mean(y2);
plot(x,y1,'r'); hold on; plot(x,y2,'b');
s1=sprintf('%s (mean=%5.2f)',expn1,y1_avg);
s2=sprintf('%s (mean=%5.2f)',expn2,y2_avg);
legend(s1,s2,'Location','southeast');
...
subplot(row,col,2);
y1=v.toa.netrad_clr.ann_stat.mmen.all;  y1_avg=mean(y1);
y2=v1.toa.netrad_clr.ann_stat.mmen.all; y2_avg=mean(y2);
plot(x,y1,'r'); hold on; plot(x,y2,'b');
s1=sprintf('%s (mean=%5.2f)',expn1,y1_avg);
s2=sprintf('%s (mean=%5.2f)',expn2,y2_avg);
legend(s1,s2,'Location','southeast');
...
subplot(row,col,3); 
y1=v.toa.lwnet.ann_stat.mmen.all;  y1_avg=mean(y1);
y2=v1.toa.lwnet.ann_stat.mmen.all; y2_avg=mean(y2);
plot(x,y1,'r'); hold on; plot(x,y2,'b');
s1=sprintf('%s (mean=%5.2f)',expn1,y1_avg);
s2=sprintf('%s (mean=%5.2f)',expn2,y2_avg);
legend(s1,s2,'Location','southeast');
...
subplot(row,col,4);
y1=v.toa.swnet.ann_stat.mmen.all;  y1_avg=mean(y1);
y2=v1.toa.swnet.ann_stat.mmen.all; y2_avg=mean(y2);
plot(x,y1,'r'); hold on; plot(x,y2,'b');
s1=sprintf('%s (mean=%5.2f)',expn1,y1_avg);
s2=sprintf('%s (mean=%5.2f)',expn2,y2_avg);
legend(s1,s2,'Location','southeast');
...
visfig='off'; figpath='./fig_am5/'; expn='evap_aero'; vname='toa'
printnew(visfig,figpath,expn,vname);

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
p.latlon=[0 360 -90 90]; p.region='global'; p.mod='c96';
p.do_trend=0; p.do_scalar=0; p.myr=1; p.opt=1; p.do_3d_atm=0; p.do_all=1;
p.yr1='1980'; p.yr2='2020'; p.syr=2; p.nyr=35; p.y1=1981; p.y2=2014; 
...
e='c384L33_am4p0_spearhi';                n=strcat(ph,e,'/',e,f); load(n);z.w1a=v; 
e='c384L33_am4p0_spearhi_peff_l_d_9e_5';  n=strcat(ph,e,'/',e,f); load(n);z.w2a=v; 
...
del=' $\Delta$'; s0='NETRAD;'; s1='LWNET; '; s2='SWNET; '; s3='TTCF; '; p.do_bias=1;
p.s0 =strcat(a0,'~(',p.sea,');~',s0); p.s1 =strcat(a1,';~',del,s0); p.s2 =strcat(a2,';~',del,s0); 
p.s3 =strcat(s1); p.s4 =strcat(del,s1); p.s5 =strcat(del,s1); 
p.s6 =strcat(s2); p.s7 =strcat(del,s2); p.s8 =strcat(del,s2); 
p.s9 =strcat(s3); p.s10=strcat(del,s3); p.s11=strcat(del,s3);
