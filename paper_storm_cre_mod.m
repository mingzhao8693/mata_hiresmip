...
expn='c192L33_am4p0_amip_HIRESMIP_HX7'; ardir='AR_climlmt';yr1=2001;yr2=2020;pct=[99 99.9];
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
tpath='/work/miz/mat_hiresmip_cre/'; s='_readartcmcs_day_cre_new.mat';
expn='c192L33_am4p0_amip_HIRESMIP_nudge_wind_1951_2020'; yrs='_2001_2020_'; diag='_diag2';
...
p.z5=squeeze(vx.pr.frqday-v.pr.frqday)*100/p.dtas;
p.z3=p.z1-p.z5;
p.z7=squeeze(vx.al.frqday-v.al.frqday)*100/p.dtas;
p.z2=squeeze(vx.ar.frqday-v.ar.frqday)*100/p.dtas;
p.z4=squeeze(vx.tc.frqday-v.tc.frqday)*100/p.dtas;
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%===FigA1n===: annual precipitation from P-days %%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
v=ob.ar; %all time mean prday from each weather type
p.lm=v.lm; p.x=v.lon; p.y=v.lat; p.xy=[0 360 -90 90];p.expn='c192';
...
p.z3=squeeze((vx.p2.prday_idwei-vx.pr.prday_idwei)-(v.p2.prday_idwei-v.pr.prday_idwei))/p.dtas;   
p.z5=squeeze(vx.pr.prday_idwei-v.pr.prday_idwei)/p.dtas; 
p.z7=squeeze(vx.al.prday_idwei-v.al.prday_idwei)/p.dtas;
p.z2=squeeze(vx.ar.prday_idwei-v.ar.prday_idwei)/p.dtas;    
p.z4=squeeze(vx.tc.prday_idwei-v.tc.prday_idwei)/p.dtas;    
...
p.s3='(b) Pr; drizzle days'; 
p.s5='(c) Pr; wet days';
p.s7='(d) Pr; storm (AR+TS+MCS) days';
p.s2='(e) Pr; AR days'; 
p.s4='(f) Pr; TS days';
p.s6='(g) Pr; MCS days'; 
p.s8='(h) Pr; wet non-storm days';
a=[c1 c2]; p.c1=a; p.fsize=8; p.optit=4; p.opt=5; p.nn=256;
a=[c3 c4]; p.c3=a; p.c5=a; p.c7=a; p.c8=a;
a=[c3 c4]; p.c2=a; p.c4=a; p.c6=a;
p.fmt='eps'; plot_2d_8panel_revision(p)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%===Fig2n===: annual mean LWCF contributed from AR/TS/MSC %%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
v=ob.ar; %all time mean prday from each weather type
p.lm=v.lm; p.x=v.lon; p.y=v.lat; p.xy=[0 360 -90 90];p.expn='c192';
...
p.z3=squeeze((vx.p2.lwcf_idwei-vx.pr.lwcf_idwei)-(v.p2.lwcf_idwei-v.pr.lwcf_idwei))/p.dtas;
p.z5=squeeze(vx.pr.lwcf_idwei-v.pr.lwcf_idwei)/p.dtas;
p.z7=squeeze(vx.al.lwcf_idwei-v.al.lwcf_idwei)/p.dtas;
p.z2=squeeze(vx.ar.lwcf_idwei-v.ar.lwcf_idwei)/p.dtas;
p.z4=squeeze(vx.tc.lwcf_idwei-v.tc.lwcf_idwei)/p.dtas;
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%===Fig3n===: annual mean SWCF contributed from AR/TS/MSC %%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
p.z5=squeeze(vx.pr.swcf_idwei-v.pr.swcf_idwei)/p.dtas; 
p.z7=squeeze(vx.al.swcf_idwei-v.al.swcf_idwei)/p.dtas;
p.z2=squeeze(vx.ar.swcf_idwei-v.ar.swcf_idwei)/p.dtas;    
p.z4=squeeze(vx.tc.swcf_idwei-v.tc.swcf_idwei)/p.dtas;    
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%===FigA1n===: PR averaged over various P-days %%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
v=ob.ar; p.expn='c192'; %all time mean prday from each weather type
p.lm=v.lm; p.x=v.lon; p.y=v.lat; p.xy=[0 360 -90 90];
...
p.s3='(b) Pr avg, drizzle days'; 
p.s5='(c) Pr avg, wet days';
p.s7='(d) Pr avg, storm (AR+TS+MCS) days'; 
p.s2='(e) Pr avg, AR days';
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%===FigA2n===: LWCF averaged over various P-days %%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
v=ob.ar; p.expn='c192'; %all time mean lwcf from each weather type
p.lm=v.lm; p.x=v.lon; p.y=v.lat; p.xy=[0 360 -90 90];
lat0=-30; p.j1=max(find(v.lat<-lat0)); p.j2=min(find(v.lat>lat0));
p.aa=squeeze(v.aa); p.id=~isnan(p.aa); p.id(p.j1:p.j2,:)=0; id=p.id;
p.cm=[0 0.0005 0.001 0.002 0.01:0.02:0.08 0.1:0.05:1]; p.c='k'; p.rescale=false;
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%===FigA3n===: SWCF averaged over various P-days %%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
v=ob.ar; p.expn='c192'; %all time mean swcf from each weather type
p.lm=v.lm; p.x=v.lon; p.y=v.lat; p.xy=[0 360 -90 90];
lat0=-30; p.j1=max(find(v.lat<-lat0)); p.j2=min(find(v.lat>lat0));
p.aa=squeeze(v.aa); p.id=~isnan(p.aa); p.id(p.j1:p.j2,:)=0; id=p.id;
p.cm=[0 0.0005 0.001 0.002 0.01:0.02:0.08 0.1:0.05:1]; p.c='k'; p.rescale=false;
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%===Fig1===: annual frequency of P-days %%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
v=ob.ar; %all time mean prday from each weather type
p.lm=v.lm; p.x=v.lon; p.y=v.lat; p.xy=[0 360 -90 90];p.expn='c192';
...
p.cm=[0 0.0005 0.001 0.002 0.01:0.02:0.08 0.1:0.05:1]; p.c='k'; p.rescale=false;
v =ob; p.vn='obs_frqday';
%vx=v0; p.vn='mod_m_obs_frqday'; p.dtas=1; c1=-10; c2=10; c3=-10; c4=10;
vx=ve; p.vn='ens_m_obs_frqday'; p.dtas=1; c1=-10; c2=10; c3=-10; c4=10;p.un='\%';
%vx=v1; p.vn='ng1_m_obs_frqday'; p.dtas=1; c1=-10; c2=10; c3=-10; c4=10;
%vx=w1; p.vn='p2k_m_ctl_frqday'; v=v1; p.dtas=2.27; c1=-2;  c2=2;c3=-1; c4=1;p.un='\%/K';
p.z1=squeeze(vx.p2.frqday-v.p2.frqday)*100/p.dtas;
...
a=1; if a; p.z8=p.z3-p.z7; end; %a=1 take care MC period mismatch when comparing with OBS
p.z2=p.z1-p.z3;
%p=smoothp(p,1,1,'omitnan','shrink');
p.s1='(a) frequency of precipitation days'; 
...
p.cm=[0 0.0005 0.001 0.002 0.01:0.02:0.08 0.1:0.05:1]; p.c='k'; p.rescale=false;
v =ob; p.vn='obs_prday_idwei';
%vx=v0; p.vn='mod_m_obs_prday_idwei'; p.dtas=1;c1=-4;c2=4;c3=-2;c4=2;p.un='mm/day';
vx=ve; p.vn='ens_m_obs_prday_idwei'; p.dtas=1;c1=-4;c2=4;c3=-2;c4=2;p.un='mm/day';
%vx=v1; p.vn='ng1_m_obs_prday_idwei'; p.dtas=1;c1=-4;c2=4;c3=-2;c4=2;p.un='mm/day';
%vx=w1; p.vn='p2k_m_ctl_prday_idwei';v=v1; p.dtas=2.27;c1=-0.4;c2=0.4;c3=-0.2;c4=0.2;p.un='mm/day/K';
p.z1=squeeze(vx.ar.prday_av   -v.ar.prday_av)   /p.dtas;   
...
p.s8='(h) Pr avg, wet non-storm days'; 
a=[c1 c2]; p.c1=a; p.c2=a; p.fsize=8; p.optit=9; p.opt=5; p.nn=256;
...
%vx=v0; p.vn='mod_m_obs_fprc_idwei'; p.dtas=1;c1=-4;c2=4;c3=-2;c4=2;p.un='';
vx=ve; p.vn='ens_m_obs_fprc_idwei'; p.dtas=1;c1=-4;c2=4;c3=-2;c4=2;p.un='';
%vx=w1; p.vn='p2k_m_ctl_fprc_idwei';v=v1; p.dtas=2.27;c1=-2;c2=2;c3=-2;c4=2;p.un='\%/K';
...
p.z8=squeeze(vx.pb.fprc_idwei-v.pb.fprc_idwei)/p.dtas*100;
a=1; if a; p.z8=p.z3-p.z7; end; %a=1 take care MC period mismatch when comparing with OBS
p.z2=p.z2-p.z3;
%p=smoothp(p,1,1,'omitnan','shrink');
...
p.aa=squeeze(v.aa); p.id=~isnan(p.aa); p.id(p.j1:p.j2,:)=0; id=p.id;
p.cm=[0 0.0005 0.001 0.002 0.01:0.02:0.08 0.1:0.05:1]; p.c='k'; p.rescale=false;
v =ob; p.vn='obs_fprc_idavg'; vm=v;
%vx=v0; p.vn='mod_m_obs_fprc_idavg'; v=vx; p.dtas=1;c1=-5;c2=5;c3=-5;c4=5;p.un='';
vx=w1; p.vn='p2k_m_ctl_fprc_idavg'; vm=v1; p.dtas=2.27;c1=-2;c2=2;c3=-2;c4=2;p.un='\%/K';
nyr1=vm.ar.nyr; nyr2=vx.ar.nyr; aa=p.aa; dtas=p.dtas; mskopt=1; no=30;
...
a=[c1 c2];
p.c1=a; p.c2=a; p.fsize=8; p.optit=9; p.opt=5;p.nn=128;
p.c3=a; p.c4=a; p.c5=a; p.c6=a; p.c7=a; p.c8=a; 
plot_2d_8panel(p)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%vx=v0; p.vn='mod_m_obs_prw_idwei';p.dtas=1;c1=-4;c2=4;c3=-2;c4=2;p.un='kg/m2';
vx=ve; p.vn='ens_m_obs_prw_idwei';p.dtas=1;c1=-4;c2=4;c3=-2;c4=2;p.un='kg/m2';
%vx=v1; p.vn='ng1_m_obs_prw_idwei';p.dtas=1;c1=-4;c2=4;c3=-2;c4=2;p.un='kg/m2';
%vx=w1; p.vn='p2k_m_ctl_prw_idwei';v=v1; p.dtas=2.27;c1=-4;c2=4;c3=-2;c4=2;p.un='kg/m2/K';
...
p.z8=squeeze(vx.pb.prw_idwei-v.pb.prw_idwei)/p.dtas;
a=1; if a; p.z8=p.z3-p.z7; end; %a=1 take care MC period mismatch when comparing with OBS
p.z2=p.z2-p.z3;
%p=smoothp(p,1,1,'omitnan','shrink');
...
%vx=v0; p.vn='mod_m_obs_prw_idavg';  p.dtas=1;c1=-5;c2=5;c3=-5;c4=5;p.un='kg/m2';
vx=ve; p.vn='ens_m_obs_prw_idavg'; p.dtas=1;c1=-5;c2=5;c3=-5;c4=5;p.un='kg/m2';
%vx=v1; p.vn='ng1_m_obs_prw_idavg'; p.dtas=1;c1=-5;c2=5;c3=-5;c4=5;p.un='kg/m2';
...
p.cm=[0 0.0005 0.001 0.002 0.01:0.02:0.08 0.1:0.05:1]; p.c='k'; p.rescale=false;
v =ob; p.vn='obs_lwcf_idwei';
vx=v0; p.vn='mod_m_obs_lwcf_idwei'; p.dtas=1;c1=-35;c2=35;c3=-10;c4=10;p.un='W/m2';
%vx=ve; p.vn='ens_m_obs_lwcf_idwei'; p.dtas=1;c1=-20;c2=20;c3=-10;c4=10;p.un='W/m2';
%vx=v1; p.vn='ng1_m_obs_lwcf_idwei'; p.dtas=1;c1=-35;c2=35;c3=-10;c4=10;p.un='W/m2';
%vx=w1; p.vn='p2k_m_ctl_lwcf_idwei';v=v1; p.dtas=2.27;c1=-4;c2=4;c3=-2;c4=2;p.un='W/m2/K';
p.z1=squeeze(vx.ar.lwcf_av   -v.ar.lwcf_av)   /p.dtas;
...
p.cm=[0 0.0005 0.001 0.002 0.01:0.02:0.08 0.1:0.05:1]; p.c='k'; p.rescale=false;
v =ob; p.vn='obs_swcf_idwei';
%vx=v0; p.vn='mod_m_obs_swcf_idwei'; p.dtas=1;c1=-20;c2=20;c3=-10;c4=10;p.un='W/m2';
vx=ve; p.vn='ens_m_obs_swcf_idwei'; p.dtas=1;c1=-20;c2=20;c3=-10;c4=10;p.un='W/m2';
%vx=w1; p.vn='p2k_m_ctl_swcf_idwei'; v=v1; p.dtas=2.27;c1=-4;c2=4;c3=-2;c4=2;p.un='W/m2/K';
p.z1=squeeze(vx.ar.swcf_av   -v.ar.swcf_av)   /p.dtas;
...
p.cm=[0 0.0005 0.001 0.002 0.01:0.02:0.08 0.1:0.05:1]; p.c='k'; p.rescale=false;
v =ob; p.vn='obs_swcf_idavg'; vm=v;
%vx=v0; p.vn='mod_m_obs_swcf_idavg'; p.dtas=1;c1=-50;c2=50;c3=-50;c4=50;p.un='W/m2';
vx=ve; p.vn='ens_m_obs_swcf_idavg'; p.dtas=1;c1=-50;c2=50;c3=-50;c4=50;p.un='W/m2';
%vx=w1; p.vn='p2k_m_ctl_swcf_idavg'; vm=v1; p.dtas=2.27;c1=-4;c2=4;c3=-4;c4=4;p.un='W/m2/K';
nyr1=vm.ar.nyr; nyr2=vx.ar.nyr; aa=p.aa; dtas=p.dtas; mskopt=1; no=30;
v=vm.pd; a1=squeeze(v.swcf_idavg); s1=squeeze(v.swcf_idstd); n1=squeeze(v.id_sum);
v=vx.pd; a2=squeeze(v.swcf_idavg); s2=squeeze(v.swcf_idstd); n2=squeeze(v.id_sum);
[zx,ex,pd,a1av,a2av]=compute_diff(a1,s1,n1,a2,s2,n2,no,nyr1,nyr2,aa,mskopt);
...
do_per_change=false; %do_per_change=true; 
if do_per_change
  c1=-10; c2=10; p.un='\%/K'; p.vn='p2k_m_ctl_swcf_idavg_per'
  p.z1=p.Z1;  p.z2=p.Z2;  p.z3=p.Z3;  p.z4=p.Z4;
  p.z5=p.Z5;  p.z6=p.Z6;  p.z7=p.Z7;  p.z8=p.Z8;
  p.z1_avg=p.Z1_avg;  p.z2_avg=p.Z2_avg;  p.z3_avg=p.Z3_avg;  p.z4_avg=p.Z4_avg;
  p.z5_avg=p.Z5_avg;  p.z6_avg=p.Z6_avg;  p.z7_avg=p.Z7_avg;  p.z8_avg=p.Z8_avg;
...
%vx=v0; p.vn='mod_m_obs_ttcf_idwei'; p.dtas=1;c1=-10;c2=10;c3=-10;c4=10;p.un='W/m2';
vx=ve; p.vn='ens_m_obs_ttcf_idwei'; p.dtas=1;c1=-10;c2=10;c3=-10;c4=10;p.un='W/m2';
%vx=w1; p.vn='p2k_m_ctl_ttcf_idwei';v=v1; p.dtas=2.27;c1=-2;c2=2;c3=-1;c4=1;p.un='W/m2/K';
...
p.z8=squeeze(vx.pb.ttcf_idwei-v.pb.ttcf_idwei)/p.dtas;
a=1; if a; p.z8=p.z3-p.z7; end; %a=1 take care MC period mismatch when comparing with OBS
p.z2=p.z2-p.z3;
%p=smoothp(p,1,1,'omitnan','shrink');
...
%vx=v0; p.vn='mod_m_obs_ttcf_idavg'; p.dtas=1;c1=-20;c2=20;c3=-20;c4=20;p.un='W/m2';
vx=ve; p.vn='ens_m_obs_ttcf_idavg'; p.dtas=1;c1=-20;c2=20;c3=-20;c4=20;p.un='W/m2';
%vx=w1; p.vn='p2k_m_ctl_ttcf_idavg'; vm=v1; p.dtas=2.27;c1=-4;c2=4;c3=-4;c4=4;p.un='W/m2/K';
nyr1=vm.ar.nyr; nyr2=vx.ar.nyr; aa=p.aa; dtas=p.dtas; mskopt=1; no=30;
...
do_per_change=false; %do_per_change=true; 
if do_per_change
  c1=-10; c2=10; p.un='\%/K'; p.vn='p2k_m_ctl_ttcf_idavg_per'
  p.z1=p.Z1;  p.z2=p.Z2;  p.z3=p.Z3;  p.z4=p.Z4;
  p.z5=p.Z5;  p.z6=p.Z6;  p.z7=p.Z7;  p.z8=p.Z8;
  p.z1_avg=p.Z1_avg;  p.z2_avg=p.Z2_avg;  p.z3_avg=p.Z3_avg;  p.z4_avg=p.Z4_avg;
  p.z5_avg=p.Z5_avg;  p.z6_avg=p.Z6_avg;  p.z7_avg=p.Z7_avg;  p.z8_avg=p.Z8_avg;
...
p.cm=[0 0.0005 0.001 0.002 0.01:0.02:0.08 0.1:0.05:1]; p.c='k'; p.rescale=false;
v =ob; p.vn='obs_rlut_idwei';
%vx=v0; p.vn='mod_m_obs_rlut_idwei';p.dtas=1;c1=-20;c2=20;c3=-20;c4=20;p.un='W/m2';
vx=ve; p.vn='ens_m_obs_rlut_idwei';p.dtas=1;c1=-20;c2=20;c3=-20;c4=20;p.un='W/m2';
%vx=w1; p.vn='p2k_m_ctl_rlut_idwei';v=v1; p.dtas=2.27;c1=-4;c2=4;c3=-4;c4=4;p.un='W/m2/K';
p.z1=squeeze(vx.ar.rlut_av   -v.ar.rlut_av)   /p.dtas;   
...
%vx=v0; p.vn='mod_m_obs_rlut_idavg'; p.dtas=1;c1=-20;c2=20;c3=-20;c4=20;p.un='W/m2';
vx=ve; p.vn='ens_m_obs_rlut_idavg'; p.dtas=1;c1=-20;c2=20;c3=-20;c4=20;p.un='W/m2';
...
%vx=v0; p.vn='mod_m_obs_rlutcs_idwei';p.dtas=1;c1=-20;c2=20;c3=-20;c4=20;p.un='W/m2';
vx=ve; p.vn='ens_m_obs_rlutcs_idwei';p.dtas=1;c1=-20;c2=20;c3=-20;c4=20;p.un='W/m2';
%vx=w1; p.vn='p2k_m_ctl_rlutcs_idwei';v=v1; p.dtas=2.27;c1=-4;c2=4;c3=-2;c4=2;p.un='W/m2/K';
...
p.s2='(b) clear-sky OLR from drizzle days'; 
...
p.lm=v.lm; p.x=v.lon; p.y=v.lat; p.xy=[0 360 -90 90];p.expn='c192';
lat0=-30; p.j1=max(find(v.lat<-lat0)); p.j2=min(find(v.lat>lat0));
p.aa=squeeze(aa); p.id=~isnan(p.aa); p.id(p.j1:p.j2,:)=0; id=p.id;
p.cm=[0 0.0005 0.001 0.002 0.01:0.02:0.08 0.1:0.05:1]; p.c='k'; p.rescale=false;
v =ob; p.vn='obs_rlutcs_idavg'; vm=v;
%vx=v0; p.vn='mod_m_obs_rlutcs_idavg'; p.dtas=1;c1=-20;c2=20;c3=-20;c4=20;p.un='W/m2';
vx=ve; p.vn='ens_m_obs_rlutcs_idavg';  p.dtas=1;c1=-20;c2=20;c3=-20;c4=20;p.un='W/m2';
%vx=w1; p.vn='p2k_m_ctl_rlutcs_idavg'; vm=v1; p.dtas=2.27;c1=-5;c2=5;c3=-5;c4=5;p.un='W/m2/K';
nyr1=vm.ar.nyr; nyr2=vx.ar.nyr; aa=p.aa; dtas=p.dtas; mskopt=1; no=30;
...
p.cm=[0 0.0005 0.001 0.002 0.01:0.02:0.08 0.1:0.05:1]; p.c='k'; p.rescale=false;
v =ob; p.vn='obs_swabs_idwei';
%vx=v0; p.vn='mod_m_obs_swabs_idwei';p.dtas=1;c1=-30;c2=30;c3=-30;c4=30;p.un='W/m2';
vx=ve; p.vn='ens_m_obs_swabs_idwei';p.dtas=1;c1=-30;c2=30;c3=-30;c4=30;p.un='W/m2';
%vx=w1; p.vn='p2k_m_ctl_swabs_idwei';v=v1; p.dtas=2.27;c1=-4;c2=4;c3=-2;c4=2;p.un='W/m2/K';
p.z1=squeeze(vx.ar.swabs_av   -v.ar.swabs_av)   /p.dtas;   
...
p.s2='(b) SWABS from drizzle days'; 
...
%vx=v0; p.vn='mod_m_obs_swabs_idavg'; p.dtas=1;c1=-20;c2=20;c3=-20;c4=20;p.un='W/m2';
vx=ve; p.vn='ens_m_obs_swabs_idavg'; p.dtas=1;c1=-20;c2=20;c3=-20;c4=20;p.un='W/m2';
...
vx=w1; p.vn='p2k_m_ctl_rsut_idwei';v=v1; p.dtas=2.27;c1=-4;c2=4;c3=-2;c4=2;p.un='W/m2/K';
...
p.aa=squeeze(v.aa); p.id=~isnan(p.aa); p.id(p.j1:p.j2,:)=0; id=p.id;
p.cm=[0 0.0005 0.001 0.002 0.01:0.02:0.08 0.1:0.05:1]; p.c='k'; p.rescale=false;
v =ob; p.vn='obs_rsutcs_idavg'; vm=v;
%vx=v0; p.vn='mod_m_obs_rsutcs_idavg'; p.dtas=1;c1=-20;c2=20;c3=-20;c4=20;p.un='W/m2';
vx=ve; p.vn='ens_m_obs_rsutcs_idavg'; p.dtas=1;c1=-20;c2=20;c3=-20;c4=20;p.un='W/m2';
%vx=w1; p.vn='p2k_m_ctl_rsutcs_idavg'; vm=v1; p.dtas=2.27;c1=-5;c2=5;c3=-5;c4=5;p.un='W/m2/K';
nyr1=vm.ar.nyr; nyr2=vx.ar.nyr; aa=p.aa; dtas=p.dtas; mskopt=1; no=30;
...
p.cm=[0 0.0005 0.001 0.002 0.01:0.02:0.08 0.1:0.05:1]; p.c='k'; p.rescale=false;
v =ob; p.vn='obs_netrad_idwei';
vx=ve; p.vn='ens_m_obs_netrad_idwei';vm=vx;p.dtas=1;c1=-30;c2=30;c3=-15;c4=15;p.un='W/m2';
%vx=w1; p.vn='p2k_m_ctl_netrad_idwei';v=v1; p.dtas=2.27;c1=-4;c2=4;c3=-2;c4=2;p.un='W/m2/K';
p.z1=squeeze(vx.ar.netrad_av   -v.ar.netrad_av)   /p.dtas;   
...
%p=smoothp(p,1,1,'omitnan','shrink');
p.s1='(a) annual mean NETRAD';
p.s2='(b) NETRAD from drizzle days'; 
...
p.aa=squeeze(v.aa); p.id=~isnan(p.aa); p.id(p.j1:p.j2,:)=0; id=p.id;
p.cm=[0 0.0005 0.001 0.002 0.01:0.02:0.08 0.1:0.05:1]; p.c='k'; p.rescale=false;
v =ob; p.vn='obs_netrad_idavg'; vm=v;
vx=ve; p.vn='ens_m_obs_netrad_idavg'; p.dtas=1;c1=-20;c2=20;c3=-20;c4=20;p.un='W/m2';
%vx=w1; p.vn='p2k_m_ctl_netrad_idavg'; vm=v1; p.dtas=2.27;c1=-5;c2=5;c3=-5;c4=5;p.un='W/m2/K';
nyr1=vm.ar.nyr; nyr2=vx.ar.nyr; aa=p.aa; dtas=p.dtas; mskopt=1; no=30;
...
do_per_change=false; %do_per_change=true; 
if do_per_change
  c1=-10; c2=10; p.un='\%/K'; p.vn='p2k_m_ctl_netrad_idavg_per'
  p.z1=p.Z1;  p.z2=p.Z2;  p.z3=p.Z3;  p.z4=p.Z4;
  p.z5=p.Z5;  p.z6=p.Z6;  p.z7=p.Z7;  p.z8=p.Z8;
  p.z1_avg=p.Z1_avg;  p.z2_avg=p.Z2_avg;  p.z3_avg=p.Z3_avg;  p.z4_avg=p.Z4_avg;
  p.z5_avg=p.Z5_avg;  p.z6_avg=p.Z6_avg;  p.z7_avg=p.Z7_avg;  p.z8_avg=p.Z8_avg;
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%Fig17: annual mean clear-sky NETRAD contributed from %%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
v=ob.ar; %all time mean prday from each weather type
p.lm=v.lm; p.x=v.lon; p.y=v.lat; p.xy=[0 360 -90 90];p.expn='c192';
...
p.aa=squeeze(v.aa); p.id=~isnan(p.aa); p.id(p.j1:p.j2,:)=0; id=p.id;
p.cm=[0 0.0005 0.001 0.002 0.01:0.02:0.08 0.1:0.05:1]; p.c='k'; p.rescale=false;
v =ob; p.vn='obs_netradclr_idwei';
vx=ve; p.vn='ens_m_obs_netradclr_idwei';vm=vx;p.dtas=1;c1=-30;c2=30;c3=-15;c4=15;p.un='W/m2';
%vx=w1; p.vn='p2k_m_ctl_netradc_idwei';v=v1; p.dtas=2.27;c1=-4;c2=4;c3=-2;c4=2;p.un='W/m2/K';
...
p.s2='(b) clear-sky NETRAD from drizzle days'; 
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%Fig16: annual mean TOA clear-sky radiation contributed from
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
v=ob.ar; %all time mean prday from each weather type
p.lm=v.lm; p.x=v.lon; p.y=v.lat; p.xy=[0 360 -90 90];p.expn='c192';
...
p.aa=squeeze(v.aa); p.id=~isnan(p.aa); p.id(p.j1:p.j2,:)=0; id=p.id;
p.cm=[0 0.0005 0.001 0.002 0.01:0.02:0.08 0.1:0.05:1]; p.c='k'; p.rescale=false;
v =ob; p.vn='obs_netradclr_idavg'; vm=v;
vx=ve; p.vn='ens_m_obs_netradclr_idavg'; p.dtas=1;c1=-20;c2=20;c3=-20;c4=20;p.un='W/m2';
%vx=w1; p.vn='p2k_m_ctl_netradclr_idavg'; vm=v1; p.dtas=2.27;c1=-5;c2=5;c3=-5;c4=5;p.un='W/m2/K';
nyr1=vm.ar.nyr; nyr2=vx.ar.nyr; aa=p.aa; dtas=p.dtas; mskopt=1; no=30;
...
do_per_change=false; %do_per_change=true; 
if do_per_change
  c1=-10; c2=10; p.un='\%/K'; p.vn='p2k_m_ctl_netradclr_idavg_per'
  p.z1=p.Z1;  p.z2=p.Z2;  p.z3=p.Z3;  p.z4=p.Z4;
  p.z5=p.Z5;  p.z6=p.Z6;  p.z7=p.Z7;  p.z8=p.Z8;
  p.z1_avg=p.Z1_avg;  p.z2_avg=p.Z2_avg;  p.z3_avg=p.Z3_avg;  p.z4_avg=p.Z4_avg;
  p.z5_avg=p.Z5_avg;  p.z6_avg=p.Z6_avg;  p.z7_avg=p.Z7_avg;  p.z8_avg=p.Z8_avg;
