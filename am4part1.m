...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
tpath='/archive/Ming.Zhao/am4_spear/'; myr=1;
expn='AM4_spear_C96_O1_hist1'; yr1='1950';yr2='1998';syr=29;nyr=20;mod='c96';%1979-2014period
v1=tsana_hiresmip(o,tpath,expn,yr1,yr2,latlon,region,syr,nyr,myr,mod,opt);


%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
tpath='/archive/Ming.Zhao/CFMIP/gfdl/'; myr=1;
expn='amip'; yr1='1979';yr2='2014';syr=1;nyr=36;mod='c96';%1979-2014period
v1=tsana(o,tpath,expn,yr1,yr2,latlon,region,syr,nyr,myr,mod,opt);

expn='amip-p4K-a'; yr1='1979';yr2='2014';syr=1;nyr=36;mod='c96';%1979-2014period
v0=tsana(o,tpath,expn,yr1,yr2,latlon,region,syr,nyr,myr,mod,opt);


expn='AM4p0p3k_bvoc_2010C_PIpcairco2_v7_1980LU_dustfix';
yr1='0002';yr2='0016';syr=1;nyr=15;mod='c96';%1980-2014period
v0=tsana(o,tpath,expn,yr1,yr2,latlon,region,syr,nyr,myr,mod,opt);

expn='AM4p0p3k_bvoc_2010C_p2K_PIpcairco2_v7_1980LU_dustfix';
yr1='0002';yr2='0016';syr=1;nyr=15;mod='c96';%1980-2014period
v0=tsana(o,tpath,expn,yr1,yr2,latlon,region,syr,nyr,myr,mod,opt);


tpath='/archive/Ming.Zhao/awg/warsaw_201710/'; myr=1;
...
expn='c192L33_am4p0_amip_HIRESMIP_H1';yr1='1950';yr2='2014';syr=31;nyr=35;mod='c96';
v0=tsana(o,tpath,expn,yr1,yr2,latlon,region,syr,nyr,myr,mod,opt);
...
expn='CM4_c192L33_am4p0_1850';yr1='0001';yr2='0100';syr=1;nyr=100;mod='c96';
v0=tsana(o,tpath,expn,yr1,yr2,latlon,region,syr,nyr,myr,mod,opt);


tpath='/archive/Ming.Zhao/awg/warsaw/'; myr=1;
expn='CM4_piControl';yr1='0001';yr2='0030';syr=1;nyr=30;mod='c96';%1980-2014period
v0=tsana(o,tpath,expn,yr1,yr2,latlon,region,syr,nyr,myr,mod,opt);
...
expn='CM4_amip';                     fn=strcat(tpath,expn,pp,expn,dr);load(fn);am4.v1=v;
...
expn='c96L33_am4p0_m1';              fn=strcat(tpath,expn,pp,expn,dr);load(fn);am4.v1=v;
expn='c96L33_am4p0_m2';              fn=strcat(tpath,expn,pp,expn,dr);load(fn);am4.v2=v;
expn='c96L33_am4p0_m3';              fn=strcat(tpath,expn,pp,expn,dr);load(fn);am4.v3=v;
expn='c96L33_am4p0_m4';              fn=strcat(tpath,expn,pp,expn,dr);load(fn);am4.v4=v;
expn='c96L33_am4p0_m5';              fn=strcat(tpath,expn,pp,expn,dr);load(fn);am4.v5=v;
expn='AM4p0';                        fn=strcat(tpath,expn,pp,expn,dr);load(fn);am4.v6=v;
expn='c96L33_am4p0_initCond2';       fn=strcat(tpath,expn,pp,expn,dr);load(fn);am4.v7=v;
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%Figures for CM4 paper: TAS over land
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
k=3; varn='tas_land'; unit='(C)'; ss={'ANN','MAM','JJA','SON','DJF'};
v=am4.v0; s=v.s; s.latx=v.lat; s.lonx=v.lon; s.lmx=v.lm0;
v=o;      z1=squeeze(v.sfc.tas.sea(k,:,:)) -273.15; s.s1='CRU TS 3.22';
v=am4.v1; z2=squeeze(v.sfc.tref.sea(k,:,:))-273.15; s.s2='AM4.0.1 minus CRU';
v=am4.v0; z3=squeeze(v.sfc.tref.sea(k,:,:))-273.15; s.s3='AM4.0 minus CRU';
dz=z2-z3; z2=z2-z1; z3=z3-z1; 
id=(z1>10000); z2(id)=NaN; z3(id)=NaN;
id=(s.lm0<0.2); dz(id)=NaN; z1=dz; s.s1='AM4.0.1 minus AM4.0';
%s.c1=-35;   s.c2=35;   s.vbino=[s.c1:5:s.c2];   s.unit='(C)';
s.c1=-8;    s.c2=8;    s.vbino=[s.c1:0.5:s.c2]; s.unit='(C)';
s.cmin=-12; s.cmax=12; s.vbin =[s.cmin:2:s.cmax];
fpath='./fig_cm4/'; expn='am4'; f=1; icmap=1;
...
v=am4.v0; s=v.s; s.latx=v.lat; s.lonx=v.lon; s.lmx=v.lm0;
v=o;      z1=squeeze(v.toa.swnet.sea(k,:,:)); s.s1='CERES-EBAF-ED2.8';
v=am4.v1; z2=squeeze(v.toa.swnet.sea(k,:,:)); s.s2='AM4.0.1 minus CERES';
v=am4.v0; z3=squeeze(v.toa.swnet.sea(k,:,:)); s.s3='AM4.0 minus CERES';
dz=z2-z3; z2=z2-z1; z3=z3-z1; 
z1=dz; s.s1='AM4.0.1 minus AM4.0';
s.c1=-20;   s.c2=20;   s.vbino=[s.c1:1:s.c2]; s.unit='(W/m2)';
...
figure; nn=32; id=(lm>0); zo(id)=NaN; id=isnan(zo); zo(id)=-1;
vbino=[-1 0:10:300];
[C,h]=contourf(zo,vbino); shading flat; colorbar;
nn=32; cmap=jet(nn); cmap=fabien_colormap(nn);
cmap(1,:)=[1 1 1]; colormap(cmap);

cmap=cbrewer('seq', 'BuGn', nn); colormap(cmap);
cmap=cbrewer('div', 'BrBG', nn); colormap(cmap);

set(h,'LineWidth',0.0,'Color', [1 1 1]);
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%AM4 paper part I Fig 9 cloud liquid drop number
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
plot_liq_drp();
...
zo(zo>10000)=NaN; a=am4.v0.aa0;
id=~isnan(zo); a(id)=a(id)/mean(a(id)); a=a(id);
e=zo(id); zo_avg=mean(e.*a);
e=z1(id); z1_avg=mean(e.*a);
c1=0; c2=300;      vbino=[c1:10:c2]; unit=unit; icmap=0;
cmin=-80; cmax=80; vbin =[cmin:5:cmax]; xy=[0 360 -90 90];
...
title('AM4.0 (1980-2014)','FontSize',fsize);
  
subplot('Position',p2);
do_mapproj(lat,lon,zo,vbino,latx,lonx,lm,domap,xy); %clabel(C,h); 
caxis([c1 c2]); colormap(cmap); freezeColors; 
h=colorbar('Location','eastoutside','Position',pos1); cbfreeze(h,cmap);

subplot('Position',p3); dz=z1-zo;
do_mapproj(lat,lon,dz,vbin,latx,lonx,lm,domap,xy); %clabel(C,h); 
