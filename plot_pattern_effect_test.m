function plot_pattern_effect_test(p)
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
pms=[ 0, 0, 1000, 1000]*1.25; fsize=9; row=4; col=2; minus=char(8212);
...
set(cb0, 'Position', [0.93 0.765 wid len]); caxis([cmin1, cmax1]); a=1.1*cmax1;
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
cb0=colorbar('FontSize',fsize,'Location','eastoutside');
set(cb0, 'Position', [0.93 0.545 wid len]); caxis([cmin2, cmax2]); a=1.15*cmax2;
cb0.Label.String = p.unit; pos=get(cb0,'Position');
cb0.Label.Position = [pos(1)-0.3 pos(2)+a]; 
cb0.Label.Rotation = 0;
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
cb0=colorbar('FontSize',fsize,'Location','eastoutside');
set(cb0, 'Position', [0.93 0.325 wid len]); caxis([cmin3, cmax3]); a=1.2*cmax3;
cb0.Label.String = p.unit; pos=get(cb0,'Position');
cb0.Label.Position = [pos(1)-0.3 pos(2)+a]; 
cb0.Label.Rotation = 0;
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
cb0=colorbar('FontSize',fsize,'Location','eastoutside');
set(cb0, 'Position', [0.93 0.106 wid len]); caxis([cmin4 cmax4]); a=1.25*cmax4;
cb0.Label.String = p.unit; pos=get(cb0,'Position');
cb0.Label.Position = [pos(1)-0.3 pos(2)+a]; 
cb0.Label.Rotation = 0;
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
