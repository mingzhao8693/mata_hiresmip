...
v=ob; p.vn='obs_frqday_new';
%v=v0; p.vn='mod_frqday';
%v=v1; p.vn='ctl_frqday';
%v=w1; p.vn='p2k_frqday';
%v=v1; p.vn='ng1_frqday';
...
a=[0 100]; p.c1=a; p.un='\%'; p.fsize=8; p.optit=4; p.opt=4;p.nn=256;
a=[0 100]; p.c2=a; p.c3=a;
a=[0 60];  p.c4=a; p.c5=a; p.c6=a; p.c7=[0 60]; p.c8=p.c7;
plot_2d_8panel(p)
...
p.aa=squeeze(v.aa); p.id=~isnan(p.aa); p.id(p.j1:p.j2,:)=0; id=p.id;
p.cm=[0 0.0005 0.001 0.002 0.01:0.02:0.08 0.1:0.05:1]; p.c='k'; p.rescale=false;
v=ob; p.vn='obs_lwcf_idwei_new';
%v=v0; p.vn='mod_lwcf_idwei';
%v=w0; p.vn='p2k_lwcf_idwei';
%v=v1; p.vn='ng1_lwcf_idwei';
%v=v2; p.vn='ng2_lwcf_idwei';
...
p.z7=squeeze(v.al.lwcf_idwei); p.z2=p.z2-p.z3;
p.z8=p.z3-p.z7; %squeeze(v.al.lwcf_idwei./v.ar.lwcf_av)*100;    
%p=smoothp(p,1,1,'omitnan','shrink');
p.s1='(a) annual mean LW CRE';
p.s2='(b) LW CRE from drizzle days'; 
...
a=[0 80]; p.c1=a; p.un='W/m2'; p.fsize=8; p.optit=4; p.opt=4;p.nn=256;
a=[-0 20]; p.c2=a; p.c3=p.c1; 
a=[-0 20]; p.c4=a; p.c5=a; p.c6=a; p.c7=[0 40]; p.c8=p.c7; p.rescale=false;
plot_2d_8panel(p)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
p.aa=squeeze(v.aa); p.id=~isnan(p.aa); p.id(p.j1:p.j2,:)=0; id=p.id;
p.cm=[0 0.0005 0.001 0.002 0.01:0.02:0.08 0.1:0.05:1]; p.c='k'; p.rescale=false;
v=ob; p.vn='obs_lwcf_idavg_new'; p.rescale=true; p.fact=8.948/0.26999;  
%v=v0; p.vn='mod_lwcf_idavg';
%v=w0; p.vn='p2k_lwcf_idavg';
%v=v1; p.vn='ng1_lwcf_idavg';
%v=v2; p.vn='ng1_lwcf_idavg';
...
a=[-2 120]; %a=[-30 30]; 
p.c1=a; p.c2=a; p.un='W/m2'; p.fsize=8; p.optit=7; p.opt=4;p.nn=256;
p.c3=a; p.c4=a; p.c5=a; p.c6=a; p.c7=a; p.c8=a; 
plot_2d_8panel(p)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
p.aa=squeeze(v.aa); p.id=~isnan(p.aa); p.id(p.j1:p.j2,:)=0; id=p.id;
p.cm=[0 0.0005 0.001 0.002 0.01:0.02:0.08 0.1:0.05:1]; p.c='k'; p.rescale=false;
v=ob; p.vn='obs_swcf_idwei_new';
%v=v0; p.vn='mod_swcf_idwei';
%v=v1; p.vn='ng1_swcf_idwei';
%v=v2; p.vn='ng2_swcf_idwei';
...
p.z7=squeeze(v.al.swcf_idwei); p.z2=p.z2-p.z3;   
p.z8=p.z3-p.z7; %p.z8=squeeze(v.al.swcf_idwei./v.ar.swcf_av)*100;    
%p=smoothp(p,1,1,'omitnan','shrink');
...
p.s8='(h) SW CRE from set non-storm days;';
a=[-80  2]; p.c1=a; p.un='W/m2'; p.fsize=8; p.optit=4; p.opt=3;p.nn=256;
a=[-40  2];  p.c2=a; p.c3=p.c1;
a=[-40  2];  p.c4=a; p.c5=a; p.c6=a; p.c7=a; p.c8=a; p.rescale=false;
plot_2d_8panel(p)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
p.aa=squeeze(v.aa); p.id=~isnan(p.aa); p.id(p.j1:p.j2,:)=0; id=p.id;
p.cm=[0 0.0005 0.001 0.002 0.01:0.02:0.08 0.1:0.05:1]; p.c='k'; p.rescale=false;
v=ob; p.vn='obs_swcf_idavg_new'; p.rescale=true; p.fact=-15.156/0.26999;
%v=v0; p.vn='mod_swcf_idavg';
%v=v1; p.vn='ng1_swcf_idavg';
%v=v2; p.vn='ng2_swcf_idavg';
...
a=[-120 2];  p.c1=a; p.un='W/m2'; p.fsize=8; p.optit=7; p.opt=3;p.nn=256;
