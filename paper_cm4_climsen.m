...
expn='ESM4_amip_D1_1850climo'; yr1='0002';yr2='0021';syr=1;nyr=15;mod='c96'
v0=tsana_hiresmip(o,tpath,expn,yr1,yr2,latlon,region,syr,nyr,myr,mod,opt);
expn='ESM4_amip_D1_1850climo_4xCO2'; yr1='0002';yr2='0021';syr=1;nyr=15;mod='c96'
v0=tsana_hiresmip(o,tpath,expn,yr1,yr2,latlon,region,syr,nyr,myr,mod,opt);
expn='ESM4_amip_D1_1850climo_p2K'; yr1='0002';yr2='0021';syr=1;nyr=15;mod='c96'
v0=tsana_hiresmip(o,tpath,expn,yr1,yr2,latlon,region,syr,nyr,myr,mod,opt);
...
expn='c96L33_am4p0_2010climo_p2K_old'; yr1='0002';yr2='0031';syr=1;nyr=30;mod='c96'
v0=tsana_hiresmip(o,tpath,expn,yr1,yr2,latlon,region,syr,nyr,myr,mod,opt);

tpath='/archive/Ming.Zhao/awg/xanadu/'; myr=5; 
expn='c96L33_am4p0_1850climo_CM4_abrupt4xCO2_C_noSICA'; yr1='0002';yr2='0021';syr=1;nyr=20;mod='c96'
v0=tsana_hiresmip(o,tpath,expn,yr1,yr2,latlon,region,syr,nyr,myr,mod,opt);
expn='c96L33_am4p0_1850climo_CM4_abrupt4xCO2_C_noSSP'; yr1='0002';yr2='0021';syr=1;nyr=20;mod='c96'
v0=tsana_hiresmip(o,tpath,expn,yr1,yr2,latlon,region,syr,nyr,myr,mod,opt);

expn='c96L33_am4p0_1850climo_CM4_piControl_C_2K'; yr1='0002';yr2='0021';syr=1;nyr=20;mod='c96'
v0=tsana_hiresmip(o,tpath,expn,yr1,yr2,latlon,region,syr,nyr,myr,mod,opt);

expn='c96L33_am4p0_1850climo_CM4_abrupt4xCO2_C_and_4xCO2_veg2'; yr1='0002';yr2='0021';syr=1;nyr=20;mod='c96'
v0=tsana_hiresmip(o,tpath,expn,yr1,yr2,latlon,region,syr,nyr,myr,mod,opt);
expn='c96L33_am4p0_1850climo_CM4_abrupt4xCO2_C_veg2'; yr1='0002';yr2='0021';syr=1;nyr=20;mod='c96'
v0=tsana_hiresmip(o,tpath,expn,yr1,yr2,latlon,region,syr,nyr,myr,mod,opt);
...
%new test %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
fn=strcat('/work/miz/mat_hiresmip/obs_global_to_c48.mat'); load(fn);
pp='/'; region='global'; dr=strcat('_',region,'_opt1.tsana_new.mat');
tpath='/archive/Ming.Zhao/CM4/xanadu_om4_v1.0.5/'; myr=1; opt=1;
...
figure; plot(CM4.c0.sfc.tref.ts.org_ann); hold on; 
plot(CM4.w0.sfc.tref.ts.org_ann,'r'); plot(CM4.w1.sfc.tref.ts.org_ann,'m');
...
%expn='c96L33_am4p0_1850climo_CM4_abrupt4xCO2_C_and_4xCO2_veg2';fn=strcat(tpath,expn,pp,expn,dr);load(fn);a40.w2=v;
...
pms=[ 0, 0, 900, 700]*0.85; fsize=10; msize=11; lw=1; ls1='-'; ls2='--';
handle=figure('Position',pms,'visible','on');
ax1=gca; x0=[2.5:5:150]; x1=[2.5:5:300]; x2=[101 150];
...
line(x2,d.dT5,'Color','m','LineWidth',lw*2,'LineStyle',ls1); hold on;
line([100 100],[1 10],'Color','k','LineWidth',lw,'LineStyle',':');
line([150 150],[1 10],'Color','k','LineWidth',lw,'LineStyle',':');
legend('CM4.0','ESM4','SPEAR','SPEAR-S-VEG','AM4.0-PW','location','southwest'); 
%legend('CM4 (150yr)','SPEAR (200yr)','ESM4 (300yr)',0);grid on;
axis([0 300 1 6.2]); set(gca,'FontSize',fsize); box on;
...
line(x2,d.dN5,'Color','m','LineWidth',lw*2,'LineStyle',ls2); hold on;
%x=[2.5:5:150]; line(x,dN1s,'Color','r','LineWidth',lw/3); hold on;
%x=[2.5:5:300]; line(x,dN2s,'Color','k','LineWidth',lw/3); hold on;
%x=[2.5:5:200]; line(x,dN3s,'Color','b','LineWidth',lw/3); hold on;
legend('CM4.0','ESM4','SPEAR','SPEAR-S-VEG','AM4.0-PW','location','southeast'); 
yl='change in net TOA radiative flux (W/m2)'; ylabel(yl,'FontSize',fsize);
set(gca,'FontSize',fsize); xy=[0 300 0 5]; mylabel(xy,1,'(a)',12);
expn='cm4_climsen'; visfig='off'; figpath='./fig_gclimsen/';
printnew(visfig,figpath,expn,vname);
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%Fig1b: Gregory plot dN vs dTs for ECS
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
pms=[ 0, 0, 900, 700]*0.8; fsize=11; msize=12; lw=1;
handle=figure('Position',pms,'visible','on');
...
plot(d.dT5,d.dN5, 'm+','MarkerSize',msize,'LineWidth',lw*2);
...
ylabel('change in TOA net radiative flux (W/m2)','FontSize',fsize);
set(gca,'FontSize',fsize); xy=[0 10 0 8]; mylabel(xy,1,'(b)',12);
expn='cm4_climsen'; visfig='off'; figpath='./fig_gclimsen/';
printnew(visfig,figpath,expn,vname);
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%Fig2a-f: surface air temperature warming map%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
vname='dtref_map'; t1=101; t2=150; opt=0; 
...
subplot(row,col,5); a=(d.w1.av-d.c1.av)-(d.w2.av-d.c2.av);
pcolor(lon,lat,a); hold on; shading flat; colorbar; caxis([-4 4]);
contour(lon,lat,lm,1,'w');
s=sprintf('(e) CM4.0 minus ESM4 (%4.2fK)',d.T1-d.T2);
title(s,'FontSize',fsize);
subplot(row,col,6); a=(d.w3.av-d.c3.av)-(d.w4.av-d.c4.av);
pcolor(lon,lat,a); hold on; shading flat; colorbar; caxis([-4 4]);
contour(lon,lat,lm,1,'w');
s=sprintf('(f) SPEAR minus SPEAR-S-VEG (%4.2fK)',d.T3-d.T4);
title(s,'FontSize',fsize);
expn='cm4_climsen'; visfig='off'; figpath='./fig_gclimsen/';
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
vname='dtref_abs_zm'; lat=o.lat; xy=[-90 90 0 18];
t1=101; t2=150; opt=0;
d=gettref(CM4,ESM,SP1,SP4,a40,a41,t1,t2,opt);
...
s4=sprintf('SPEAR-S-VEG (%4.2f)',d.T4);
...
yl='change in surface air temperature (K)'; ylabel(yl,'FontSize',fsize);
axis(xy); grid on; set(gca,'FontSize',fsize); mylabel(xy,1,'(g)',12);
expn='cm4_climsen'; visfig='off'; figpath='./fig_gclimsen/';
printnew(visfig,figpath,expn,vname);
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
