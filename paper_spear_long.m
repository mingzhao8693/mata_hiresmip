...
p.do_trend=0; p.do_scalar=0; p.myr=10; p.opt=0; p.do_3d_atm=0; 
p.yr1='0001'; p.yr2='1000'; p.syr=1; p.nyr=1000; p.y1=0001; p.y2=0030; 
tpath='/archive/Ming.Zhao/SPEAR/'; 
p.expn='AM4_SPEAR_c96_o1_Control_1850_Q50';       v0=tsana_hiresmip_new(o,tpath,p);
p.expn='AM4_SPEAR_c96_o1_Control_1850_Q50_4xCO2'; w0=tsana_hiresmip_new(o,tpath,p);
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
dr=strcat('_global_opt0.c48_tsana_hiresmip_new_1-30_0001-1000.mat');
tpath='/archive/Ming.Zhao/SPEAR/';
expn='AM4_SPEAR_c96_o1_Control_1850_Q50';       fn=strcat(tpath,expn,'/',expn,dr);load(fn);c0=v;
expn='AM4_SPEAR_c96_o1_Control_1850_Q50_4xCO2'; fn=strcat(tpath,expn,'/',expn,dr);load(fn);w0=v;
...
y1=c0.sfc.tref.ts.org_ann; y2=w0.sfc.tref.ts.org_ann;
figure; plot(y2-y1,'r-'); 
figure;
plot(y1,'r-'); hold on; plot(y2,'r--');
plot(y3,'g-'); hold on; plot(y4,'g--');
plot(y5,'b-'); hold on; plot(y6,'b--');
...
expn='AM4_spear_C96_O1_1850cntl';                fn=strcat(tpath,expn,'/',expn,dr);load(fn);SP4.c0=v;
expn='AM4_spear_C96_O1_1850cntl_4xCO2';          fn=strcat(tpath,expn,'/',expn,dr);load(fn);SP4.w0=v;
tpath='/archive/Ming.Zhao/SPEAR/'; dr=strcat('_',region,'_opt0.c48_tsana_hiresmip_new_1-30_0001-1000.mat'); 
expn='AM4_SPEAR_c96_o1_Control_1850_Q50';        fn=strcat(tpath,expn,pp,expn,dr);load(fn);esm.c0=v;
expn='AM4_SPEAR_c96_o1_Control_1850_Q50_4xCO2';  fn=strcat(tpath,expn,pp,expn,dr);load(fn);esm.w0=v;
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
y1=esm.c0.sfc.tref.ts.org_ann; y2=esm.w0.sfc.tref.ts.org_ann;
y3=SP1.c0.sfc.tref.ts.org_ann; y4=SP1.w0.sfc.tref.ts.org_ann;
y5=SP4.c0.sfc.tref.ts.org_ann; y6=SP4.w0.sfc.tref.ts.org_ann;
figure; plot(y2-y1,'ro-'); hold on; plot(y4-y3,'g*-'); plot(y6-y5,'bs-');
figure;
plot(y1,'r-'); hold on; plot(y2,'r--');
plot(y3,'g-'); hold on; plot(y4,'g--');
plot(y5,'b-'); hold on; plot(y6,'b--');
...
d=get_tref_netrad_ts_new(CM4,esm,SP1,SP4,t1,t2,t3,1);
