function v=mjomse_ana(tpath,expn,yr1,yr2,latlon,nyr,region)
%varlist (2D)=======================
...
tpath ='/archive/Ming.Zhao/AM4LO/';
latlon=[38.75 181.25 -21.5 21.5]; region='iowpac'; 
expn='CM_c96L33_am4p0_o1_2010cntl_mse';yr1='0002'; yr2='0032'; nyr=31;
%expn='CM_c96L33_am4p0_o1_2010cntl_mse';yr1='0002'; yr2='0009'; nyr=8;
%expn='SPEAR_c96_o1_Control_2010_E50';yr1='0002'; yr2='0021'; nyr=20;
%expn='CM4_c96L32_am4g10r8_2010_OMp5_ePBL2_mjo_mse3';yr1='0001'; yr2='0020'; nyr=20;
%tpath ='/archive/Ming.Zhao/mdt/20161108/';
%latlon=[38.75 181.25 -21.5 21.5]; region='iowpac';

%tpath ='/archive/Ming.Zhao/sm4p0/warsaw_201710/';
%latlon=[38.75 181.25 -21.5 21.5]; region='iowpac'; 
%expn='c96L33_am4p1_2010climo_1';yr1='0001'; yr2='0015'; nyr=15;
...
io_latlon=[75 85   -5 5];  %definition of IO
lat1=-6.5; lat2=6.5;       %definition of equatorial region
lat1=-10;  lat2=10;        %definition of equatorial region

epath ='/atmos_daily/'; varn='dpint';
fext=strcat('atmos_daily.',yr1,'-',yr2,'.'); 
%fext=strcat('atmos_level.',yr1,'0101-',yr2,'1231.'); 
...
v.lgd_max=26; v.nz=33;

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%test MSE budget balance with 2D field
...
%varn='hdt_tot_int';fn=strcat(tpath,expn,epath,fext,varn,'.nc');
%varb=readvar(varn,fn,v,'2d','no'); hdt_tot_int=varb;
%varn='hdt_dgz_adj';fn=strcat(tpath,expn,epath,fext,varn,'.nc');
%varb=readvar(varn,fn,v,'2d','no'); hdt_dgz_adj=varb;
%varn='hdt_sum_int0';fn=strcat(tpath,expn,epath,fext,varn,'.nc');
%varb=readvar(varn,fn,v,'2d','no'); hdt_sum_int=varb;
%varn='dgz_phy_int0';fn=strcat(tpath,expn,epath,fext,varn,'.nc');
%varb=readvar(varn,fn,v,'2d','no'); dgz_phy_int=varb;
%figure; k1=150; k2=200; j=1; i=1;
%y0=hdt_tot_int(k1:k2,    j,i); plot([k1:k2],    y0,'-r*'); hold on;
%y1=hdt_dgz_adj(k1:k2,    j,i); plot([k1:k2],    y1,'-g.'); hold on;
%y2=hdt_sum_int(k1-1:k2-1,j,i); plot([k1-1:k2-1],y2,'-b.'); hold on;
%y3=y1+y2;                      plot([k1-1:k2-1],y3,'-ks'); hold on;
%y4=y0-y1;                      plot([k1:k2],    y4,'-ms'); hold on;
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
v.io.latlon=io_latlon; v.io.lat1=lat1; v.io.lat2=lat2; opt2d=2; opt3d=2;
...
v.pcp=lag_regress_2d(varb,v,latlon,lat1,lat2,v.io.pcp,0);
% $$$ v.tmp=lag_regress(varb,v,v.io.pcp,1); 
% $$$ figure; contourf(v.lon,v.lgd,v.pcp.lagslop.org_avg',20); shading flat; caxis([-2 2]);colorbar;
% $$$ figure; contourf(v.lon,v.lgd,v.tmp.lagslop.org_avg',20); shading flat; caxis([-2 2]);colorbar;
% $$$ figure; contourf(v.lon,v.lgd,v.pcp.lagcorr.iso_avg',20); shading flat; caxis([-0.8 0.8]);colorbar;
% $$$ figure; contourf(v.lon,v.lgd,v.tmp.lagcorr.iso_avg',20); shading flat; caxis([-0.8 0.8]);colorbar;
%figure; plot(v.lgd,v.io.pcp.comp_iso_avg,'k-*');

varn='hfint0';  fn=strcat(tpath,expn,epath,fext,varn,'.nc');
varb=readvar(varn,fn,v,'2d','no');
v.io.hfint0=get_iso_reg(varb,v,io_latlon,1,event);
v.hfint0=lag_regress_2d(varb,v,latlon,lat1,lat2,v.io.pcp,1);

varn='olr'; fn=strcat(tpath,expn,epath,fext,varn,'.nc'); 
varb=readvar(varn,fn,v,'2d','no');
v.io.olr=get_iso_reg(varb,v,io_latlon,1,event);
v.olr=lag_regress_2d(varb,v,latlon,lat1,lat2,v.io.olr,opt2d);

varn='u200'; fn=strcat(tpath,expn,epath,fext,varn,'.nc'); 
varb=readvar(varn,fn,v,'2d','no');
v.io.u200=get_iso_reg(varb,v,io_latlon,0);
v.u200=lag_regress_2d(varb,v,latlon,lat1,lat2,v.io.u200,opt2d);

varn='u850'; fn=strcat(tpath,expn,epath,fext,varn,'.nc');
varb=readvar(varn,fn,v,'2d','no');
v.io.u850=get_iso_reg(varb,v,io_latlon,0);
v.u850=lag_regress_2d(varb,v,latlon,lat1,lat2,v.io.u850,opt2d);

%fn=strcat(tpath,expn,'/',expn,'_',region,'_lagreg.mat');fn
%save(fn,'v','-v7.3'); %return %could be stop here for simple analysis

varn='ps'; fn=strcat(tpath,expn,epath,fext,varn,'.nc');
varb=readvar(varn,fn,v,'2d','no');
v.io.ps=get_iso_reg(varb,v,io_latlon,0);
v.ps=lag_regress_2d(varb,v,latlon,lat1,lat2,v.io.ps,opt2d);

varn='dpint0'; fn=strcat(tpath,expn,epath,fext,varn,'.nc');
varb=readvar(varn,fn,v,'2d','no');
v.io.dpint0=get_iso_reg(varb,v,io_latlon,1,event);
v.dpint0=lag_regress_2d(varb,v,latlon,lat1,lat2,v.io.pcp,opt2d);

varn='hdt_tot_int'; fn=strcat(tpath,expn,epath,fext,varn,'.nc');
varb=readvar(varn,fn,v,'2d','no');
v.io.hdt_tot_int=get_iso_reg(varb,v,io_latlon,1,event);
v.hdt_tot_int=lag_regress_2d(varb,v,latlon,lat1,lat2,v.io.pcp,opt2d);
  
varn='hdt_sum_int0'; fn=strcat(tpath,expn,epath,fext,varn,'.nc');
varb=readvar(varn,fn,v,'2d','no'); varb1=varb;
v.io.hdt_sum_int0=get_iso_reg(varb,v,io_latlon,1,event);

varn='hdt_dgz_adj';  fn=strcat(tpath,expn,epath,fext,varn,'.nc');
varb=readvar(varn,fn,v,'2d','no'); varb2=varb;
v.io.hdt_dgz_adj=get_iso_reg(varb,v,io_latlon,1,event);
v.hdt_dgz_adj=lag_regress_2d(varb,v,latlon,lat1,lat2,v.io.pcp,opt2d);

varb=varb1+varb2; 
v.io.hdt_net_int=get_iso_reg(varb,v,io_latlon,1,event); 
v.hdt_net_int=lag_regress_2d(varb,v,latlon,lat1,lat2,v.io.pcp,opt2d);

varn='hdt_dgz_int0'; fn=strcat(tpath,expn,epath,fext,varn,'.nc');
varb=readvar(varn,fn,v,'2d','no');
v.io.hdt_dgz_int0=get_iso_reg(varb,v,io_latlon,1,event);
v.hdt_dgz_int0=lag_regress_2d(varb,v,latlon,lat1,lat2,v.io.pcp,opt2d);

varn='hdt_adj_int0'; fn=strcat(tpath,expn,epath,fext,varn,'.nc');
varb=readvar(varn,fn,v,'2d','no');
v.io.hdt_adj_int0=get_iso_reg(varb,v,io_latlon,1,event);
v.hdt_adj_int0=lag_regress_2d(varb,v,latlon,lat1,lat2,v.io.pcp,opt2d);

%mse change due to physics induced water mass change 
varn='hdt_ddp_int0'; fn=strcat(tpath,expn,epath,fext,varn,'.nc');
varb=readvar(varn,fn,v,'2d','no');
v.io.hdp_phy_int0=get_iso_reg(varb,v,io_latlon,1,event);
v.hdp_phy_int0=lag_regress_2d(varb,v,latlon,lat1,lat2,v.io.pcp,opt2d);

%mse change due to dynamics induced mass change 
varn='hdp_dyn_int0'; fn=strcat(tpath,expn,epath,fext,varn,'.nc');
varb=readvar(varn,fn,v,'2d','no');
v.io.hdp_dyn_int0=get_iso_reg(varb,v,io_latlon,1,event);
v.hdp_dyn_int0=lag_regress_2d(varb,v,latlon,lat1,lat2,v.io.pcp,opt2d);

varn='ddp_phy_int0'; fn=strcat(tpath,expn,epath,fext,varn,'.nc');
varb=readvar(varn,fn,v,'2d','no');
v.io.ddp_phy_int0=get_iso_reg(varb,v,io_latlon,1,event);
v.ddp_phy_int0=lag_regress_2d(varb,v,latlon,lat1,lat2,v.io.pcp,opt2d);

varn='ddp_dyn_int0'; fn=strcat(tpath,expn,epath,fext,varn,'.nc');
varb=readvar(varn,fn,v,'2d','no');
v.io.ddp_dyn_int0=get_iso_reg(varb,v,io_latlon,1,event);
v.ddp_dyn_int0=lag_regress_2d(varb,v,latlon,lat1,lat2,v.io.pcp,opt2d);

varn='dgz_phy_int0'; fn=strcat(tpath,expn,epath,fext,varn,'.nc');
varb=readvar(varn,fn,v,'2d','no');
v.io.dgz_phy_int0=get_iso_reg(varb,v,io_latlon,1,event);
v.dgz_phy_int0=lag_regress_2d(varb,v,latlon,lat1,lat2,v.io.pcp,opt2d);

varn='dgz_dyn_int0'; fn=strcat(tpath,expn,epath,fext,varn,'.nc');
varb=readvar(varn,fn,v,'2d','no');
v.io.dgz_dyn_int0=get_iso_reg(varb,v,io_latlon,1,event);
v.dgz_dyn_int0=lag_regress_2d(varb,v,latlon,lat1,lat2,v.io.pcp,opt2d);

varn='tdt_dyn_int0'; fn=strcat(tpath,expn,epath,fext,varn,'.nc');
varb=readvar(varn,fn,v,'2d','no');
v.io.tdt_dyn_int0=get_iso_reg(varb,v,io_latlon,1,event);
v.tdt_dyn_int0=lag_regress_2d(varb,v,latlon,lat1,lat2,v.io.pcp,opt2d);

varn='qvdt_dyn_int0'; fn=strcat(tpath,expn,epath,fext,varn,'.nc');
varb=readvar(varn,fn,v,'2d','no');
v.io.qvdt_dyn_int0=get_iso_reg(varb,v,io_latlon,1,event);
v.qvdt_dyn_int0=lag_regress_2d(varb,v,latlon,lat1,lat2,v.io.pcp,opt2d);
...
varn='hdt_hadv_int0'; fn=strcat(tpath,expn,epath,fext,varn,'.nc');
varb=readvar(varn,fn,v,'2d','no');
v.io.hdt_hadv_int0=get_iso_reg(varb,v,io_latlon,1,event);
v.hdt_hadv_int0=lag_regress_2d(varb,v,latlon,lat1,lat2,v.io.pcp,opt2d);

varn='hdt_vadv_int0'; fn=strcat(tpath,expn,epath,fext,varn,'.nc');
varb=readvar(varn,fn,v,'2d','no');
v.io.hdt_vadv_int0=get_iso_reg(varb,v,io_latlon,1,event);
v.hdt_vadv_int0=lag_regress_2d(varb,v,latlon,lat1,lat2,v.io.pcp,opt2d);
 
varn='tdt_rad_int0'; fn=strcat(tpath,expn,epath,fext,varn,'.nc');
varb=readvar(varn,fn,v,'2d','no');
v.io.tdt_rad_int0=get_iso_reg(varb,v,io_latlon,1,event);
v.tdt_rad_int0=lag_regress_2d(varb,v,latlon,lat1,lat2,v.io.pcp,opt2d);
  
varn='tdt_dif_int0'; fn=strcat(tpath,expn,epath,fext,varn,'.nc');
varb=readvar(varn,fn,v,'2d','no');
v.io.tdt_dif_int0=get_iso_reg(varb,v,io_latlon,1,event);
v.tdt_dif_int0=lag_regress_2d(varb,v,latlon,lat1,lat2,v.io.pcp,opt2d);

varn='qvdt_dif_int0'; fn=strcat(tpath,expn,epath,fext,varn,'.nc');
varb=readvar(varn,fn,v,'2d','no');
v.io.qvdt_dif_int0=get_iso_reg(varb,v,io_latlon,1,event);
v.qvdt_dif_int0=lag_regress_2d(varb,v,latlon,lat1,lat2,v.io.pcp,opt2d);
...
v.io.u700=get_iso_reg(varb,v,io_latlon,1,event);
v.u700=lag_regress_2d(varb,v,latlon,lat1,lat2,v.io.pcp,opt2d);

varn='vcomp'; fn=strcat(tpath,expn,epath,fext,varn,'.nc'); k1=19; k2=22;
f=netcdf(fn,'nowrite'); varb=f{varn}(v.ts:v.te,k1:k2,v.ys:v.ye,v.xs:v.xe);
varb=squeeze(mean(varb,2)); varb=reshape(varb,v.nday,v.nyr,v.nlat,v.nlon);
v.io.v700=get_iso_reg(varb,v,io_latlon,1,event);
v.v700=lag_regress_2d(varb,v,latlon,lat1,lat2,v.io.pcp,opt2d);

varn='sphum'; fn=strcat(tpath,expn,epath,fext,varn,'.nc'); k1=19; k2=22;
f=netcdf(fn,'nowrite'); varb=f{varn}(v.ts:v.te,k1:k2,v.ys:v.ye,v.xs:v.xe);
varb=squeeze(mean(varb,2)); varb=reshape(varb,v.nday,v.nyr,v.nlat,v.nlon);
v.io.qv700=get_iso_reg(varb,v,io_latlon,1,event);
v.qv700=lag_regress_2d(varb,v,latlon,lat1,lat2,v.io.pcp,opt2d);
...
v.io.hfintn0=get_iso_reg(varb,v,io_latlon,1,event); v.pf=f{'pfull'}(:);

%3D standard fields
varn='temp'; fn=strcat(tpath,expn,epath,fext,varn,'.nc'); 
varb=readvar(varn,fn,v,'3d','no');ta=varb;
v.io.ta=get_iso_reg_3d(varb,v,1,event,'no'); 
varn='sphum'; fn=strcat(tpath,expn,epath,fext,varn,'.nc'); 
varb=readvar(varn,fn,v,'3d','no');qv=varb;
v.io.qv=get_iso_reg_3d(varb,v,1,event,'no'); 
varn='ice_wat'; fn=strcat(tpath,expn,epath,fext,varn,'.nc'); 
varb=readvar(varn,fn,v,'3d','no');qi=varb;
v.io.qi=get_iso_reg_3d(varb,v,1,event,'no'); 
varn='z_full'; fn=strcat(tpath,expn,epath,fext,varn,'.nc'); 
varb=readvar(varn,fn,v,'3d','no')*G;gz=varb;
v.io.gz=get_iso_reg_3d(varb,v,1,event,'no'); 
varb=CPD*ta+LV0*qv+gz-HLF*qi; 
v.io.mse=get_iso_reg_3d(varb,v,1,event,'no'); %v.mse=lag_regress_3d(varb,v,v.io.pcp,1);

varn='rh'; fn=strcat(tpath,expn,epath,fext,varn,'.nc');
varb=readvar(varn,fn,v,'3d','no');
v.io.rh=get_iso_reg_3d(varb,v,1,event,'no'); 
varn='cld_amt'; fn=strcat(tpath,expn,epath,fext,varn,'.nc');
varb=readvar(varn,fn,v,'3d','no');
v.io.qa=get_iso_reg_3d(varb,v,1,event,'no'); 
varn='liq_wat'; fn=strcat(tpath,expn,epath,fext,varn,'.nc');
varb=readvar(varn,fn,v,'3d','no');
v.io.ql=get_iso_reg_3d(varb,v,1,event,'no'); 
varn='ucomp'; fn=strcat(tpath,expn,epath,fext,varn,'.nc');
varb=readvar(varn,fn,v,'3d','no');
v.io.ua=get_iso_reg_3d(varb,v,1,event,'no'); 
v.ua=lag_regress_3d(varb,v,v.io.pcp,opt3d);
varn='vcomp'; fn=strcat(tpath,expn,epath,fext,varn,'.nc');
varb=readvar(varn,fn,v,'3d','no');
v.io.va=get_iso_reg_3d(varb,v,1,event,'no'); 
v.va=lag_regress_3d(varb,v,v.io.pcp,opt3d);
varn='omega'; fn=strcat(tpath,expn,epath,fext,varn,'.nc');
varb=readvar(varn,fn,v,'3d','no');
v.io.omg=get_iso_reg_3d(varb,v,1,event,'no'); 
v.omg=lag_regress_3d(varb,v,v.io.pcp,opt3d);
varn='mc_full'; fn=strcat(tpath,expn,epath,fext,varn,'.nc');
varb=readvar(varn,fn,v,'3d','no');
v.io.mc=get_iso_reg_3d(varb,v,1,event,'no'); 

%3D MSE
varn='dpint'; fn=strcat(tpath,expn,epath,fext,varn,'.nc');
varb=readvar(varn,fn,v,'3d','no');  dpint=varb; 
v.io.dpint=get_iso_reg_3d(varb,v,1,event,'no');
v.dpint=lag_regress_3d(varb,v,v.io.pcp,opt3d);
varb=readvar(varn,fn,v,'3d','yes'); dpog=varb;
v.io.dpog=get_iso_reg_3d(varb,v,1,event,'no');
v.dpog=lag_regress_3d(varb,v,v.io.pcp,opt3d);

%varn='hfintn'; varb=readvar(varn,tpath,expn,epath,fext,v,'3d','yes');
%varb=varb./dpint;
%v.io.hfintn=get_iso_reg_3d(varb,v,1,event,'no'); 
%v.hfintn=lag_regress_3d(varb,v,v.io.pcp,opt3d);

varn='dgz_dyn_int'; fn=strcat(tpath,expn,epath,fext,varn,'.nc');
varb=readvar(varn,fn,v,'3d','yes'); varb=varb./dpog;
v.io.hdt_dgz_dyn=get_iso_reg_3d(varb,v,1,event,'no');
v.hdt_dgz_dyn=lag_regress_3d(varb,v,v.io.pcp,opt3d);

varn='hdt_dgz_int'; fn=strcat(tpath,expn,epath,fext,varn,'.nc');
varb=readvar(varn,fn,v,'3d','yes'); varb=varb./dpog;
v.io.hdt_dgz_phy=get_iso_reg_3d(varb,v,1,event,'no');
v.hdt_dgz_phy=lag_regress_3d(varb,v,v.io.pcp,opt3d);

varn='hdt_ddp_int'; fn=strcat(tpath,expn,epath,fext,varn,'.nc');
varb=readvar(varn,fn,v,'3d','yes'); varb=varb./dpog;
v.io.hdt_ddp_phy=get_iso_reg_3d(varb,v,1,event,'no');
v.hdt_ddp_phy=lag_regress_3d(varb,v,v.io.pcp,opt3d);

varn='hdt_adj_int'; fn=strcat(tpath,expn,epath,fext,varn,'.nc');
varb=readvar(varn,fn,v,'3d','yes'); varb=varb./dpog;
v.io.hdt_adj_phy=get_iso_reg_3d(varb,v,1,event,'no');
v.hdt_adj_phy=lag_regress_3d(varb,v,v.io.pcp,opt3d);

varn='ddp_phy_int'; fn=strcat(tpath,expn,epath,fext,varn,'.nc');
varb=readvar(varn,fn,v,'3d','yes'); varb=varb./dpog;
v.io.ddp_phy=get_iso_reg_3d(varb,v,1,event,'no');
v.ddp_phy=lag_regress_3d(varb,v,v.io.pcp,opt3d);

varn='hfint'; fn=strcat(tpath,expn,epath,fext,varn,'.nc');
varb=readvar(varn,fn,v,'3d','yes'); varb=varb./dpog;
v.io.hf=get_iso_reg_3d(varb,v,1,event,'no');
v.hf=lag_regress_3d(varb,v,v.io.pcp,opt3d);

varn='tdt_rad_int'; fn=strcat(tpath,expn,epath,fext,varn,'.nc');
varb=readvar(varn,fn,v,'3d','yes'); varb=varb./dpog;
v.io.tdt_rad=get_iso_reg_3d(varb,v,1,event,'no');
v.tdt_rad=lag_regress_3d(varb,v,v.io.pcp,opt3d);

varn='hdt_hadv_int'; fn=strcat(tpath,expn,epath,fext,varn,'.nc');
varb=readvar(varn,fn,v,'3d','yes'); varb=varb./dpog;
v.io.hdt_hadv=get_iso_reg_3d(varb,v,1,event,'no');
v.hdt_hadv=lag_regress_3d(varb,v,v.io.pcp,opt3d);

varn='hdt_vadv_int'; fn=strcat(tpath,expn,epath,fext,varn,'.nc');
varb=readvar(varn,fn,v,'3d','yes'); varb=varb./dpog;
v.io.hdt_vadv=get_iso_reg_3d(varb,v,1,event,'no');
v.hdt_vadv=lag_regress_3d(varb,v,v.io.pcp,opt3d);

varn='hdp_dyn_int'; fn=strcat(tpath,expn,epath,fext,varn,'.nc');
varb=readvar(varn,fn,v,'3d','yes'); varb=varb./dpog;
v.io.hdp_dyn=get_iso_reg_3d(varb,v,1,event,'no');
v.hdp_dyn=lag_regress_3d(varb,v,v.io.pcp,opt3d);

varn='ddp_dyn_int'; fn=strcat(tpath,expn,epath,fext,varn,'.nc');
varb=readvar(varn,fn,v,'3d','yes'); varb=varb./dpog;
v.io.ddp_dyn=get_iso_reg_3d(varb,v,1,event,'no');
v.ddp_dyn=lag_regress_3d(varb,v,v.io.pcp,opt3d);

varn='tdt_dif_int'; fn=strcat(tpath,expn,epath,fext,varn,'.nc');
varb=readvar(varn,fn,v,'3d','yes'); varb=varb./dpog;
v.io.tdt_dif=get_iso_reg_3d(varb,v,1,event,'no');
v.tdt_dif=lag_regress_3d(varb,v,v.io.pcp,opt3d);

varn='qvdt_dif_int'; fn=strcat(tpath,expn,epath,fext,varn,'.nc');
varb=readvar(varn,fn,v,'3d','yes'); varb=varb./dpog;
v.io.qvdt_dif=get_iso_reg_3d(varb,v,1,event,'no');
v.qvdt_dif=lag_regress_3d(varb,v,v.io.pcp,opt3d);

varn='hdt_conv_int'; fn=strcat(tpath,expn,epath,fext,varn,'.nc');
varb=readvar(varn,fn,v,'3d','yes'); varb=varb./dpog;
v.io.hdt_conv=get_iso_reg_3d(varb,v,1,event,'no'); 
v.hdt_conv=lag_regress_3d(varb,v,v.io.pcp,opt3d);

varn='tdt_conv_int'; fn=strcat(tpath,expn,epath,fext,varn,'.nc');
varb=readvar(varn,fn,v,'3d','yes'); varb=varb./dpog;
v.io.tdt_conv=get_iso_reg_3d(varb,v,1,event,'no'); 
v.tdt_conv=lag_regress_3d(varb,v,v.io.pcp,opt3d);

varn='qdt_conv_int'; fn=strcat(tpath,expn,epath,fext,varn,'.nc');
varb=readvar(varn,fn,v,'3d','yes'); varb=varb./dpog;
v.io.qdt_conv=get_iso_reg_3d(varb,v,1,event,'no'); 
v.qdt_conv=lag_regress_3d(varb,v,v.io.pcp,opt3d);

%varn='dgz_conv_int'; varb=readvar(varn,tpath,expn,epath,fext,v,'3d','yes');
%varb=varb./dpog;
%v.io.dgz_conv_int=get_iso_reg_3d(varb,v,1,event,'no'); 
%v.dgz_conv_int=lag_regress_3d(varb,v,v.io.pcp,opt3d);

fn=strcat(tpath,expn,'/',expn,'_',region,'_mjomse.mat');fn
