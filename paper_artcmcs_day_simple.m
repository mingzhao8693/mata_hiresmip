...
opt='MC'; v=readartcmcs_day_obs(tpath,expn,yr1,yr2,pct,opt,diag);
opt='AR'; v=readartcmcs_day_obs(tpath,expn,yr1,yr2,pct,opt,diag);
opt='TC'; v=readartcmcs_day_obs(tpath,expn,yr1,yr2,pct,opt,diag);
opt='AL'; v=readartcmcs_day_obs(tpath,expn,yr1,yr2,pct,opt,diag);
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
tpath='/archive/Ming.Zhao/awg/warsaw_201803/';pct=[99 99.9];%pct=[25 50 75 90 95 99 99.9];
expn='c192L33_am4p0_amip_HIRESMIP_H9_newpp'; ardir='AR_climlmt';yr1=2020;yr2=2020;diag=0;
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
tpath='/archive/Ming.Zhao/awg/warsaw_201803/';pct=[99 99.9];%pct=[25 50 75 90 95 99 99.9];
expn='c192L33_am4p0_amip_HIRESMIP_H8_newpp'; ardir='AR_climlmt';yr1=2015;yr2=2020;diag=0;
opt='mod'; addtc_to_AR(tpath,expn,yr1,yr2,opt,-30)
opt='AL';  v.al=readartcmcs_day(tpath,expn,yr1,yr2,pct,opt,diag);
opt='MC';  v.mc=readartcmcs_day(tpath,expn,yr1,yr2,pct,opt,diag);
opt='AR';  v.ar=readartcmcs_day(tpath,expn,yr1,yr2,pct,opt,diag);
