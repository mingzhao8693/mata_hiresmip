function [v]=readartcmcs_day_cre_new(tpath,expn,yr1,yr2,pct,opt,diag,adj_opt)
...
for m=1:length(d_end)
  ...
  %precip%%%%%%%%%%%%%%%%%%%%%%%
  varn='precipitation'; ff='day'; exd='/atmos_data/daily_mswep/'; 
  ...
  v.frqday(m,:,:)=squeeze(mean(id,1)); v.frqday_all=id;
...
%  a=readallyear_mon(v,exd,varn,exf1,exf2,exf3,m,ff)*86400; 
  ...
  if (diag==0); break; end
  %%%%%%%%%%%%%%%%%%%%%%%%%%%%%
  varn='toa_lw_all'; ff='day'; exd='/atmos_data/daily_ceres4.1/'; exf1='ceres.'; exf2='0101-'; exf3='1231.';
  a=readallyear_mon(v,exd,varn,exf1,exf2,exf3,m,ff); 
  a=do_ceres_adj(varn,a,adj_opt); rlut=a;
  s=get_cond_var_new(a,id,pct,v.aa,0,idxx);
  ...
  %%%%%%%%%%%%%%%%%%%%%%%%%%%%%
  varn='toa_lw_clr'; ff='day'; exd='/atmos_data/daily_ceres4.1/'; exf1='ceres.'; exf2='0101-'; exf3='1231.';
  a=readallyear_mon(v,exd,varn,exf1,exf2,exf3,m,ff); 
  a=fillmissing(a,'nearest',1); a=fillmissing(a,'nearest',3); 
  a=do_ceres_adj(varn,a,adj_opt); lwcf=a-rlut; clear rlut;
  s=get_cond_var_new(a,id,pct,v.aa,0,idxx);
  ...
  %%%%%%%%%%%%%%%%%%%%%%%%%%%%%
  varn='toa_sw_all'; ff='day'; exd='/atmos_data/daily_ceres4.1/'; exf1='ceres.'; exf2='0101-'; exf3='1231.';
  a=readallyear_mon(v,exd,varn,exf1,exf2,exf3,m,ff); 
  a=do_ceres_adj(varn,a,adj_opt); rsut=a;
  s=get_cond_var_new(a,id,pct,v.aa,0,idxx);
  ...
  %%%%%%%%%%%%%%%%%%%%%%%%%%%%%
  varn='toa_solar_all'; ff='day'; exd='/atmos_data/daily_ceres4.1/'; exf1='ceres.'; exf2='0101-'; exf3='1231.';
  a=readallyear_mon(v,exd,varn,exf1,exf2,exf3,m,ff); 
  a=do_ceres_adj(varn,a,adj_opt); a=a-rsut;
  s=get_cond_var_new(a,id,pct,v.aa,0,idxx);
  ...
  %%%%%%%%%%%%%%%%%%%%%%%%%%%%%
  varn='toa_sw_clr'; ff='day'; exd='/atmos_data/daily_ceres4.1/'; exf1='ceres.'; exf2='0101-'; exf3='1231.';
  a=readallyear_mon(v,exd,varn,exf1,exf2,exf3,m,ff); 
  a=fillmissing(a,'nearest',1); a=fillmissing(a,'nearest',3); 
  a=do_ceres_adj(varn,a,adj_opt); rsutcs=a;
  s=get_cond_var_new(a,id,pct,v.aa,0,idxx);
  ...
  %%%%%%%%%%%%%%%%%%%%%%%%%%%%%
  a=rsutcs-rsut; clear rsutcs rsut; swcf=a;
  s=get_cond_var_new(a,id,pct,v.aa,0,idxx);
  ...
  %%%%%%%%%%%%%%%%%%%%%%%%%%%%%
  varn='toa_net_all'; ff='day'; exd='/atmos_data/daily_ceres4.1/'; exf1='ceres.'; exf2='0101-'; exf3='1231.';
  a=readallyear_mon(v,exd,varn,exf1,exf2,exf3,m,ff); 
  a=do_ceres_adj(varn,a,adj_opt); netrad=a; 
  s=get_cond_var_new(a,id,pct,v.aa,0,idxx);
  ...
  %%%%%%%%%%%%%%%%%%%%%%%%%%%%%
  varn='toa_net_clr'; ff='day'; exd='/atmos_data/daily_ceres4.1/'; exf1='ceres.'; exf2='0101-'; exf3='1231.';
  a=readallyear_mon(v,exd,varn,exf1,exf2,exf3,m,ff); 
  a=fillmissing(a,'nearest',3); a=fillmissing(a,'nearest',1); 
  a=do_ceres_adj(varn,a,adj_opt); netradclr=a;
  s=get_cond_var_new(a,id,pct,v.aa,0,idxx);
  ...
  if (diag==1); break; end
  %%%%%%%%%%%%%%%%%%%%%%%%%%%%%
  varn='prw'; ff='day'; exd='/atmos_data/daily_era5/'; exf1='ERA5.'; exf2='0101-'; exf3='1231.';
  a=readallyear_mon(v,exd,varn,exf1,exf2,exf3,m,ff);
  s=get_cond_var_new(a,id,pct,v.aa,0,idxx);
  ...
  %%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% $$$   varn='tas'; ff='day'; exd='/atmos_data/daily_era5/'; exf1='ERA5.'; exf2='0101-'; exf3='1231.';
% $$$   a=readallyear_mon(v,exd,varn,exf1,exf2,exf3,m,ff);
% $$$   s=get_cond_var_new(a,id,pct,v.aa,0,idxx);
...
% $$$   v.tas_idwei_ts_day_lat(m,:,:) =s.idwei_ts_day_lat;
  ...
  if (diag==2); break; end
  %%%%%%%%%%%%%%%%%%%%%%%%%%%%%
  varn='ivty'; ff='day'; exd='/atmos_data/daily_era5/';  exf1='ERA5.'; exf2='0101-'; exf3='1231.';
  ...
  %%%%%%%%%%%%%%%%%%%%%%%%%%%%%
  varn='ivtx'; ff='day'; exd='/atmos_data/daily_era5/';  exf1='ERA5.'; exf2='0101-'; exf3='1231.';
...
fnmat=strcat(epath,expn,fext,'_',opt,'_diag',num2str(diag),'_adj',num2str(adj_opt),'_readartcmcs_day_cre_newer.mat')
