function [d]=getnettoa(CM4,ESM,SP1,SP4,a40,a41,t1,t2,opt)
%t1=101; t2=150; opt=0;
...
a=a40.W0.toa.netrad.all (:    ,:,:,:); W5=gmean(a,aa,opt);
a=a40.W1.toa.netrad.all (:    ,:,:,:); W1=gmean(a,aa,opt);

a=a40.S0.toa.netrad.all (:    ,:,:,:); S5=gmean(a,aa,opt);
a=a40.I0.toa.netrad.all (:    ,:,:,:); I5=gmean(a,aa,opt);
a=a40.V0.toa.netrad.all (:    ,:,:,:); V5=gmean(a,aa,opt);
a=a40.P0.toa.netrad.all (:    ,:,:,:); P5=gmean(a,aa,opt);

a=a40.S1.toa.netrad.all (:    ,:,:,:); A5=gmean(a,aa,opt);
a=a40.I1.toa.netrad.all (:    ,:,:,:); B5=gmean(a,aa,opt);
a=a40.V1.toa.netrad.all (:    ,:,:,:); C5=gmean(a,aa,opt);
a=a40.P1.toa.netrad.all (:    ,:,:,:); D5=gmean(a,aa,opt);
...
d.N7=(W5.gm-c5.gm); d.Nf=(W1.gm-c5.gm);
