...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
pms=[ 0, 0, 2000, 800]*0.5; fsize=14; lw=2; x=[1:10];
...
hb(4).FaceColor = 'b';
hb(5).FaceColor = 'k';
visfig='off'; figpath='./fig_cre/'; expn='c192'; vname='obs_all_idwei_new';
...
hb(4).FaceColor = 'b';
hb(5).FaceColor = 'k';
visfig='off'; figpath='./fig_cre/'; expn='c192'; vname='obs_all_idwei_norm';
printnew(visfig,figpath,expn,vname);
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
pms=[ 0, 0, 2000, 800]*0.5; fsize=12; lw=2; x=[1:10]
handle = figure('Position', pms,'visible','on');
...
hb(3).FaceColor = 'b';
hb(4).FaceColor = 'k';
visfig='off'; figpath='./fig_cre/'; expn='c192'; vname='obs_all_idavg_new';
printnew(visfig,figpath,expn,vname);
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
pms=[ 0, 0, 2000, 800]*0.5; fsize=12; lw=2; x=[1:10]
...
hb(3).FaceColor = 'b';
hb(4).FaceColor = 'k';
visfig='off'; figpath='./fig_cre/'; expn='c192'; vname='obs_all_idavg_norm';
printnew(visfig,figpath,expn,vname);
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
