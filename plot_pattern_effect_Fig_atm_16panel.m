function plot_pattern_effect_Fig_atm_16panel(p)
...
title(s,'FontSize',fsize,'Interpreter','latex');
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
subplot(row,col,i); a=a2-a1; b=b2-b1; sx=let(i)+'(c) minus (b)'; i=i+1;
pcolor(lon,lat,a); hold on; shading flat;  caxis([p.cmin1 p.cmax1]);
if p.do_add;
  contour(lon,lat,add.u, add.ubin,'color',p.z1_co,'Linestyle','-', 'showtext',p.show);
  contour(lon,lat,add.u,-add.ubin,'color',p.z1_co,'Linestyle','--','showtext',p.show);
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
subplot(row,col,i); a=p.u3; b=p.du3; sx=let(i)+p.s3; i=i+1;
...
%cb0.Label.Rotation = 0;
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
subplot(row,col,i); a=p.u4; b=p.du4; sx=let(i)+p.s4; i=i+1; a4=a; b4=b;
...
%  contour(lon,lat,add.u+p.u5+add.u, add.ubin,'color','y','Linestyle','-', 'showtext',p.show);
...
title(s,'FontSize',fsize,'Interpreter','latex');
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
subplot(row,col,i); a=a5-a4; b=b5-b4; sx=let(i)+'(g) minus (f)'; i=i+1;
pcolor(lon,lat,a); hold on; shading flat;  caxis([p.cmin4 p.cmax4]);
contour(lon,lat,lm,1,co); axis(p.xy)
if p.do_add;
  contour(lon,lat,add.u, add.ubin,'color',p.z1_co,'Linestyle','-', 'showtext',p.show);
...
title(s,'FontSize',fsize,'Interpreter','latex');
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
subplot(row,col,i); a=a8-a7; b=b8-b7; sx=let(i)+p.s8; sx=let(i)+'(k) minus (j)'; i=i+1; 
pcolor(lon,lat,a); hold on; shading flat;  caxis([p.cmin7 p.cmax7]);
contour(lon,lat,lm,1,co); axis(p.xy);
if p.do_add;
  contour(lon,lat,add.u, add.ubin,'color',p.z1_co,'Linestyle','-', 'showtext',p.show);
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
subplot(row,col,i); a=p.z9; b=p.dz9; sx=let(i)+p.s9; i=i+1;
...
title(s,'FontSize',fsize,'Interpreter','latex');
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
subplot(row,col,i); a=a11-a10; b=b11-b10; sx=let(i)+'(o) minus (n)'; i=i+1; 
pcolor(lon,lat,a); hold on; shading flat; caxis([p.cmin10 p.cmax10]);
contour(lon,lat,lm,1,co); axis(p.xy);
if p.do_add;
  %contour(lon,lat,add.z,add.zbin,p.z1_co,'showtext',p.show);
