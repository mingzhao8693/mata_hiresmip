function plot_pattern_effect_Figs_suppl3(p)
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
pms=[ 0, 0, 1600, 1000]*1; fsize=9; row=4; col=4; minus=char(8212);
...
cb0.Label.Position = [pos(1)-0.3 pos(2)+0.5]; 
...
cb0.Label.String = p.unit; pos=get(cb0,'Position');
cb0.Label.Position = [pos(1)-0.3 pos(2)+0.09]; 
cb0.Label.Rotation = 0;
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
cb0.Label.String = p.unit; pos=get(cb0,'Position');
cb0.Label.Position = [pos(1)-0.3 pos(2)+0.3]; 
cb0.Label.Rotation = 0;
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
cb0.Label.String = p.unit; pos=get(cb0,'Position');
cb0.Label.Position = [pos(1)-0.3 pos(2)+0.52]; 
cb0.Label.Rotation = 0;
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
