...
expn='ERAI_6h_DATA'; ardir='AR_climlmt'; yr1=2020;yr2=2020; pct=[99 99.9];
...
expn='ERAI_6h_DATA'; ardir='AR_climlmt'; yr1=2017;yr2=2020; pct=[99 99.9];
for yr = yr1:yr2
...
o.time=[1979:2014]; o.nyr=length(o.time); o.expn='pcp_mswep_1979_2014'
o.sfc.pcp_all =o.sfc.pcp_mswep.all;
o.sfc.slp_all =o.sfc.slp_1959_2021.all (end-41:end-6,:,:,:);
o.sfc.z500_all=o.sfc.z500_1959_2021.all(end-41:end-6,:,:,:);
o.sfc.ts_all  =o.sfc.sst_1870_2020.all (end-41:end-6,:,:,:);
o.sfc.ice_all =o.sfc.sst_1870_2020.all (end-41:end-6,:,:,:);
vo.tr7914=do_trend(o,1979,2014,'obs');

o.time=[1979:2020]; o.nyr=length(o.time); o.expn='pcp_mswep_1979_2020'
o.sfc.pcp_all =o.sfc.pcp_mswep.all;
o.sfc.slp_all =o.sfc.slp_1959_2021.all (end-41:end,:,:,:);
o.sfc.z500_all=o.sfc.z500_1959_2021.all(end-41:end,:,:,:);
o.sfc.ts_all  =o.sfc.sst_1870_2020.all (end-41:end,:,:,:);
o.sfc.ice_all =o.sfc.sst_1870_2020.all (end-41:end,:,:,:);
vo.tr7920=do_trend(o,1979,2020,'obs');

o.time=[1959:2020]; o.nyr=length(o.time); o.expn='pcp_gpcc_1959_2020'
o.sfc.pcp_all =o.sfc.pcp_gpcc.all      (end-61:end,:,:,:); 
o.sfc.slp_all =o.sfc.slp_1959_2021.all (end-61:end,:,:,:);
o.sfc.z500_all=o.sfc.z500_1959_2021.all(end-61:end,:,:,:);
o.sfc.ts_all  =o.sfc.sst_1870_2020.all (end-61:end,:,:,:);
o.sfc.ice_all =o.sfc.sst_1870_2020.all (end-61:end,:,:,:);
vo.tr5920=do_trend(o,1959,2020,'obs');

o.time=[1921:2020]; o.nyr=length(o.time); o.expn='pcp_gpcc_1921_2020'
o.sfc.pcp_all =o.sfc.pcp_gpcc.all      (end-100:end,:,:,:); 
o.sfc.slp_all =o.sfc.pcp_all;
o.sfc.z500_all=o.sfc.pcp_all;
o.sfc.ts_all  =o.sfc.sst_1870_2020.all (end-100:end,:,:,:);
o.sfc.ice_all =o.sfc.sst_1870_2020.all (end-100:end,:,:,:);
vo.tr2120=do_trend(o,1921,2020,'obs');
