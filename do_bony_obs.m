function v=do_bony_obs(o,omega,omega_clm,lm0,aa0,lat,lon,latlon,dlo)
...
s.qal.clm =o.atm_0114.qal.clm (:,  ys:ye,xs:xe);
s.qam.clm =o.atm_0114.qam.clm (:,  ys:ye,xs:xe);
s.qah.clm =o.atm_0114.qah.clm (:,  ys:ye,xs:xe);
s.lwp.clm =o.atm_0114.lwp.clm (:,  ys:ye,xs:xe);
s.iwp.clm =o.atm_0114.iwp.clm (:,  ys:ye,xs:xe);
s.wvp.clm =o.atm_0114.wvp.clm (:,  ys:ye,xs:xe);
