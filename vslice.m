function [z zb rmse]=vslice(v,s,k,varn,mod,mv)
...
elseif strcmp(varn,'zmw')
  i=1;
  y=squeeze(v.atm.w1000.sea(k,:,:));id1=(y>a); z(i,:)=zmeanwithmask(y,id1);i=i+1;
  y=squeeze(v.atm.w925.sea(k,:,:)); id2=(y>a); z(i,:)=zmeanwithmask(y,id2);i=i+1;
  y=squeeze(v.atm.w850.sea(k,:,:)); id3=(y>a); z(i,:)=zmeanwithmask(y,id3);i=i+1;
  y=squeeze(v.atm.w700.sea(k,:,:)); id4=(y>a); z(i,:)=zmeanwithmask(y,id4);i=i+1;
  y=squeeze(v.atm.w600.sea(k,:,:)); id5=(y>a); z(i,:)=zmeanwithmask(y,id5);i=i+1;
  y=squeeze(v.atm.w500.sea(k,:,:)); id6=(y>a); z(i,:)=zmeanwithmask(y,id6);i=i+1;
  y=squeeze(v.atm.w400.sea(k,:,:)); id7=(y>a); z(i,:)=zmeanwithmask(y,id7);i=i+1;
  y=squeeze(v.atm.w300.sea(k,:,:)); id8=(y>a); z(i,:)=zmeanwithmask(y,id8);i=i+1;
  y=squeeze(v.atm.w250.sea(k,:,:)); id9=(y>a); z(i,:)=zmeanwithmask(y,id9);i=i+1;
  y=squeeze(v.atm.w200.sea(k,:,:)); ida=(y>a); z(i,:)=zmeanwithmask(y,ida);i=i+1;
  y=squeeze(v.atm.w150.sea(k,:,:)); idb=(y>a); z(i,:)=zmeanwithmask(y,idb);i=i+1;
  y=squeeze(v.atm.w100.sea(k,:,:)); idc=(y>a); z(i,:)=zmeanwithmask(y,idc);i=i+1;
  y=squeeze(v.atm.w70.sea (k,:,:)); idd=(y>a); z(i,:)=zmeanwithmask(y,idd);i=i+1;
  y=squeeze(v.atm.w50.sea (k,:,:)); idd=(y>a); z(i,:)=zmeanwithmask(y,idd);i=i+1;
  if strcmp(mod,'obs')
    zb=z; zb(:,:)=0;
  else
    i=1;
    y=squeeze(v.atm.w1000.sea_bias(k,:,:)); zb(i,:)=zmeanwithmask(y,id1);i=i+1;
    y=squeeze(v.atm.w925.sea_bias(k,:,:));  zb(i,:)=zmeanwithmask(y,id2);i=i+1;
    y=squeeze(v.atm.w850.sea_bias(k,:,:));  zb(i,:)=zmeanwithmask(y,id3);i=i+1;
    y=squeeze(v.atm.w700.sea_bias(k,:,:));  zb(i,:)=zmeanwithmask(y,id4);i=i+1;
    y=squeeze(v.atm.w600.sea_bias(k,:,:));  zb(i,:)=zmeanwithmask(y,id5);i=i+1;
    y=squeeze(v.atm.w500.sea_bias(k,:,:));  zb(i,:)=zmeanwithmask(y,id6);i=i+1;
    y=squeeze(v.atm.w400.sea_bias(k,:,:));  zb(i,:)=zmeanwithmask(y,id7);i=i+1;
    y=squeeze(v.atm.w300.sea_bias(k,:,:));  zb(i,:)=zmeanwithmask(y,id8);i=i+1;
    y=squeeze(v.atm.w250.sea_bias(k,:,:));  zb(i,:)=zmeanwithmask(y,id9);i=i+1;
    y=squeeze(v.atm.w200.sea_bias(k,:,:));  zb(i,:)=zmeanwithmask(y,ida);i=i+1;
    y=squeeze(v.atm.w150.sea_bias(k,:,:));  zb(i,:)=zmeanwithmask(y,idb);i=i+1;
    y=squeeze(v.atm.w100.sea_bias(k,:,:));  zb(i,:)=zmeanwithmask(y,idc);i=i+1;
    y=squeeze(v.atm.w70.sea_bias (k,:,:));  zb(i,:)=zmeanwithmask(y,idd);i=i+1;
    y=squeeze(v.atm.w50.sea_bias (k,:,:));  zb(i,:)=zmeanwithmask(y,idd);i=i+1;
  end
elseif strcmp(varn,'zmrh')
  i=1;
  y=squeeze(v.atm.rh1000.sea(k,:,:));id1=(y>a); z(i,:)=zmeanwithmask(y,id1);i=i+1;
  y=squeeze(v.atm.rh925.sea(k,:,:)); id2=(y>a); z(i,:)=zmeanwithmask(y,id2);i=i+1;
  y=squeeze(v.atm.rh850.sea(k,:,:)); id3=(y>a); z(i,:)=zmeanwithmask(y,id3);i=i+1;
  y=squeeze(v.atm.rh700.sea(k,:,:)); id4=(y>a); z(i,:)=zmeanwithmask(y,id4);i=i+1;
  y=squeeze(v.atm.rh600.sea(k,:,:)); id5=(y>a); z(i,:)=zmeanwithmask(y,id5);i=i+1;
  y=squeeze(v.atm.rh500.sea(k,:,:)); id6=(y>a); z(i,:)=zmeanwithmask(y,id6);i=i+1;
  y=squeeze(v.atm.rh400.sea(k,:,:)); id7=(y>a); z(i,:)=zmeanwithmask(y,id7);i=i+1;
  y=squeeze(v.atm.rh300.sea(k,:,:)); id8=(y>a); z(i,:)=zmeanwithmask(y,id8);i=i+1;
  y=squeeze(v.atm.rh250.sea(k,:,:)); id9=(y>a); z(i,:)=zmeanwithmask(y,id9);i=i+1;
  y=squeeze(v.atm.rh200.sea(k,:,:)); ida=(y>a); z(i,:)=zmeanwithmask(y,ida);i=i+1;
  y=squeeze(v.atm.rh150.sea(k,:,:)); idb=(y>a); z(i,:)=zmeanwithmask(y,idb);i=i+1;
  y=squeeze(v.atm.rh100.sea(k,:,:)); idc=(y>a); z(i,:)=zmeanwithmask(y,idc);i=i+1;
  y=squeeze(v.atm.rh70.sea (k,:,:)); idd=(y>a); z(i,:)=zmeanwithmask(y,idd);i=i+1;
  y=squeeze(v.atm.rh50.sea (k,:,:)); idd=(y>a); z(i,:)=zmeanwithmask(y,idd);i=i+1;
  if strcmp(mod,'obs')
    zb=z; zb(:,:)=0;
  else
    i=1;
    y=squeeze(v.atm.rh1000.sea_bias(k,:,:)); zb(i,:)=zmeanwithmask(y,id1);i=i+1;
    y=squeeze(v.atm.rh925.sea_bias(k,:,:));  zb(i,:)=zmeanwithmask(y,id2);i=i+1;
    y=squeeze(v.atm.rh850.sea_bias(k,:,:));  zb(i,:)=zmeanwithmask(y,id3);i=i+1;
    y=squeeze(v.atm.rh700.sea_bias(k,:,:));  zb(i,:)=zmeanwithmask(y,id4);i=i+1;
    y=squeeze(v.atm.rh600.sea_bias(k,:,:));  zb(i,:)=zmeanwithmask(y,id5);i=i+1;
    y=squeeze(v.atm.rh500.sea_bias(k,:,:));  zb(i,:)=zmeanwithmask(y,id6);i=i+1;
    y=squeeze(v.atm.rh400.sea_bias(k,:,:));  zb(i,:)=zmeanwithmask(y,id7);i=i+1;
    y=squeeze(v.atm.rh300.sea_bias(k,:,:));  zb(i,:)=zmeanwithmask(y,id8);i=i+1;
    y=squeeze(v.atm.rh250.sea_bias(k,:,:));  zb(i,:)=zmeanwithmask(y,id9);i=i+1;
    y=squeeze(v.atm.rh200.sea_bias(k,:,:));  zb(i,:)=zmeanwithmask(y,ida);i=i+1;
    y=squeeze(v.atm.rh150.sea_bias(k,:,:));  zb(i,:)=zmeanwithmask(y,idb);i=i+1;
    y=squeeze(v.atm.rh100.sea_bias(k,:,:));  zb(i,:)=zmeanwithmask(y,idc);i=i+1;
    y=squeeze(v.atm.rh70.sea_bias (k,:,:));  zb(i,:)=zmeanwithmask(y,idd);i=i+1;
    y=squeeze(v.atm.rh50.sea_bias (k,:,:));  zb(i,:)=zmeanwithmask(y,idd);i=i+1;
  end
end
%compute RMSE  
a=zb; b=zb;
