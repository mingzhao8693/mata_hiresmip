function [ts,ind]=plot_spearle_all_new(vm, o, p)
...
for i = 1:mod_num
  ...
  a=v.sst.mod.ts.sst; ind.sst_ann(i,:,:,:)=squeeze(mean(a,2));
  ...
  titl=sprintf('M%02d (avg=%4.2fKdec^{-1}; r1=%4.2f; r2=%4.2f)',i,a0,corr_glob(i),corr_tpac(i)); 
...
rectangle('Position',rg.ipwp,'EdgeColor',p.color1,'LineStyle',':');
set(gca,'FontSize',fsize); axis([p.x1 p.x2 p.y1 p.y2]);
titl=sprintf('(a) HadISST (avg=%4.2fKdec^{-1}; r1=%4.2f; r2=%4.2f)',a0,corr_glob(i),corr_tpac(i)); 
title(titl,'FontSize',fsize-1);
%---------------------------
...
rectangle('Position',rg.ipwp,'EdgeColor',p.color1,'LineStyle',':');
set(gca,'FontSize',fsize); axis([p.x1 p.x2 p.y1 p.y2]);
titl=sprintf('(b) ERSSTv5 (avg=%4.2fKdec^{-1}; r1=%4.2f; r2=%4.2f)',a0,corr_glob(i),corr_tpac(i)); 
title(titl,'FontSize',fsize-1);
%---------------------------
...
rectangle('Position',rg.ipwp,'EdgeColor',p.color1,'LineStyle',':');
set(gca,'FontSize',fsize); axis([p.x1 p.x2 p.y1 p.y2]);
titl=sprintf('(c) COBE SST (avg=%4.2fKdec^{-1}; r1=%4.2f; r2=%4.2f)',a0,corr_glob(i),corr_tpac(i)); 
title(titl,'FontSize',fsize-1);
...
rectangle('Position',rg.ipwp,'EdgeColor',p.color1,'LineStyle',':');
set(gca,'FontSize',fsize); axis([p.x1 p.x2 p.y1 p.y2]);
titl=sprintf('(d) COBE2 SST (avg=%4.2fKdec^{-1}; r1=%4.2f; r2=%4.2f)',a0,corr_glob(i),corr_tpac(i)); 
title(titl,'FontSize',fsize-1);
...
rectangle('Position',rg.ipwp,'EdgeColor',p.color1,'LineStyle',':');
set(gca,'FontSize',fsize); axis([p.x1 p.x2 p.y1 p.y2]);
titl=sprintf('(e) ENS mean (avg=%4.2fKdec^{-1}; r1=%4.2f; r2=%4.2f)',a0,corr_glob(i),corr_tpac(i)); 
title(titl,'FontSize',fsize-1);
...
pms=[ 0, 0, 850, 780]*1.2; fsize=10; ms=4; row=2; col=2;
handle=figure('Position',pms,'visible','on'); 
...
i=31; plot(x1(i),y1(i),'bd','MarkerSize',12); hold on;
i=32; plot(x1(i),y1(i),'bo','MarkerSize',12); 
i=33; plot(x1(i),y1(i),'b*','MarkerSize',12); 
i=34; plot(x1(i),y1(i),'bs','MarkerSize',12); 
i=35; plot(x1(i),y1(i),'bp','MarkerSize',12); 
...
xlabel('Pacific W-E SST index ($\rm{K dec^{-1}}$)','FontSize',fsize,'Interpreter','latex');
ylabel('Pacific O-E SST index ($\rm{K dec^{-1}}$)','FontSize',fsize,'Interpreter','latex');
...
c1=polyfit(x1(i1:i2),y1(i1:i2),1); y=c1(1)*x+c1(2); plot(x,y,'b--');hold on; 
c1=corrcoef(x1(i1:i2),y1(i1:i2)); s1=sprintf('r=%4.2f',c1(1,2)); 
i=31; plot(x1(i),y1(i),'bd','MarkerSize',ms); hold on;
i=32; plot(x1(i),y1(i),'bo','MarkerSize',ms); 
i=33; plot(x1(i),y1(i),'b*','MarkerSize',ms); 
i=34; plot(x1(i),y1(i),'bs','MarkerSize',ms); 
i=35; plot(x1(i),y1(i),'bp','MarkerSize',ms); 
%plot(x1(1:30),y1(1:30),'b+','MarkerSize',8); 
for i=1:30
...
i=31; plot(x1(i),y1(i),'kd','MarkerSize',ms); hold on;
i=32; plot(x1(i),y1(i),'ko','MarkerSize',ms); 
i=33; plot(x1(i),y1(i),'k*','MarkerSize',ms); 
i=34; plot(x1(i),y1(i),'ks','MarkerSize',ms); 
i=35; plot(x1(i),y1(i),'kp','MarkerSize',ms); 
i=31; plot(x2(i),y1(i),'rd','MarkerSize',ms); 
i=32; plot(x2(i),y1(i),'ro','MarkerSize',ms); 
i=33; plot(x2(i),y1(i),'r*','MarkerSize',ms); 
i=34; plot(x2(i),y1(i),'rs','MarkerSize',ms); 
i=35; plot(x2(i),y1(i),'rp','MarkerSize',ms); 
i=31; plot(x3(i),y1(i),'bd','MarkerSize',ms); 
i=32; plot(x3(i),y1(i),'bo','MarkerSize',ms); 
i=33; plot(x3(i),y1(i),'b*','MarkerSize',ms); 
i=34; plot(x3(i),y1(i),'bs','MarkerSize',ms); 
i=35; plot(x3(i),y1(i),'bp','MarkerSize',ms); 
%plot(x1(1:30),y1(1:30),'b+','MarkerSize',8); 
%plot(x2(1:30),y1(1:30),'r+','MarkerSize',8); 
%plot(x3(1:30),y1(1:30),'g+','MarkerSize',8); 
for i=1:30
...
xy=[-0.5 1.5 0.05 0.42]; mylabel(xy,1,'(d)',fsize);
...
xlabel('SO, IPWP, or Pacific W-E SST index ($\rm{K dec^{-1}}$)','FontSize',fsize,'Interpreter','latex');
ylabel('global mean SST trend ($\rm{K dec^{-1}}$)','FontSize',fsize,'Interpreter','latex');
set(gca,'FontSize',fsize); 
