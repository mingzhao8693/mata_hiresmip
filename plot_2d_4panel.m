...
pms=[ 0, 0, 1100, 500]*1; fsize=10; lw=2; row=2; col=2;
...
contour(x,y,lm,1,p.c); axis(xy); 
ylabel(yl,'FontSize',fsize); set(gca,'FontSize',fsize);
%s2=sprintf('%s (mean:%5.3f)',s2,z2_mean); myboxon(0,360,-90,90,p.c);
...
contour(x,y,lm,1,p.c); axis(xy); 
ylabel(yl,'FontSize',fsize); set(gca,'FontSize',fsize);
%s3=sprintf('%s (mean:%5.3f)',s3,z3_mean); myboxon(0,360,-90,90,p.c);
...
contour(x,y,lm,1,p.c); axis(xy); 
ylabel(yl,'FontSize',fsize); set(gca,'FontSize',fsize);
%s4=sprintf('%s (mean:%5.3f)',s4,z4_mean); myboxon(0,360,-90,90,p.c);
...
contour(x,y,lm,1,p.c); axis(xy); 
ylabel(yl,'FontSize',fsize); set(gca,'FontSize',fsize);
%s5=sprintf('%s (mean:%5.3f)',s5,z5_mean); myboxon(0,360,-90,90,p.c);
...
visfig='off'; figpath='./fig_PE/'; 
p.expn=strcat(p.expn,'_4panel');
