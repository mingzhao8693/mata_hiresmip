...
expn='ERAI_6h_DATA'; ardir='AR_climlmt'; yr1=2009;yr2=2014; pct=[99 99.9];
opt='obs'; addtc_to_AR_obs(tpath,expn,yr1,yr2,opt,-30);
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
tpath='/archive/Ming.Zhao/backup/ECMWF/'; diag=0;
expn='ERAI_6h_DATA'; ardir='AR_climlmt'; yr1=1985;yr2=2008; pct=[99 99.9];
opt='MC'; v=readartcmcs_wind_obs(tpath,expn,yr1,yr2,pct,opt,diag);
expn='ERAI_6h_DATA'; ardir='AR_climlmt'; yr1=1979;yr2=2014; pct=[99 99.9];
opt='AR'; v=readartcmcs_wind_obs(tpath,expn,yr1,yr2,pct,opt,diag);
opt='TC'; v=readartcmcs_wind_obs(tpath,expn,yr1,yr2,pct,opt,diag);
opt='AL'; v=readartcmcs_wind_obs(tpath,expn,yr1,yr2,pct,opt,diag);
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
tpath='/archive/Ming.Zhao/awg/warsaw_201803/';pct=[99 99.9];%pct=[25 50 75 90 95 99 99.9];
expn='c192L33_am4p0_amip_HIRESMIP_H8_newpp'; ardir='AR_climlmt';yr1=1979;yr2=2014;diag=0;
%opt='mod'; addtc_to_AR(tpath,expn,yr1,yr2,opt,-30)
opt='AL';  v.al=readartcmcs_day_wind(tpath,expn,yr1,yr2,pct,opt,diag);
opt='MC';  v.mc=readartcmcs_day_wind(tpath,expn,yr1,yr2,pct,opt,diag);
opt='AR';  v.ar=readartcmcs_day_wind(tpath,expn,yr1,yr2,pct,opt,diag);
opt='TC';  v.tc=readartcmcs_day_wind(tpath,expn,yr1,yr2,pct,opt,diag);
