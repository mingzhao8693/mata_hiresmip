function v=mjomse_new(tpath,expn,yr1,yr2,latlon,nyr,region)
%varlist (2D)=======================
...
v.ps=lagregress(varb,v,latlon,lat1,lat2,v.io.ps,1);
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%2D fields
...
varb=readvar(varn,fn,v,'3d','yes');dpint=varb;
...
varb=readvar(varn,fn,v,'3d','yes'); varb=varb./dpint;
