function tr=compute_trend_obs(v,o,s,p)
y1=p.y1; y2=p.y2; 
...
a=get4season_all(vobs);
tr.pcp_gpcp=get_trend_TSR(s,a,xt_obs,alpha);
tr.pcp_gpcp.ts=ts;
%MSWEP%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
ts.findit=findit; ts.xt_obs=xt_obs; %a=squeeze(mean(vobs,2));
a=get4season_all(vobs);
tr.pcp_mswep=get_trend_TSR(s,a,xt_obs,alpha);
tr.pcp_mswep.ts=ts;
%GPCC%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
ts.findit=findit; ts.xt_obs=xt_obs; %a=squeeze(mean(vobs,2));
a=get4season_all(vobs);
tr.pcp_gpcc=get_trend_TSR(s,a,xt_obs,alpha);
tr.pcp_gpcc.ts=ts;
%ERA5%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
ts.findit=findit; ts.xt_obs=xt_obs; %a=squeeze(mean(vobs,2));
a=get4season_all(vobs);
tr.pcp_era5=get_trend_TSR(s,a,xt_obs,alpha);
tr.pcp_era5.ts=ts;
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
ts.findit=findit; 
a=get4season_all(vobs);
tr.slp_era5=get_trend_TSR(s,a,xt_obs,alpha);
tr.slp_era5.ts=ts;
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
ts.findit=findit; 
a=get4season_all(vobs);
tr.tref_era5=get_trend_TSR(s,a,xt_obs,alpha);
tr.tref_era5.ts=ts;
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
ts.findit=findit; 
a=get4season_all(vobs);
tr.rhref=get_trend_TSR(s,a,xt_obs,alpha);
tr.rhref.ts=ts;
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
ts.findit=findit; 
a=get4season_all(vobs);
tr.evap=get_trend_TSR(s,a,xt_obs,alpha);
tr.evap.ts=ts;
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
ts.findit=findit; 
a=get4season_all(vobs);
tr.shflx=get_trend_TSR(s,a,xt_obs,alpha);
tr.shflx.ts=ts;
