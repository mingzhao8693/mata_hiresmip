function [v]=read_daily_obs(tpath,expn,yr1,yr2,pct,opt,latlon)
[CPD,CPV,CL,RV,RD,LV0,G,ROWL,CPVMCL,EPS,EPSI,GINV,RDOCP,T0,HLF]=thermconst;
tpath='/archive/Ming.Zhao/awg/2023.04/'; expn ='c192_obs'; opt=0;
yr1=1979; yr2=2020; %yr1=1950; yr2=2020; 
...
thresh=[]; do_trend=1; v.era5.pr=extremes_ana(var,pct,thresh,nbin,do_trend,1)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%other OBS data %%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
fnout=strcat(tpath,expn,'/',expn,'_daily_climo_obs.nc')
