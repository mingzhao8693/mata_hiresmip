%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%AM4.0 paper Part I Figs. 26 and 27
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
v.u200=wk_specana(tpath,expn,yr1,yr2,yrs,latlon,region,varn,cald)
varn='u850'; yr1='1980'; yr2='2014'; yrs='1981'; cald='JULIAN';
v.u850=wk_specana(tpath,expn,yr1,yr2,yrs,latlon,region,varn,cald)
expn='GPCP';
latlon=[0 360 -15 15]; region='gtrop';
varn='precip'; yr1='1997'; yr2='2014'; yrs='1997'; cald='JULIAN';
v.pcp=wk_specana(tpath,expn,yr1,yr2,yrs,latlon,region,varn,cald)
expn='NOAA_OLR';
latlon=[0 360 -15 15]; region='gtrop';
varn='olr'; yr1='1979'; yr2='2011'; yrs='1979'; cald='JULIAN';
v.olr=wk_specana(tpath,expn,yr1,yr2,yrs,latlon,region,varn,cald)
fn='EqWaveDispersion.nc'; f = netcdf(fn, 'nowrite');
...
fn=strcat(tpath,expn,'_mjo_wk','.mat');
save(fn,'v','-v7.3'); 
%to read the observational analysis
fn=strcat('/work/miz/mat_am4p0/obs_mjo_lagreg.mat'); load(fn); o=v;
o=read_wkobs;
...
expn='c96L33_am4p0_m1';yr1='1980'; yr2='2014'; nyr=35;
v=am4part1_mjo_lagreg(tpath,expn,yr1,yr2,nyr,io_latlon,latlon,lateq,region)
expn='c96L33_am4p0_m2';yr1='1980'; yr2='2014'; nyr=35;
v=am4part1_mjo_lagreg(tpath,expn,yr1,yr2,nyr,io_latlon,latlon,lateq,region)
expn='c96L33_am4p0_m3';yr1='1980'; yr2='2014'; nyr=35;
v=am4part1_mjo_lagreg(tpath,expn,yr1,yr2,nyr,io_latlon,latlon,lateq,region)
expn='c96L33_am4p0_m4';yr1='1980'; yr2='2014'; nyr=35;
v=am4part1_mjo_lagreg(tpath,expn,yr1,yr2,nyr,io_latlon,latlon,lateq,region)
expn='c96L33_am4p0_m5';yr1='1980'; yr2='2014'; nyr=35;
v=am4part1_mjo_lagreg(tpath,expn,yr1,yr2,nyr,io_latlon,latlon,lateq,region)
expn='AM4p0';          yr1='1980'; yr2='2014'; nyr=35;
v=am4part1_mjo_lagreg(tpath,expn,yr1,yr2,nyr,io_latlon,latlon,lateq,region)
expn='c96L33_am4p0_initCond2'; yr1='1980'; yr2='2014'; nyr=35;
v=am4part1_mjo_lagreg(tpath,expn,yr1,yr2,nyr,io_latlon,latlon,lateq,region)
expn='cm4p0_2010';     yr1='0001'; yr2='0050'; nyr=35;
v=am4part1_mjo_lagreg(tpath,expn,yr1,yr2,nyr,io_latlon,latlon,lateq,region)
expn='cm4p0_hist';     yr1='1980'; yr2='2014'; nyr=35;
v=am4part1_mjo_lagreg(tpath,expn,yr1,yr2,nyr,io_latlon,latlon,lateq,region)
expn='CM4_c96L33_am4p0_2010_base'; yr1='0001'; yr2='0045'; nyr=35;
v=am4part1_mjo_lagreg(tpath,expn,yr1,yr2,nyr,io_latlon,latlon,lateq,region)
expn='LOAR4_c96L33_am4p0_2010climo_C15'; yr1='0001'; yr2='0100'; nyr=35;
v=am4part1_mjo_lagreg(tpath,expn,yr1,yr2,nyr,io_latlon,latlon,lateq,region)
expn='AM3';            yr1='1980'; yr2='2014'; nyr=35;
v=am4part1_mjo_lagreg(tpath,expn,yr1,yr2,nyr,io_latlon,latlon,lateq,region)
expn='AM2.1';          yr1='1981'; yr2='2007'; nyr=27;
v=am4part1_mjo_lagreg(tpath,expn,yr1,yr2,nyr,io_latlon,latlon,lateq,region)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%AM4.0 paper model MJO analysis: WHEELER-KILADIS
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
tpath ='/archive/Ming.Zhao/awg/warsaw/';
latlon=[0 360 -15 15]; region='gtrop';
expn='AM4.0'; yr1='1980'; yr2='2014'; yrs='1981'; cald='JULIAN'
v=mvar_wk_specana(tpath,expn,yr1,yr2,yrs,nyr,latlon,region,cald);
expn='c96L33_am4p0_m1'; yr1='1980'; yr2='2014'; yrs='1981'; nyr=34; cald='JULIAN'
v=mvar_wk_specana(tpath,expn,yr1,yr2,yrs,nyr,latlon,region,cald);
expn='c96L33_am4p0_m2'; yr1='1980'; yr2='2014'; yrs='1981'; nyr=34; cald='JULIAN'
v=mvar_wk_specana(tpath,expn,yr1,yr2,yrs,nyr,latlon,region,cald);
expn='c96L33_am4p0_m3'; yr1='1980'; yr2='2014'; yrs='1981'; nyr=34; cald='JULIAN'
v=mvar_wk_specana(tpath,expn,yr1,yr2,yrs,nyr,latlon,region,cald);
expn='c96L33_am4p0_m4'; yr1='1980'; yr2='2014'; yrs='1981'; nyr=34; cald='JULIAN'
v=mvar_wk_specana(tpath,expn,yr1,yr2,yrs,nyr,latlon,region,cald);
expn='c96L33_am4p0_m5'; yr1='1980'; yr2='2014'; yrs='1981'; nyr=34; cald='JULIAN'
v=mvar_wk_specana(tpath,expn,yr1,yr2,yrs,nyr,latlon,region,cald);
expn='AM4p0';           yr1='1980'; yr2='2014'; yrs='1981'; nyr=34; cald='JULIAN'
v=mvar_wk_specana(tpath,expn,yr1,yr2,yrs,nyr,latlon,region,cald);
expn='c96L33_am4p0_initCond2'; yr1='1980'; yr2='2014'; yrs='1981'; nyr=34; cald='JULIAN'
v=mvar_wk_specana(tpath,expn,yr1,yr2,yrs,nyr,latlon,region,cald);
%expn='cm4p0_2010';     yr1='0041'; yr2='0070'; yrs='0041'; nyr=30; cald='NOLEAP'
%expn='cm4p0_2010';     yr1='0301'; yr2='0360'; yrs='0301'; nyr=34; cald='NOLEAP'
expn='cm4p0_2010';      yr1='0001'; yr2='0050'; yrs='0001'; nyr=34; cald='NOLEAP'
v=mvar_wk_specana(tpath,expn,yr1,yr2,yrs,nyr,latlon,region,cald);
expn='cm4p0_hist';      yr1='1980'; yr2='2014'; yrs='1981'; nyr=34; cald='NOLEAP'
v=mvar_wk_specana(tpath,expn,yr1,yr2,yrs,nyr,latlon,region,cald);
expn='CM4_c96L33_am4p0_2010_base'; yr1='0001'; yr2='0045'; yrs='0001'; nyr=34; cald='NOLEAP'
v=mvar_wk_specana(tpath,expn,yr1,yr2,yrs,nyr,latlon,region,cald);
expn='LOAR4_c96L33_am4p0_2010climo_C15'; yr1='0001'; yr2='0100'; yrs='0001'; nyr=34; cald='JULIAN'
v=mvar_wk_specana(tpath,expn,yr1,yr2,yrs,nyr,latlon,region,cald);
expn='AM3';             yr1='1980'; yr2='2014'; yrs='1981'; nyr=34; cald='JULIAN'
v=mvar_wk_specana(tpath,expn,yr1,yr2,yrs,nyr,latlon,region,cald);
expn='AM2.1';           yr1='1980'; yr2='2014'; yrs='1981'; nyr=34; cald='NOLEAP'
v=mvar_wk_specana(tpath,expn,yr1,yr2,yrs,nyr,latlon,region,cald);
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
expn='AM4.0';                 fn=strcat(tpath,expn,'/',expn,'_',region,'_lagreg.mat'); load(fn);am4.v0=v;
%expn='c96L33_am4p0';          fn=strcat(tpath,expn,'/',expn,'_',region,'_lagreg.mat'); load(fn);am4.v0=v;
expn='c96L33_am4p0_m1';       fn=strcat(tpath,expn,'/',expn,'_',region,'_lagreg.mat'); load(fn);am4.v1=v;
expn='c96L33_am4p0_m1';       fn=strcat(tpath,expn,'/',expn,'_',region,'_mjo.mat'); load(fn);am4.v1a=v;
expn='c96L33_am4p0_m2';       fn=strcat(tpath,expn,'/',expn,'_',region,'_lagreg.mat'); load(fn);am4.v2=v;
expn='c96L33_am4p0_m3';       fn=strcat(tpath,expn,'/',expn,'_',region,'_lagreg.mat'); load(fn);am4.v3=v;
expn='c96L33_am4p0_m4';       fn=strcat(tpath,expn,'/',expn,'_',region,'_lagreg.mat'); load(fn);am4.v4=v;
expn='c96L33_am4p0_m5';       fn=strcat(tpath,expn,'/',expn,'_',region,'_lagreg.mat'); load(fn);am4.v5=v;
expn='AM4p0';                 fn=strcat(tpath,expn,'/',expn,'_',region,'_lagreg.mat'); load(fn);am4.v6=v;
expn='c96L33_am4p0_initCond2';fn=strcat(tpath,expn,'/',expn,'_',region,'_lagreg.mat'); load(fn);am4.v7=v;
expn='cm4p0_2010';            fn=strcat(tpath,expn,'/',expn,'_',region,'_lagreg.mat'); load(fn);cm4.v0=v;
