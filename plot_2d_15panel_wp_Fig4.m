...
set(cb0, 'Position', [0.93 0.8 wid len]); caxis([cmin1, cmax1]); a=1.18*cmax1;
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
cb0=colorbar('FontSize',fsize+2,'Location','eastoutside');
set(cb0, 'Position', [0.93 0.628 wid len]); caxis([cmin2, cmax2]); a=1.2*cmax2;
cb0.Label.String = p.unit; pos=get(cb0,'Position')
cb0.Label.Position = [pos(1)-0.3 pos(2)+a]; 
cb0.Label.Rotation = 0;
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
cb0=colorbar('FontSize',fsize+2,'Location','eastoutside');
set(cb0, 'Position', [0.93 0.452 wid len]); caxis([cmin3, cmax3]); a=1.2*cmax3;
cb0.Label.String = p.unit; pos=get(cb0,'Position')
cb0.Label.Position = [pos(1)-0.3 pos(2)+a]; 
cb0.Label.Rotation = 0;
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
cb0=colorbar('FontSize',fsize+2,'Location','eastoutside');
set(cb0, 'Position', [0.93 0.282 wid len]); caxis([cmin4, cmax4]); a=1.2*cmax4;
cb0.Label.String = p.unit; pos=get(cb0,'Position')
cb0.Label.Position = [pos(1)-0.3 pos(2)+a]; 
cb0.Label.Rotation = 0;
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
pcolor(lon,lat,a); hold on; shading flat;  caxis([cmin5 cmax5]);
contour(lon,lat,lm,1,co); 
s=sprintf('%s (%5.3f%s)',sx,b,p.unit); %title(s,'FontSize',fsize);
title(s,'FontSize',fsize,'Interpreter','latex');
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
cb0=colorbar('FontSize',fsize+2,'Location','eastoutside');
set(cb0, 'Position', [0.93 0.11 wid len]); caxis([cmin5, cmax5]); a=1.22*cmax5;
cb0.Label.String = p.unit; pos=get(cb0,'Position')
cb0.Label.Position = [pos(1)-0.3 pos(2)+a]; 
cb0.Label.Rotation = 0;
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
