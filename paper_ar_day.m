...
%opt='mod'; addtc_to_AR(tpath,expn,yr1,yr2,opt)
...
fext=strcat(yrs,'MC_diag',num2str(d),'_readartc_day.mat'); fn=strcat(tpath,expn,fext); load(fn);v1.mc=v;
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
tpath='/work/miz/mat_hiresmip/'; d=4;
...
fext=strcat(yrs,'MC_diag',num2str(d),'_readartc_day.mat'); fn=strcat(tpath,expn,fext); load(fn);w1.mc=v;
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
tpath='/work/miz/mat_hiresmip/'; d=4;
...
p.s3='frequency of TC days'; 
p.s4='frequency of TD days'; 
p.s5='frequency of MCS days';
p.s6='SUM=AR+TC+TD+MCS'; p.s0='';
...
p.s3='annual mean TC precipitation'; 
p.s4='annual mean TD precipitation'; 
p.s5='annual mean MCS precipitation';
p.s6='SUM=AR+TC+TD+MCS precipitation'; p.s0='';
...
p.s3='fraction of P from TC'; 
p.s4='fraction of P from TD'; 
p.s5='fraction of P from MCS';
p.s6='fraction of P from AR+TC+TD+MCS'; p.s0='';
...
p.s2='AR'; p.s3='TC'; p.s4='TD'; p.s5='MCS';
p.s6='AVG (AR+TC+TD+MCS)'; p.s0='';
...
p.s4='AVG TD P>=P99'; 
p.s5='AVG MSC P>=P99';
p.s6='AVG AR+TC+TD+MCS P>=P99'; p.s0='';
...
p.s6='AVG AR+TC+TD+MCS P>=P99.9'; p.s0='';
...
p.s3='fraction of from TC'; 
p.s4='fraction of from TD'; 
p.s5='fraction of from MCS';
p.s6='fraction of from AR+TC+TD+MCS'; p.s0='';
...
p=smoothp(p,1,1,'omitnan','shrink');
p.s1='annual mean LW CRE (W/m2)';
p.s2='AR mean'; p.s3='TC mean'; p.s4='TD mean'; p.s5='MCS mean';
p.s6='AVG (AR+TC+TD+MCS)'; p.s0='';
...
p.s3='\Delta frequency of TC days'; 
p.s4='\Delta frequency of TD days'; 
p.s5='\Delta frequency of MCS days';
p.s6='\Delta SUM=AR+TC+TD+MCS days'; p.s0='';
...
p.s3='\Delta fraction from TC'; 
p.s4='\Delta fraction from TD'; 
p.s5='\Delta fraction from MCS';
p.s6='\Delta AVG (AR+TC+TD+MCS)'; p.s0='';
...
p.s3='\Delta TC precipitation'; 
p.s4='\Delta TD precipitation'; 
p.s5='\Delta MCS precipitation';
p.s6='\Delta SUM=AR+TC+TD+MCS precipitation'; p.s0='';
...
p.s3='\Delta fraction of P from TC'; 
p.s4='\Delta fraction of P from TD'; 
p.s5='\Delta fraction of P from MCS';
p.s6='\Delta fraction of P from AR+TC+TD+MCS'; p.s0='';
...
p.s3='\Delta TC mean precipitation'; 
p.s4='\Delta TD mean precipitation'; 
p.s5='\Delta MCS mean precipitation';
p.s6='\Delta AVG (AR+TC+TD+MCS) precipitation'; p.s0='';
p.c1=[-10 10]; a=[-10 10]; p.c2=a; p.c3=a; p.c4=a; p.c5=a; p.c6=a;
plot_2d_6panel(p)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
p.s3='percent change of Pr for TC (Pr>=P99)'; 
...
p.s3='percent change of TC P>=P99.9'; 
...
p.s3='\Delta TC mean 500hPa omega'; 
p.s4='\Delta TD mean 500hPa omega'; 
p.s5='\Delta MCS mean 500hPa omega';
p.s6='\Delta AVG (AR+TC+TD+MCS) 500hPa omega'; p.s0='';
p.c1=[-10 10]; a=[-10 10]; p.c2=a; p.c3=a; p.c4=a; p.c5=a; p.c6=a;
plot_2d_6panel(p)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
p.s3='percent change in \omega_{500} for TC (Pr>=P99)'; 
...
p.s3='percent change in \omega_{500} for TC (P>=P99.9)'; 
...
p.s3='\Delta TC LW CRE'; 
p.s4='\Delta TD LW CRE'; 
p.s5='\Delta MCS LW CRE';
p.s6='\Delta LW CRE from AR+TC+TD+MCS'; p.s0='';
...
p.s3='\Delta TC mean LW CRE'; 
p.s4='\Delta TD mean LW CRE'; 
p.s5='\Delta MCS mean LW CRE';
p.s6='\Delta AVG (AR+TC+TD+MCS) LW CRE'; p.s0='';
...
p.s3='\Delta non-TC mean LW CRE'; 
p.s4='\Delta non-TD mean LW CRE'; 
p.s5='\Delta non-MCS mean LW CRE';
p.s6='\Delta AVG non-(AR+TC+TD+MCS) LW CRE'; p.s0='';
p.c1=[-1 1]; a=[-2 2]; p.c2=a; p.c3=a; p.c4=a; p.c5=a; p.c6=a;
plot_2d_6panel(p)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%delta SWCF%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
p.s3='\Delta TC SW CRE'; 
p.s4='\Delta TD SW CRE'; 
p.s5='\Delta MCS SW CRE';
p.s6='\Delta SW CRE from AR+TC+TD+MCS'; p.s0='';
p.c1=[-1 1]; a=[-1 1]; p.c2=a; p.c3=a; p.c4=a; p.c5=a; p.c6=a; 
plot_2d_6panel(p)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
p.s3='\Delta TC mean SW CRE'; 
p.s4='\Delta TD mean SW CRE'; 
p.s5='\Delta MCS mean SW CRE';
p.s6='\Delta AVG (AR+TC+TD+MCS) SW CRE'; p.s0='';
p.c1=[-1 1]; a=[-2 2]; p.c2=a; p.c3=a; p.c4=a; p.c5=a; p.c6=a;
plot_2d_6panel(p)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
p.s3='percent change of TC P>=P99'; 
