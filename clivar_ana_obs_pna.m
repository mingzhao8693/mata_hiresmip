function v=clivar_ana_obs_pna(tpath,expn,latlon,region)
...
if (do_sample_plot)
  ...
  i=2; z1=-squeeze(x.eof(:,:,i)); lat=v.lat; lon=v.lon; 
  ...
  pms=[0,0,1200,800]*1.5; h=figure('Position',pms,'visible','on');
  plot(v.PNA_z500.index2,'-rs'); hold on; plot(-v.PNA_external.pnai,'-m.');
  plot(-w.eof_ts(:,2),'-g*');
end
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
