function [v]=readartcmap(tpath,expn,yr1,yr2,opt)
...
for m=1:1 %12
  ...
  %TC
  ff='6hr'; exd='/AR_allstorms/'; varn='TC'; exf1=''; exf2=''; exf3='';
  [id_tc time]=readallyear_artc(v,exd,varn,exf1,exf2,exf3,m,ff);

  %AR feature
  ff='6hr'; exd='/AR_allstorms/'; varn='AR'; exf1=''; exf2=''; exf3='';
  [shape time]=readallyear_artc(v,exd,varn,exf1,exf2,exf3,m,ff);
  ...
  ivty=readallyear_artc(v,exd,varn,exf1,exf2,exf3,m,ff); 
...
fnmat=strcat(epath,expn,fext,'_readartcmap.mat')
