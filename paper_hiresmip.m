...
p.yr1='1980'; p.yr2='2020'; p.syr=1; p.nyr=41; p.y1=1980; p.y2=2020; 
...
%p.expn='c192L33_am4p0_2010climo'; v=tsana_hiresmip_new(o,tpath,p);
...
%e='c192L33_am4p0_2010climo'; n=strcat(ph,e,'/',e,f); load(n);z.v1=v;
e='c192L33_am4p0_2010climo_trend_1979_2020_spear_best_wegradient'; n=strcat(ph,e,'/',e,f);  load(n);z.v1=v;
e='c192L33_am4p0_2010climo_trend_1979_2020_spear_worst_wegradient'; n=strcat(ph,e,'/',e,f); load(n);z.v2=v;
e='c192L33_am4p0_2010climo_trend_1979_2020_spear_2best_wegradient'; n=strcat(ph,e,'/',e,f); load(n);z.v3=v;
e='c192L33_am4p0_2010climo_trend_1979_2020_spear_2worst_wegradient'; n=strcat(ph,e,'/',e,f);load(n);z.v4=v;

v=z.v0; s=v.s; lon=s.lon; lat=s.lat; aa=s.aa;
a0=v.sfc.tsurf.tavg0; cmin=-1; cmax=1; cmin1=0; cmax1=10;
pms=[ 0, 0, 1200, 1200]*1; fsize=16; row=2; col=2;
handle = figure('Position', pms,'visible','on'); 
subplot(row,col,1); a=z.v1.sfc.tsurf.tavg0-a0;
pcolor(lon,lat,a); hold on; shading flat; colorbar; caxis([cmin cmax]);
nn=256;  cmap=bluewhitered_miz(nn); colormap(cmap);
avg=mean(mean(a.*aa)); s=sprintf('(a) AVG = %5.2f',avg); title(s,'FontSize',fsize);
subplot(row,col,2); a=z.v2.sfc.tsurf.tavg0-a0;
pcolor(lon,lat,a); hold on; shading flat; colorbar; caxis([cmin cmax]);
avg=mean(mean(a.*aa)); s=sprintf('(b) AVG = %5.2f',avg); title(s,'FontSize',fsize);
subplot(row,col,3); a=z.v3.sfc.tsurf.tavg0-a0;
a=z.v1.toa.lwcf.tavg0;
pcolor(lon,lat,a); hold on; shading flat; colorbar; %caxis([cmin1 cmax1]);
avg=mean(mean(a.*aa)); s=sprintf('(c) AVG = %5.2f',avg); title(s,'FontSize',fsize);
subplot(row,col,4); a=squeeze(mean(z.v0.toa.lwnet.ann(61:90,:,:),1))-z.v0.toa.lwnet.tavg0;
a=z.v0.toa.lwcf.tavg0;
pcolor(lon,lat,a); hold on; shading flat; colorbar; %caxis([cmin1 cmax1]);
avg=mean(mean(a.*aa)); s=sprintf('(d) AVG = %5.2f',avg); title(s,'FontSize',fsize);
...
v0=tsana_hiresmip(o,tpath,expn,yr1,yr2,latlon,region,syr,nyr,myr,mod,opt);
expn='SPEAR_c192_o1_Hist_AllForc_IC1921_K50_ens_02';
v0=tsana_hiresmip(o,tpath,expn,yr1,yr2,latlon,region,syr,nyr,myr,mod,opt);
expn='SPEAR_c192_o1_Hist_AllForc_IC1921_K50_ens_03';
v0=tsana_hiresmip(o,tpath,expn,yr1,yr2,latlon,region,syr,nyr,myr,mod,opt);
expn='SPEAR_c192_o1_Hist_AllForc_IC1921_K50_ens_04';
v0=tsana_hiresmip(o,tpath,expn,yr1,yr2,latlon,region,syr,nyr,myr,mod,opt);
expn='SPEAR_c192_o1_Hist_AllForc_IC1921_K50_ens_05';
v0=tsana_hiresmip(o,tpath,expn,yr1,yr2,latlon,region,syr,nyr,myr,mod,opt);
expn='SPEAR_c192_o1_Hist_AllForc_IC1921_K50_ens_06';
v0=tsana_hiresmip(o,tpath,expn,yr1,yr2,latlon,region,syr,nyr,myr,mod,opt);
expn='SPEAR_c192_o1_Hist_AllForc_IC1921_K50_ens_07';
v0=tsana_hiresmip(o,tpath,expn,yr1,yr2,latlon,region,syr,nyr,myr,mod,opt);
expn='SPEAR_c192_o1_Hist_AllForc_IC1921_K50_ens_08';
v0=tsana_hiresmip(o,tpath,expn,yr1,yr2,latlon,region,syr,nyr,myr,mod,opt);
expn='SPEAR_c192_o1_Hist_AllForc_IC1921_K50_ens_09';
v0=tsana_hiresmip(o,tpath,expn,yr1,yr2,latlon,region,syr,nyr,myr,mod,opt);
expn='SPEAR_c192_o1_Hist_AllForc_IC1921_K50_ens_10';
v0=tsana_hiresmip(o,tpath,expn,yr1,yr2,latlon,region,syr,nyr,myr,mod,opt);
expn='SPEAR_c192_o1_Hist_AllForc_IC1921_K50_ens_11';
v0=tsana_hiresmip(o,tpath,expn,yr1,yr2,latlon,region,syr,nyr,myr,mod,opt);
expn='SPEAR_c192_o1_Hist_AllForc_IC1921_K50_ens_12';
v0=tsana_hiresmip(o,tpath,expn,yr1,yr2,latlon,region,syr,nyr,myr,mod,opt);
expn='SPEAR_c192_o1_Hist_AllForc_IC1921_K50_ens_13';
v0=tsana_hiresmip(o,tpath,expn,yr1,yr2,latlon,region,syr,nyr,myr,mod,opt);
expn='SPEAR_c192_o1_Hist_AllForc_IC1921_K50_ens_14';
v0=tsana_hiresmip(o,tpath,expn,yr1,yr2,latlon,region,syr,nyr,myr,mod,opt);
expn='SPEAR_c192_o1_Hist_AllForc_IC1921_K50_ens_15';
v0=tsana_hiresmip(o,tpath,expn,yr1,yr2,latlon,region,syr,nyr,myr,mod,opt);
expn='SPEAR_c192_o1_Hist_AllForc_IC1921_K50_ens_16';
v0=tsana_hiresmip(o,tpath,expn,yr1,yr2,latlon,region,syr,nyr,myr,mod,opt);
expn='SPEAR_c192_o1_Hist_AllForc_IC1921_K50_ens_17';
v0=tsana_hiresmip(o,tpath,expn,yr1,yr2,latlon,region,syr,nyr,myr,mod,opt);
expn='SPEAR_c192_o1_Hist_AllForc_IC1921_K50_ens_18';
v0=tsana_hiresmip(o,tpath,expn,yr1,yr2,latlon,region,syr,nyr,myr,mod,opt);
expn='SPEAR_c192_o1_Hist_AllForc_IC1921_K50_ens_19';
v0=tsana_hiresmip(o,tpath,expn,yr1,yr2,latlon,region,syr,nyr,myr,mod,opt);
expn='SPEAR_c192_o1_Hist_AllForc_IC1921_K50_ens_20';
v0=tsana_hiresmip(o,tpath,expn,yr1,yr2,latlon,region,syr,nyr,myr,mod,opt);
expn='SPEAR_c192_o1_Hist_AllForc_IC1921_K50_ens_21';
v0=tsana_hiresmip(o,tpath,expn,yr1,yr2,latlon,region,syr,nyr,myr,mod,opt);
expn='SPEAR_c192_o1_Hist_AllForc_IC1921_K50_ens_22';
v0=tsana_hiresmip(o,tpath,expn,yr1,yr2,latlon,region,syr,nyr,myr,mod,opt);
expn='SPEAR_c192_o1_Hist_AllForc_IC1921_K50_ens_23';
v0=tsana_hiresmip(o,tpath,expn,yr1,yr2,latlon,region,syr,nyr,myr,mod,opt);
expn='SPEAR_c192_o1_Hist_AllForc_IC1921_K50_ens_24';
v0=tsana_hiresmip(o,tpath,expn,yr1,yr2,latlon,region,syr,nyr,myr,mod,opt);
expn='SPEAR_c192_o1_Hist_AllForc_IC1921_K50_ens_25';
v0=tsana_hiresmip(o,tpath,expn,yr1,yr2,latlon,region,syr,nyr,myr,mod,opt);
expn='SPEAR_c192_o1_Hist_AllForc_IC1921_K50_ens_26';
v0=tsana_hiresmip(o,tpath,expn,yr1,yr2,latlon,region,syr,nyr,myr,mod,opt);
expn='SPEAR_c192_o1_Hist_AllForc_IC1921_K50_ens_27';
v0=tsana_hiresmip(o,tpath,expn,yr1,yr2,latlon,region,syr,nyr,myr,mod,opt);
expn='SPEAR_c192_o1_Hist_AllForc_IC1921_K50_ens_28';
v0=tsana_hiresmip(o,tpath,expn,yr1,yr2,latlon,region,syr,nyr,myr,mod,opt);
expn='SPEAR_c192_o1_Hist_AllForc_IC1921_K50_ens_29';
v0=tsana_hiresmip(o,tpath,expn,yr1,yr2,latlon,region,syr,nyr,myr,mod,opt);
expn='SPEAR_c192_o1_Hist_AllForc_IC1921_K50_ens_30';
v0=tsana_hiresmip(o,tpath,expn,yr1,yr2,latlon,region,syr,nyr,myr,mod,opt);
